...
| behind upstream | 16 |
| …of those, crossing a **major** boundary | 5 |
| …of those, a `0.x` minor (breaking by semver convention) | 4 |
| at the newest version and upstream still active | 18 |
