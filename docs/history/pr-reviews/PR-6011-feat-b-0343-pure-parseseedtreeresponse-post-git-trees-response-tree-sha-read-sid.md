# PR #6011 -- feat(B-0343): pure parseSeedTreeResponse — POST /git/trees response → tree SHA (read-side pair of buildSeedTreeRequest)
...
|---|---|
| Number | 6011 |
| Title | feat(B-0343): pure parseSeedTreeResponse — POST /git/trees response → tree SHA (read-side pair of buildSeedTreeRequest) |
