# PR #6212 -- docs(B-0164.1): clarify remaining disagreement wiring
...
|---|---|
| Number | 6212 |
| Title | docs(B-0164.1): clarify remaining disagreement wiring |
...
- Mark B-0164.1 closed now that the PR-review disagreement detector, divergence shard writer, pending-shard reader, and reconcile CLI are landed.
- Update B-0164 parent AC #2 from blocked to done.
...
- **`chatgpt-codex-connector[bot]` (bot)** at 2026-05-31T13:56:22Z on `docs/backlog/P1/B-0164.1-pr-review-disagreement-preservation-protocol.md`:4 (association: NONE)

  <pre>
  **&lt;sub&gt;&lt;sub&gt;![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)&lt;/sub&gt;&lt;/sub&gt;  Keep B-0164.1 open until the detector is wired**
...
- **`Copilot` (bot)** at 2026-05-31T13:56:48Z on `docs/backlog/P1/B-0164-dual-loop-substrate-attribution-and-reconciliation-protocol-2026-05-02.md`:137 (association: NONE)

  <pre>
  P1: Closing B-0164.1 here leaves the parent decomposition inconsistent: the B-0164.3 row in the same table still lists B-0164.1 (and B-0160, which is also closed) as its blocker. Please update the remaining-child blocker/status wording in this parent row and the B-0164.3 row together so B-0164.3 reflects the actual remaining cron-topology decision/observation work rather than already-closed prerequisites.
  </pre>
...
```
docs(B-0164.1): close disagreement protocol row
...
```
docs(B-0164.1): keep caller wiring open
