# PR #7670 -- docs(craft): bob/weave/tie/twist/braid nailed to running code + the textile frame (warp/weft) + B-1027
...
|---|---|
| Number | 7670 |
| Title | docs(craft): bob/weave/tie/twist/braid nailed to running code + the textile frame (warp/weft) + B-1027 |
