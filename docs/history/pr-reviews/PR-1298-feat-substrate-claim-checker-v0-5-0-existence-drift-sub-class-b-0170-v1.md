# PR #1298 -- feat(substrate-claim-checker): v0.5.0 — existence-drift sub-class (081KQNJ500008QG0R003SCWBDV v1+)
...
|---|---|
| Number | 1298 |
| Title | feat(substrate-claim-checker): v0.5.0 — existence-drift sub-class (081KQNJ500008QG0R003SCWBDV v1+) |
...
- 081KQNJ500008QG0R003ZC6PK8 guess file (post-#1285 fix): 2 false-positives in calibration-delta tables (acceptable v0.5 limitation; documented)
- 081KQJZR90008QG0R001YX3445 guess file: 1 finding (Otto's proposed `tools/chat-events/replay.ts`)
...
Second sub-class of 081KQNJ500008QG0R003SCWBDV's 7-class taxonomy. Catches claims that a
...
- PR #1280 081KQNJ500008QG0R003ZC6PK8 ground-truth recovery claimed `tools/git/hooks/`
  exists; reviewer flagged that it doesn't (081KQNJ500008QG0R003ZC6PK8 row deliverable)
- PR #1289 + #1290 review threads flagged similar existence-drift
  patterns

**Sanity check on real substrate**:
- alignment-frontier memo: clean (0 findings)
- 081KQNJ500008QG0R003ZC6PK8 guess file (post-#1285 fix): 2 false-positives in
  calibration-delta tables (acceptable v0.5 limitation; documented)
- 081KQJZR90008QG0R001YX3445 guess file: 1 finding (proposed `tools/chat-events/replay.ts`)
