# PR #8726 -- deps: bump actions/checkout from 6.0.3 to 7.0.0
...
|---|---|
| Number | 8726 |
| Title | deps: bump actions/checkout from 6.0.3 to 7.0.0 |
| Author | `app/dependabot` (bot) |
| State | MERGED |
| Created at | 2026-06-20T07:14:50Z |
| Merged at | 2026-07-01T21:52:02Z |
| Merge commit SHA | `41cd5478f761d7a89a4c60d8ebc84ec4651596d0` |
| Branch | `dependabot/github_actions/actions/checkout-7.0.0` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/8726 |
| Changed files | 46 |
| Additions / deletions | +74 / -74 |
