# PR #11203 -- archive(pr-reviews): PR #11187 on merge
...
|---|---|
| Number | 11203 |
| Title | archive(pr-reviews): PR #11187 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T23:52:08Z |
| Merged at | 2026-08-17T00:06:22Z |
| Merge commit SHA | `22584dd8c1803281307f956e05262fbedd36f0a4` |
| Branch | `automation/pr-archive-11187-run-31980302269-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11203 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11187
...
PR title: feat(gpu): gate hardware.nvidia.open behind a preflight — measure the delta, refuse the flip
Workflow run: 31980302269
Workflow attempt: 1
