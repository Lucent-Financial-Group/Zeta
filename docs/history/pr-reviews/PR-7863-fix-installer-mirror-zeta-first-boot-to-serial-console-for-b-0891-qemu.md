# PR #7863 -- fix(installer): mirror zeta-first-boot to serial console for B-0891 QEMU
...
|---|---|
| Number | 7863 |
| Title | fix(installer): mirror zeta-first-boot to serial console for B-0891 QEMU |
