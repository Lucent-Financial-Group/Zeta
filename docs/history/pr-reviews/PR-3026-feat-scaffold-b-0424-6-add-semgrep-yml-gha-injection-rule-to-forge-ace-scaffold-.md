...
```
feat(scaffold): 081KRFA460008QG0R001H98EXJ.6 — add .semgrep.yml GHA injection rule to for…
...
```
fix(scaffold): 081KRFA460008QG0R001H98EXJ.6 — scaffold .mise.toml with semgrep pin alongs…
