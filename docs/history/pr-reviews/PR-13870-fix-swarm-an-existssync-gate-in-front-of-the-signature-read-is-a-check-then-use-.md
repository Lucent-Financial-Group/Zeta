# PR #13870 -- fix(swarm): an existsSync gate in front of the signature read is a check-then-use race
...
|---|---|
| Number | 13870 |
| Title | fix(swarm): an existsSync gate in front of the signature read is a check-then-use race |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-22T19:00:06Z |
| Merged at | 2026-08-22T19:13:09Z |
| Merge commit SHA | `276bbfe62514e2ecb17222fb90279e42c7bbe8f1` |
| Branch | `shadow-swarm-toctou` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/13870 |
| Changed files | 1 |
