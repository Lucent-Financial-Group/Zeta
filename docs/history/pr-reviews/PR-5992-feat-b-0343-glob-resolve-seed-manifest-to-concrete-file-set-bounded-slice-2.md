# PR #5992 -- feat(B-0343): glob-resolve seed manifest to concrete file set (bounded slice 2)
...
|---|---|
| Number | 5992 |
| Title | feat(B-0343): glob-resolve seed manifest to concrete file set (bounded slice 2) |
