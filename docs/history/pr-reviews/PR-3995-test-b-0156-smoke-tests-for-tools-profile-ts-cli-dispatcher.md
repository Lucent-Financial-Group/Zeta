...
```
test(081KQGDBJ0008QG0R000A4EZS5): smoke tests for tools/profile.ts CLI dispatcher
...
(081KRA5AR0008QG0R0011ZGRZT #4): VALIDATES DISPATCH ONLY, NOT dotnet-counters /
dotnet-trace / dotnet-gcdump invocations — those tools aren't
guaranteed in CI. Live subcommand testing is out of scope.

Closes the last gap in 081KQGDBJ0008QG0R000A4EZS5 acceptance criterion #2 ("each
...
Composes with:
- 081KQGDBJ0008QG0R000A4EZS5 (TS standardization)
- 081KRA5AR0008QG0R0011ZGRZT (peer-call smoke test pattern this mirrors)
