# PR #5714 -- feat(B-0907): Itron-coincidence-metering substrate + Rx temporal-joins + bitemporal + bond-pricing application
...
|---|---|
| Number | 5714 |
| Title | feat(B-0907): Itron-coincidence-metering substrate + Rx temporal-joins + bitemporal + bond-pricing application |
...
- [PR #5713](https://github.com/Lucent-Financial-Group/Zeta/pull/5713) — B-0906 (encryption-thermal-cost two-axis; economic foundation)
- [PR #5712](https://github.com/Lucent-Financial-Group/Zeta/pull/5712) — B-0905 Landauer model + B-0901-B-0904 shadow* substrate
- [PR #5710](https://github.com/Lucent-Financial-Group/Zeta/pull/5710) — B-0898 Measure-as-bridge (operates on coincidence-metered events)
- [PR #5709](https://github.com/Lucent-Financial-Group/Zeta/pull/5709) — B-0897 Persist-as-bridge (round-trip-promise IS bitemporal forward+inverse)
...
- [x] B-0907 backlog row filed with required frontmatter
