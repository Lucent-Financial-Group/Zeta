# PR #11500 -- archive(pr-reviews): PR #11484 on merge
...
|---|---|
| Number | 11500 |
| Title | archive(pr-reviews): PR #11484 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-17T14:35:55Z |
| Merged at | 2026-08-17T15:28:31Z |
| Merge commit SHA | `536c5309ec3d3b47bca058dd380abbeafbaf8fd8` |
| Branch | `automation/pr-archive-11484-run-32039565495-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11500 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11484
...
PR title: feat(installer): opt-in persist bind to probed USB iSerial
Workflow run: 32039565495
Workflow attempt: 1
