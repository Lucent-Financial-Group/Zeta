# PR #6632 -- proof(B-1007 C13): DBSP operator algebra (z⁻¹/I/D) + Tick (ℕ,+,0) monoid — FsCheck + Z3
...
|---|---|
| Number | 6632 |
| Title | proof(B-1007 C13): DBSP operator algebra (z⁻¹/I/D) + Tick (ℕ,+,0) monoid — FsCheck + Z3 |
