# PR #7783 -- docs(research): Infer.NET circuits — half the engine is already ours; three rings, one calculus (B-1032)
...
|---|---|
| Number | 7783 |
| Title | docs(research): Infer.NET circuits — half the engine is already ours; three rings, one calculus (B-1032) |
