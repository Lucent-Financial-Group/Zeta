# PR #11158 -- archive(pr-reviews): PR #10675 on merge
...
|---|---|
| Number | 11158 |
| Title | archive(pr-reviews): PR #10675 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T22:48:37Z |
| Merged at | 2026-08-17T00:06:51Z |
| Merge commit SHA | `b3f6601e7c79f0184cea94e1f378874892818b11` |
| Branch | `automation/pr-archive-10675-run-31977334410-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11158 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #10675
...
PR title: feat(ace): signed capability manifest — the declaration half, and ace verify can now fail
Workflow run: 31977334410
Workflow attempt: 1
