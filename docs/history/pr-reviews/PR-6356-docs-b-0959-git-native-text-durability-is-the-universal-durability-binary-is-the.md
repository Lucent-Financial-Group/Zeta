# PR #6356 -- docs(B-0959): git-native TEXT durability is the universal durability; binary is the optimization
...
|---|---|
| Number | 6356 |
| Title | docs(B-0959): git-native TEXT durability is the universal durability; binary is the optimization |
