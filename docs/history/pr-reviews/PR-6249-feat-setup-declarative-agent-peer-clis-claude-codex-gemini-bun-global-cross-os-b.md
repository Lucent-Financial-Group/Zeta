# PR #6249 -- feat(setup): declarative agent/peer CLIs (claude/codex/gemini) bun-global cross-OS (B-0857 Phase 1)
...
|---|---|
| Number | 6249 |
| Title | feat(setup): declarative agent/peer CLIs (claude/codex/gemini) bun-global cross-OS (B-0857 Phase 1) |
