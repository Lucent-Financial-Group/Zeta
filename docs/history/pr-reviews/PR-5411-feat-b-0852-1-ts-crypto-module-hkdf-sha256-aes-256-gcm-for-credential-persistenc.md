...
```
feat(B-0852.1): TS crypto module — HKDF-SHA256 + AES-256-GCM for cred…
...
```
fix(B-0852.1 SECURITY-HIGH): add scrypt passphrase stretching before …
...
```
fix(B-0852.1): 3 Copilot findings — decrypt() salt-validation + non-t…
