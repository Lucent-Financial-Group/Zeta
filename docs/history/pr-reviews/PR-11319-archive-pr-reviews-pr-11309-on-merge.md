# PR #11319 -- archive(pr-reviews): PR #11309 on merge
...
|---|---|
| Number | 11319 |
| Title | archive(pr-reviews): PR #11309 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-17T03:40:38Z |
| Merged at | 2026-08-17T03:48:04Z |
| Merge commit SHA | `20ba24c374706618cdd4a2e84f2ce8064b21128f` |
| Branch | `automation/pr-archive-11309-run-31991884350-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11319 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11309
...
PR title: feat(installer): opt-in QEMU USB iSerial guest serial assertion
Workflow run: 31991884350
Workflow attempt: 1
