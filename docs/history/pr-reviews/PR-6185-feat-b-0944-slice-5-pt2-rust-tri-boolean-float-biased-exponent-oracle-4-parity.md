# PR #6185 -- feat(B-0944 slice 5 pt2): Rust tri-boolean float (biased-exponent) — oracle #4 parity
...
|---|---|
| Number | 6185 |
| Title | feat(B-0944 slice 5 pt2): Rust tri-boolean float (biased-exponent) — oracle #4 parity |
...
## B-0944 slice 5 pt2 — Rust tri-boolean float (biased-exponent), oracle #4
...
Composes-with: B-0944 (slice 5 pt2) · C# #6184 · F# #6183 · TS #6172/#6173 · `monad-propagation-pattern-cross-language-substrate-shape`.
