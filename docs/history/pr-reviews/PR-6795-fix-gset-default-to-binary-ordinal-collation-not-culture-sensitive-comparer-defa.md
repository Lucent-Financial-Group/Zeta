# PR #6795 -- fix(GSet): default to binary/ordinal collation, not culture-sensitive Comparer.Default (B-0969)
...
|---|---|
| Number | 6795 |
| Title | fix(GSet): default to binary/ordinal collation, not culture-sensitive Comparer.Default (B-0969) |
