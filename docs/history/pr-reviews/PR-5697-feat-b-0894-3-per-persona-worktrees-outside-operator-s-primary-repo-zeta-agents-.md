# PR #5697 -- feat(B-0894.3): per-persona worktrees outside operator's primary repo — ~/.zeta/agents/<persona>/<stream>/ canonical
...
|---|---|
| Number | 5697 |
| Title | feat(B-0894.3): per-persona worktrees outside operator's primary repo — ~/.zeta/agents/<persona>/<stream>/ canonical |
...
- **B-0894** (parent, PR #5696, merged `d3962a9ef`) — reboot-survival fix; this PR refines location
...
- **B-0894.1 bus envelope migration** to `~/.zeta/bus/`
- **B-0894.2 worktree-pool primitive** (long-term mechanization)
...
- [x] B-0894.3 backlog row authored with substrate-inventory + composes_with + operator-verbatim
