...
```
docs(b-0258): document ordering/formatting contract; close 081KR2E4K0008QG0R001E27DDV

081KR2E4K0008QG0R001E27DDV (MEMORY.md index generator) was implemented under 081KRCQQF0008QG0R0037YYP1A
...
- docs/backlog/P1/081KR2E4K0008QG0R001E27DDV-*.md: status open → closed; add pre-start
...
- 081KR2E4K0008QG0R001E27DDV backlog doc: add blank lines around lists (MD032)
