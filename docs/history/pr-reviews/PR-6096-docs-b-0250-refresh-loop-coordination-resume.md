# PR #6096 -- docs(B-0250): refresh loop coordination resume
...
|---|---|
| Number | 6096 |
| Title | docs(B-0250): refresh loop coordination resume |
...
## Summary
- refresh autonomous-loop coordination RESUME after #6095 landed the B-0250 loop-run receipt source
