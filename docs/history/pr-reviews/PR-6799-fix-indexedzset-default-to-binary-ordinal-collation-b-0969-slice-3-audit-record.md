# PR #6799 -- fix(IndexedZSet): default to binary/ordinal collation (B-0969 slice 3) + audit record
...
|---|---|
| Number | 6799 |
| Title | fix(IndexedZSet): default to binary/ordinal collation (B-0969 slice 3) + audit record |
