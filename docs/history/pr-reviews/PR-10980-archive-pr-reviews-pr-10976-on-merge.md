# PR #10980 -- archive(pr-reviews): PR #10976 on merge
...
|---|---|
| Number | 10980 |
| Title | archive(pr-reviews): PR #10976 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T17:45:23Z |
| Merged at | 2026-08-16T18:27:52Z |
| Merge commit SHA | `b486c4a1c5e731e66e128736ead4d5217a7b5a69` |
| Branch | `automation/pr-archive-10976-run-31962518463-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/10980 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #10976
...
PR title: feat(competence): event source for per-(agent,hat,jurisdiction) competence — use is the determinator, agreement is only the prior
Workflow run: 31962518463
Workflow attempt: 1
