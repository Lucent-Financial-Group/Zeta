# PR #6086 -- feat(health): add B-0250 merged PR event adapter
...
|---|---|
| Number | 6086 |
| Title | feat(health): add B-0250 merged PR event adapter |
...
Summary:
- Add merged-PR metadata as the first real factory event observation source for B-0250 coincidence detection.
