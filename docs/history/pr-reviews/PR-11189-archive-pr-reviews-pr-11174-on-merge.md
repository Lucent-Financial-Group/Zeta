# PR #11189 -- archive(pr-reviews): PR #11174 on merge
...
|---|---|
| Number | 11189 |
| Title | archive(pr-reviews): PR #11174 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T23:29:49Z |
| Merged at | 2026-08-17T00:05:08Z |
| Merge commit SHA | `40ea5bd5a606a0852bdd1a112f2199327abdba27` |
| Branch | `automation/pr-archive-11174-run-31979255237-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11189 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11174
...
PR title: test(longhorn): prove a PVC actually BINDS — the closest thing to prod without prod
Workflow run: 31979255237
Workflow attempt: 1
