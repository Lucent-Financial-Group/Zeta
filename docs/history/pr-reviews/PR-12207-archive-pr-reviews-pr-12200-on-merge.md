# PR #12207 -- archive(pr-reviews): PR #12200 on merge
...
|---|---|
| Number | 12207 |
| Title | archive(pr-reviews): PR #12200 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-18T23:56:48Z |
| Merged at | 2026-08-19T00:03:59Z |
| Merge commit SHA | `2d99d6bfb152b0069bd7c6bcae00057e4de87ea2` |
| Branch | `automation/pr-archive-12200-run-32199247106-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/12207 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #12200
...
PR title: research(security): TPM 2.0 vs YubiHSM 2 — the isolation architectures are inverted, and the TPM has no tenants
Workflow run: 32199247106
Workflow attempt: 1
