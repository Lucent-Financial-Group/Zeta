# PR #12555 -- archive(pr-reviews): PR #12537 on merge
...
|---|---|
| Number | 12555 |
| Title | archive(pr-reviews): PR #12537 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-19T21:53:10Z |
| Merged at | 2026-08-20T17:46:28Z |
| Merge commit SHA | `99f605624e798717f6fc756b183f68bc3cd4a501` |
| Branch | `automation/pr-archive-12537-run-32306068234-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/12555 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #12537
...
PR title: docs(research): the forward-correlation instrument cannot be an observation — route it as an intervention
Workflow run: 32306068234
Workflow attempt: 1
