# PR #11983 -- archive(pr-reviews): PR #11975 on merge
...
|---|---|
| Number | 11983 |
| Title | archive(pr-reviews): PR #11975 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-18T14:56:55Z |
| Merged at | 2026-08-18T15:04:10Z |
| Merge commit SHA | `885725a9b670efd2777b20ce3cbbaf7ae80aedb1` |
| Branch | `automation/pr-archive-11975-run-32151319995-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11983 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11975
...
PR title: fix(archive): heal and guard the PR-review merge-time race — the archive kept 74.3% of review threads, not 21%
Workflow run: 32151319995
Workflow attempt: 1
