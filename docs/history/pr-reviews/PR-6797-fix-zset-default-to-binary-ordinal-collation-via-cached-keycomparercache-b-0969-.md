# PR #6797 -- fix(ZSet): default to binary/ordinal collation via cached KeyComparerCache (B-0969 slice 2)
...
|---|---|
| Number | 6797 |
| Title | fix(ZSet): default to binary/ordinal collation via cached KeyComparerCache (B-0969 slice 2) |
