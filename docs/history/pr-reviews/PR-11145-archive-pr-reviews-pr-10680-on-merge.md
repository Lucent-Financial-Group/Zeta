# PR #11145 -- archive(pr-reviews): PR #10680 on merge
...
|---|---|
| Number | 11145 |
| Title | archive(pr-reviews): PR #10680 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T22:31:04Z |
| Merged at | 2026-08-17T00:07:21Z |
| Merge commit SHA | `27ebd24c538cf42d49ba2bf5bcea8e12a412fc59` |
| Branch | `automation/pr-archive-10680-run-31976527399-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11145 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #10680
...
PR title: fix(entropy): derive the bits measure() is charged — two of them were on bijections
Workflow run: 31976527399
Workflow attempt: 1
