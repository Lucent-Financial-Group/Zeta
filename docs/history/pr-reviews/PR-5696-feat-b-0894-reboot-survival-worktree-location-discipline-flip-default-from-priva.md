# PR #5696 -- feat(B-0894): reboot-survival worktree-location discipline — flip default from /private/tmp/ to ~/Documents/src/repos/Zeta/worktrees/
...
|---|---|
| Number | 5696 |
| Title | feat(B-0894): reboot-survival worktree-location discipline — flip default from /private/tmp/ to ~/Documents/src/repos/Zeta/worktrees/ |
...
- [x] B-0894 backlog row authored with substrate-inventory pass + empirical anchor + composes_with
