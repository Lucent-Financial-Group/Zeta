# PR #6592 -- feat(infernet B-1000): Apache Arrow columnar message store — NaturalBatch + family adapters + batched product/divide + RecordBatch
...
|---|---|
| Number | 6592 |
| Title | feat(infernet B-1000): Apache Arrow columnar message store — NaturalBatch + family adapters + batched product/divide + RecordBatch |
