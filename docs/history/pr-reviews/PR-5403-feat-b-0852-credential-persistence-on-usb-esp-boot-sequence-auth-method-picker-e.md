...
- **`Copilot` (bot)** at 2026-05-27T05:50:48Z on `docs/backlog/P1/B-0852-credential-persistence-on-usb-esp-plus-boot-sequence-auth-method-picker-encrypted-blob-bound-to-usb-uuid-plus-operator-passphrase-aaron-2026-05-27.md`:60 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-27T06:02:10Z on `docs/backlog/P1/B-0852-credential-persistence-on-usb-esp-plus-boot-sequence-auth-method-picker-encrypted-blob-bound-to-usb-uuid-plus-operator-passphrase-aaron-2026-05-27.md`:60 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-27T06:02:11Z on `docs/backlog/P1/B-0852-credential-persistence-on-usb-esp-plus-boot-sequence-auth-method-picker-encrypted-blob-bound-to-usb-uuid-plus-operator-passphrase-aaron-2026-05-27.md`:12 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-27T06:02:11Z on `docs/backlog/P1/B-0852-credential-persistence-on-usb-esp-plus-boot-sequence-auth-method-picker-encrypted-blob-bound-to-usb-uuid-plus-operator-passphrase-aaron-2026-05-27.md`:90 (association: NONE)
...
```
feat(B-0852): credential persistence on USB ESP + boot-sequence auth-…
...
```
docs(B-0852): enrich Phase 2 with operator security model + Phase 1+2…
...
```
docs(B-0852): auto-recover-by-default + escape-hatch picker semantics…
...
```
docs(B-0852): fix Step 6.9/6.95 collision per Copilot review — picker…
...
```
docs(B-0852): declarative cred-manifest discipline (NOT imperative) p…
...
```
fix(B-0852): picker GATES Step 6.8 device-flow per Copilot P0 + move …
