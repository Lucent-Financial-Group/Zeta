# PR #4575 -- backlog(B-0696): substrate-surface-change bus envelope for cross-AI coordination
...
|---|---|
| Number | 4575 |
| Title | backlog(B-0696): substrate-surface-change bus envelope for cross-AI coordination |
...
- B-0689 (Otto-VSCode SENDER_IDS — `from` field pattern)
...
- [x] `BACKLOG.md` regenerated via `tools/backlog/generate-index.ts` to include B-0696
