# PR #2950 -- feat(081KRA5AR0008QG0R0011ZGRZT/4): peer-call smoke tests — verify all 8 wrappers respond to --help
...
|---|---|
| Number | 2950 |
| Title | feat(081KRA5AR0008QG0R0011ZGRZT/4): peer-call smoke tests — verify all 8 wrappers respond to --help |
...
Addresses 081KRA5AR0008QG0R0011ZGRZT acceptance criterion 4: 4-wrapper (now 8-wrapper) smoke test.
...
- 081KRA5AR0008QG0R0011ZGRZT (acceptance #4 — this PR closes the criterion)
- PR #2946 (established 8-wrapper count this test enforces)
- PR #2949 (081KRA5AR0008QG0R0011ZGRZT acceptance #3 — self-documenting failure marker; in flight)
...
- **`Copilot` (bot)** at 2026-05-13T06:13:57Z on `tools/peer-call/smoke.test.ts`:31 (association: NONE)
  ...
  <pre>
  The ‘out of scope’ list says “Cross-wrapper consensus (081KRA5AR0008QG0R0011ZGRZT acceptance #4 future work)”, but this file is explicitly implementing 081KRA5AR0008QG0R0011ZGRZT acceptance criterion #4 per the header/PR description. Update the acceptance reference here (or rephrase) to avoid contradicting the stated purpose of the test.
...
```
feat(081KRA5AR0008QG0R0011ZGRZT/4): peer-call smoke tests — verify all 8 wrappers respond…

… to --help

Addresses 081KRA5AR0008QG0R0011ZGRZT acceptance criterion 4: "Add a smoke test to
...
(081KR2E4K0008QG0R001HQF27C added kiro; 081KR2E4K0008QG0R002KNZ29V added claude).
...
- PR #2949 (081KRA5AR0008QG0R0011ZGRZT acceptance #3 — self-documenting failure marker;
  in flight)
...
```
fix(081KRA5AR0008QG0R0011ZGRZT/4): address Copilot+Codex round-1 findings on PR #2950
...
3. "Out of scope" list said "Cross-wrapper consensus (081KRA5AR0008QG0R0011ZGRZT
