...
```
feat(bg/audit): duplicate-row-id audit tool + 081KRFA460008QG0R00308W7FJ substrate-cleanu…

…p row

While resolving the 081KRFA460008QG0R001SXP0C2 ID collision (PR #3053), an inline audit
...
hygiene risk: a consumer of `id: 081KRA5AR0008QG0R000Y6102S` gets one of THREE files
...
- `docs/backlog/P1/081KRFA460008QG0R00308W7FJ-duplicate-row-id-substrate-cleanup-2026-05-13.md`
...
Empirical findings:
- 559 rows scanned
- 12 collision groups (1 three-way: 081KRA5AR0008QG0R000Y6102S; 11 pairs)
- Most pairs are P1-vs-P2 cross-priority bleed (Otto-Desktop vs
  parallel agents filing in overlapping ranges)
- The 081KQ8P5D0008QG0R0002TN22C.x sub-rows show a within-priority decomposition race
  (Riven's atomic-children sweep vs earlier 081KQ8P5D0008QG0R0002TN22C decomposition,
  both 2026-05-10/11)
