# PR #5669 -- feat(B-0867.5+): work-lifecycle state machine — backlog → claim → PR → review (cycle N times) → merge (operator 2026-05-28 question answered)
...
|---|---|
| Number | 5669 |
| Title | feat(B-0867.5+): work-lifecycle state machine — backlog → claim → PR → review (cycle N times) → merge (operator 2026-05-28 question answered) |
...
```
feat(B-0867.5+): work-lifecycle state machine — backlog → claim → PR …
