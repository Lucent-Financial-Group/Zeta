# PR #3005 -- docs(agent-best-practices): add docs/launch/** to persona-naming closed-list (closes 081KRFA460008QG0R000NVM36W)
...
|---|---|
| Number | 3005 |
| Title | docs(agent-best-practices): add docs/launch/** to persona-naming closed-list (closes 081KRFA460008QG0R000NVM36W) |
...
Implements the policy amendment proposed in 081KRFA460008QG0R000NVM36W (PR #3002 — just merged): adds \`docs/launch/**\` to the persona-naming closed-list in \`docs/AGENT-BEST-PRACTICES.md\`.
...
- 081KRFA460008QG0R000NVM36W (PR #3002 — backlog row proposing this amendment, just merged)
