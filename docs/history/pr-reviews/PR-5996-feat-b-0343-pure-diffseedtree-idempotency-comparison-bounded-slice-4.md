# PR #5996 -- feat(B-0343): pure diffSeedTree idempotency comparison (bounded slice 4)
...
|---|---|
| Number | 5996 |
| Title | feat(B-0343): pure diffSeedTree idempotency comparison (bounded slice 4) |
