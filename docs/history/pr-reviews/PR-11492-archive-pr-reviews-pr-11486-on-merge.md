# PR #11492 -- archive(pr-reviews): PR #11486 on merge
...
|---|---|
| Number | 11492 |
| Title | archive(pr-reviews): PR #11486 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-17T14:23:05Z |
| Merged at | 2026-08-17T14:44:24Z |
| Merge commit SHA | `b99c053cb0f11ea256d94a8160acb0309b253121` |
| Branch | `automation/pr-archive-11486-run-32038806341-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11492 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11486
...
PR title: fix(ci): unrelated PRs went red because GitHub throttled the eprover tarball
Workflow run: 32038806341
Workflow attempt: 1
