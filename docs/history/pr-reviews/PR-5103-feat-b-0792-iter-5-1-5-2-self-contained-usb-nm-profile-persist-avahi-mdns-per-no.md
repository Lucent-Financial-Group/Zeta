...
```
feat(B-0792 iter-5.1): persist NetworkManager profiles from live inst…
...
```
feat(B-0792 iter-5.2): per-node hostname injection — decouple hostnam…
...
```
fix(B-0792 iter-5.1+5.2): 4 Copilot findings — Step 6.5 dup, personal…
