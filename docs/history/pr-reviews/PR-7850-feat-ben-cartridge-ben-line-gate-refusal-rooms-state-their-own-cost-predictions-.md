# PR #7850 -- feat(ben): cartridge `ben` line + gate refusal — rooms state their own cost predictions (B-1039)
...
|---|---|
| Number | 7850 |
| Title | feat(ben): cartridge `ben` line + gate refusal — rooms state their own cost predictions (B-1039) |
