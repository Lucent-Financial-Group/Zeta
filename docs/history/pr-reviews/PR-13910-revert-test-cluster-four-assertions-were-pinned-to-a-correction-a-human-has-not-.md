# PR #13910 -- Revert "test(cluster): four assertions were pinned to a correction a human has not taken" — the tree moved, so the tests follow it
...
|---|---|
| Number | 13910 |
| Title | Revert "test(cluster): four assertions were pinned to a correction a human has not taken" — the tree moved, so the tests follow it |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-22T20:11:47Z |
| Merged at | 2026-08-22T20:25:38Z |
| Merge commit SHA | `ea101dd22e8c763472d744f9a06d2d7eba61a901` |
| Branch | `shadow-revert-14-world` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/13910 |
| Changed files | 2 |
| Additions / deletions | +30 / -61 |
