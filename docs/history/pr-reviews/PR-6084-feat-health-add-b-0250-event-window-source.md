# PR #6084 -- feat(health): add B-0250 event-window source
...
|---|---|
| Number | 6084 |
| Title | feat(health): add B-0250 event-window source |
...
Summary:
- Add pure bounded event-window coincidence detection for B-0250.
