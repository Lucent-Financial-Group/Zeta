# PR #4385 -- feat(B-0620.5): decompose slice 5 category-classifier from 4023
...
|---|---|
| Number | 4385 |
| Title | feat(B-0620.5): decompose slice 5 category-classifier from 4023 |
...
- **Path**: `docs/backlog/P2/B-0620-slice-5-category-classifier.md`
- **Replies**: 0
...
- `docs/backlog/P2/B-0620-slice-5-category-classifier.md`

**Message:**

```
feat(B-0620.5): decompose slice 5 from blob PR 4023
```
