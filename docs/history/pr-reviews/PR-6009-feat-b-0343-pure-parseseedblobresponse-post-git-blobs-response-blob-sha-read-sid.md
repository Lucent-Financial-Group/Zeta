# PR #6009 -- feat(B-0343): pure parseSeedBlobResponse — POST /git/blobs response → blob SHA (read-side pair of buildSeedBlobRequest)
...
|---|---|
| Number | 6009 |
| Title | feat(B-0343): pure parseSeedBlobResponse — POST /git/blobs response → blob SHA (read-side pair of buildSeedBlobRequest) |
