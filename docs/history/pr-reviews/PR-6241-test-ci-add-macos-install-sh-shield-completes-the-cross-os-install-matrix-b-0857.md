# PR #6241 -- test(ci): add macOS install.sh shield — completes the cross-OS install matrix (B-0857)
...
|---|---|
| Number | 6241 |
| Title | test(ci): add macOS install.sh shield — completes the cross-OS install matrix (B-0857) |
