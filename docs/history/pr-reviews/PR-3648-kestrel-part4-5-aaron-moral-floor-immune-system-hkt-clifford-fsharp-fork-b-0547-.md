...
- A: \`docs/backlog/P2/081KRMEXM0008QG0R001VGNET5-intelligent-compiler-recursive-hkt-clifford-fsharp-fork-roslyn-source-generators-linq-csharp-substrate-representation-*.md\` (the synthesis backlog row)
