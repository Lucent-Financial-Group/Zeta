# PR #10944 -- archive(pr-reviews): PR #10942 on merge
...
|---|---|
| Number | 10944 |
| Title | archive(pr-reviews): PR #10942 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T15:51:20Z |
| Merged at | 2026-08-16T17:25:57Z |
| Merge commit SHA | `6536c83a661dbc5d9850cfd10fe0c8d322f0eca5` |
| Branch | `automation/pr-archive-10942-run-31956866716-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/10944 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #10942
...
PR title: design(fpga): Z-set join uncomputes cleanly at O(W²) ancilla — and an FPGA cannot measure Landauer
Workflow run: 31956866716
Workflow attempt: 1
