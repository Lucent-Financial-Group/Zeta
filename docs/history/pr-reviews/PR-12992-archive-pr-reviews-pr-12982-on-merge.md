# PR #12992 -- archive(pr-reviews): PR #12982 on merge
...
|---|---|
| Number | 12992 |
| Title | archive(pr-reviews): PR #12982 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-20T23:56:01Z |
| Merged at | 2026-08-20T23:59:38Z |
| Merge commit SHA | `7e880ef71ebc004a4565002391c2a4393e443e0a` |
| Branch | `automation/pr-archive-12982-run-32430624769-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/12992 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #12982
...
PR title: setup: the YubiHSM SDK is a brew CASK, not a formula — and pkcs11-tool was missing everywhere
Workflow run: 32430624769
Workflow attempt: 1
