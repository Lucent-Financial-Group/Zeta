# PR #7630 -- docs(hardware): NVIDIA GPUs in hand and ready — shader rung jumps the queue (matrix + B-1025/B-1026)
...
|---|---|
| Number | 7630 |
| Title | docs(hardware): NVIDIA GPUs in hand and ready — shader rung jumps the queue (matrix + B-1025/B-1026) |
