...
```
feat(B-0754): zero-typing USB install — first-boot service + nmtui fa…
...
acceptance criteria from B-0754:
...
```
feat(B-0754): greedy N-disk auto-shape — enumerate all internal disks…
...
Composes with B-0754 v1 ZETA_AUTO_CONFIRM=WIPE bypass (unchanged)
...
```
fix(B-0754): P0 Copilot catches — export BOOT_DISK=auto + drop stale …
