# PR #11973 -- archive(pr-reviews): PR #11963 on merge
...
|---|---|
| Number | 11973 |
| Title | archive(pr-reviews): PR #11963 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-18T14:32:29Z |
| Merged at | 2026-08-18T14:38:19Z |
| Merge commit SHA | `1473db4ab876937d6a36d385d626ecf933c790bf` |
| Branch | `automation/pr-archive-11963-run-32148888758-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11973 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11963
...
PR title: feat(cover-acyclicity): ship the GYO alpha-acyclicity criterion with certificates and a semantic falsifier
Workflow run: 32148888758
Workflow attempt: 1
