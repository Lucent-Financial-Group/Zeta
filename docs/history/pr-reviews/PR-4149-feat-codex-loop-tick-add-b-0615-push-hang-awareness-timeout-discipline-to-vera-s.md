# PR #4149 -- feat(codex-loop-tick): add 081KRW63S0008QG0R000EAZ9K2 push-hang awareness + timeout discipline to Vera's spawned prompt
...
|---|---|
| Number | 4149 |
| Title | feat(codex-loop-tick): add 081KRW63S0008QG0R000EAZ9K2 push-hang awareness + timeout discipline to Vera's spawned prompt |
...
Cross-agent consistency: Vera (Codex) gets the same 081KRW63S0008QG0R000EAZ9K2 awareness Otto (Claude) got in [PR #4146](https://github.com/Lucent-Financial-Group/Zeta/pull/4146).

## What

Three sentences appended to Vera's `refresh-worldview` prompt block:

1. **Wrap refresh-worldview in `timeout --kill-after=5s 30s`** — was unwrapped, vulnerable to the same fetch-orphan failure mode 081KRW63S0008QG0R000EAZ9K2 documents.
...
- [081KRW63S0008QG0R000EAZ9K2](docs/backlog/P3/081KRW63S0008QG0R000EAZ9K2-claude-code-bash-tool-orphans-git-fetch-subprocesses-under-saturation-self-saturation-feedback-loop-2026-05-18.md) (the open bug class)
...
```
feat(codex-loop-tick): add 081KRW63S0008QG0R000EAZ9K2 push-hang awareness + timeout disci…
