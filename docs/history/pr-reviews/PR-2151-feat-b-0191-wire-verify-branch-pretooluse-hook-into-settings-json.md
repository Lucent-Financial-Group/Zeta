# PR #2151 -- feat(081KQR4HQ0008QG0R002YNV361): wire verify-branch PreToolUse hook into settings.json
...
|---|---|
| Number | 2151 |
| Title | feat(081KQR4HQ0008QG0R002YNV361): wire verify-branch PreToolUse hook into settings.json |
...
- **Wires** the existing `verify-branch-pretooluse.ts` hook into `.claude/settings.json` as a `PreToolUse` hook with `"matcher": "Bash"` — completing 081KQR4HQ0008QG0R002YNV361 acceptance criteria #2 (hook wired into settings.json)
