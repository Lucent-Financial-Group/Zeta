# PR #6090 -- deps: Bump actions/upload-artifact from 4.4.3 to 7.0.1
...
|---|---|
| Number | 6090 |
| Title | deps: Bump actions/upload-artifact from 4.4.3 to 7.0.1 |
| Author | `app/dependabot` (bot) |
| State | MERGED |
| Created at | 2026-05-30T07:14:01Z |
| Merged at | 2026-05-30T07:18:23Z |
| Merge commit SHA | `56b1f6f74c1c8d0e699ae6c0f5960546d9d5ba48` |
| Branch | `dependabot/github_actions/actions/upload-artifact-7.0.1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/6090 |
| Changed files | 2 |
| Additions / deletions | +4 / -4 |

## Description

Bumps [actions/upload-artifact](https://github.com/actions/upload-artifact) from 4.4.3 to 7.0.1.
<details>
...
<li>Additional commits viewable in <a href="https://github.com/actions/upload-artifact/compare/v4.4.3...043fb46d1a93c77aae656e7c1c64a875d1fc6a0a">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=actions/upload-artifact&package-manager=github_actions&previous-version=4.4.3&new-version=7.0.1)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
