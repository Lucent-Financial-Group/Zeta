# PR #7639 -- feat(hardware): B-1024 slice 1 — aarch64 ISO builds AND boots in CI (QEMU virt + EDK2) + multi-boot CYOA boot-screen design
...
|---|---|
| Number | 7639 |
| Title | feat(hardware): B-1024 slice 1 — aarch64 ISO builds AND boots in CI (QEMU virt + EDK2) + multi-boot CYOA boot-screen design |
