# PR #16648 -- deps: bump vite from 7.3.6 to 8.2.2 in /src/Renderers/website
...
|---|---|
| Number | 16648 |
| Title | deps: bump vite from 7.3.6 to 8.2.2 in /src/Renderers/website |
| Author | `app/dependabot` (bot) |
| State | MERGED |
| Created at | 2026-09-05T07:22:43Z |
| Merged at | 2026-09-05T08:33:01Z |
| Merge commit SHA | `8f173e082a28eccd6dabaaaad72189eda6437da7` |
| Branch | `dependabot/npm_and_yarn/src/Renderers/website/vite-8.2.2` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/16648 |
| Changed files | 2 |
| Additions / deletions | +240 / -194 |
