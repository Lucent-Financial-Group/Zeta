# PR #11514 -- archive(pr-reviews): PR #11502 on merge
...
|---|---|
| Number | 11514 |
| Title | archive(pr-reviews): PR #11502 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-17T14:51:13Z |
| Merged at | 2026-08-17T15:55:29Z |
| Merge commit SHA | `835906fd0d0b0651291205fc609604da3b3b7bf0` |
| Branch | `automation/pr-archive-11502-run-32040395860-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11514 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11502
...
PR title: feat(zflash): joining node gets an address — static segment addressing, not DHCP or mDNS
Workflow run: 32040395860
Workflow attempt: 1
