# PR #12465 -- archive(pr-reviews): PR #12458 on merge
...
|---|---|
| Number | 12465 |
| Title | archive(pr-reviews): PR #12458 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-19T17:30:31Z |
| Merged at | 2026-08-19T17:42:53Z |
| Merge commit SHA | `c130faeac09c2fbbbc065100d26553cdcd756140` |
| Branch | `automation/pr-archive-12458-run-32281902450-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/12465 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #12458
...
PR title: ci(gate): macOS joins Windows as a non-blocking drift check — the floor narrows to Linux
Workflow run: 32281902450
Workflow attempt: 1
