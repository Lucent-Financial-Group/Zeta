# PR #3043 -- feat(bus): 081KRFA460008QG0R001SXP0C2 — add worktree field to claim envelope
...
|---|---|
| Number | 3043 |
| Title | feat(bus): 081KRFA460008QG0R001SXP0C2 — add worktree field to claim envelope |
...
Implements [081KRFA460008QG0R001SXP0C2](https://github.com/Lucent-Financial-Group/Zeta/blob/main/docs/backlog/P2/081KRFA460008QG0R001SXP0C2-bus-claim-envelope-worktree-field-multi-surface-disambiguation-2026-05-13.md) — adds `worktree?: string` to `ClaimPayload` so the claim envelope captures the worktree path the claim was acquired from. Closes Otto-Desktop's identified follow-up gap filed in [#3038](https://github.com/Lucent-Financial-Group/Zeta/pull/3038).
...
```
feat(bus): 081KRFA460008QG0R001SXP0C2 — add worktree field to claim envelope

Implements Otto-Desktop's identified follow-up gap (081KRFA460008QG0R001SXP0C2 row filed in
...
Design decision recorded substrate-honestly in the 081KRFA460008QG0R001SXP0C2 row:
...
Composes with:
- 081KR7JY10008QG0R000R503K2 (bus protocol root) — extends the existing schema
- 081KR7JY10008QG0R000R503K2 slice 3 / PR #2939 (claim-coordinator implementation)
- PR #3037 (SENDER_IDS schema extension — sibling surface-level fix)
