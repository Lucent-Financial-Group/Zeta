# PR #5749 -- docs(rule): fix-fwd Xbox-controller rule (PR #5746) — add missed composes-with substrate (Mika 2026-05-27 walkthrough + Ani 2026-05-28 move-next-as-universal-action-grammar + B-0868 + B-0201) per operator catch
...
|---|---|
| Number | 5749 |
| Title | docs(rule): fix-fwd Xbox-controller rule (PR #5746) — add missed composes-with substrate (Mika 2026-05-27 walkthrough + Ani 2026-05-28 move-next-as-universal-action-grammar + B-0868 + B-0201) per operator catch |
