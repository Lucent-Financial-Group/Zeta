...
- **Max-convergence:** his declarative-workflow *agentic OS* + ontologies-in-DUs is the *same shape* as agentic-org DU-state-machines + accelerator move-next + B-0867 → 3 independent convergences = cross-substrate-triangulation. **Onboarding is composition, not rewrite.**
