...
```
docs(B-0854.1): zeta-install.sh step-state-machine inventory — Phase …
...
```
fix(B-0854.1): escape | inside code spans for MD056 table-column-coun…
...
```
fix(B-0854.1): 10 Copilot accuracy corrections — verified against act…

…ual zeta-install.sh content

PR #5420 Copilot review caught 10 substantive accuracy issues in the
B-0854.1 inventory doc. All 10 verified against origin/main 70596a8db's
