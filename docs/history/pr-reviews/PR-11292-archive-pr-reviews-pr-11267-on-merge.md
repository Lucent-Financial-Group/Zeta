# PR #11292 -- archive(pr-reviews): PR #11267 on merge
...
|---|---|
| Number | 11292 |
| Title | archive(pr-reviews): PR #11267 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-17T02:53:40Z |
| Merged at | 2026-08-17T03:08:44Z |
| Merge commit SHA | `082bd7226fbebf26e6a963fc23dfbf84d38c8267` |
| Branch | `automation/pr-archive-11267-run-31989357246-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11292 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11267
...
PR title: ci: split the TS suite into a hermetic tier and an environment-dependent tier
Workflow run: 31989357246
Workflow attempt: 1
