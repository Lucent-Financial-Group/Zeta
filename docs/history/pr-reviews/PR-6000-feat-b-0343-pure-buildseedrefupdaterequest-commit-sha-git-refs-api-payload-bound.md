# PR #6000 -- feat(B-0343): pure buildSeedRefUpdateRequest — commit SHA → git-refs API payload (bounded slice 8)
...
|---|---|
| Number | 6000 |
| Title | feat(B-0343): pure buildSeedRefUpdateRequest — commit SHA → git-refs API payload (bounded slice 8) |
