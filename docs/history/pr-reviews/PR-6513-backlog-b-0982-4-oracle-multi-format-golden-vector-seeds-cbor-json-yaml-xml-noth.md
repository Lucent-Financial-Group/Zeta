# PR #6513 -- backlog(B-0982): 4-oracle multi-format golden-vector seeds (CBOR/JSON/YAML/XML) — nothing is single source of truth
...
|---|---|
| Number | 6513 |
| Title | backlog(B-0982): 4-oracle multi-format golden-vector seeds (CBOR/JSON/YAML/XML) — nothing is single source of truth |
