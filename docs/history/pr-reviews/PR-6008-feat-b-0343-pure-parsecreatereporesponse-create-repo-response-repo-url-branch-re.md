# PR #6008 -- feat(B-0343): pure parseCreateRepoResponse — create-repo response → repo URL + branch (read-side pair)
...
|---|---|
| Number | 6008 |
| Title | feat(B-0343): pure parseCreateRepoResponse — create-repo response → repo URL + branch (read-side pair) |
