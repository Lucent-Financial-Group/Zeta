# PR #6800 -- fix(Core): ordinal collation for Hierarchy/Residuated/Aggregate — F# core audit COMPLETE (B-0969)
...
|---|---|
| Number | 6800 |
| Title | fix(Core): ordinal collation for Hierarchy/Residuated/Aggregate — F# core audit COMPLETE (B-0969) |
