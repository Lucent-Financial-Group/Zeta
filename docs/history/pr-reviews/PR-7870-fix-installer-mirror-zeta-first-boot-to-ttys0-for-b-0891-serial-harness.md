# PR #7870 -- fix(installer): mirror zeta-first-boot to ttyS0 for B-0891 serial harness
...
|---|---|
| Number | 7870 |
| Title | fix(installer): mirror zeta-first-boot to ttyS0 for B-0891 serial harness |
