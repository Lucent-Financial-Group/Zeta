# PR #6225 -- ci(windows): Slice 2c — Server-Core Docker test of install.ps1, green on windows-2025 (B-0857)
...
|---|---|
| Number | 6225 |
| Title | ci(windows): Slice 2c — Server-Core Docker test of install.ps1, green on windows-2025 (B-0857) |
