# PR #11170 -- archive(pr-reviews): PR #11163 on merge
...
|---|---|
| Number | 11170 |
| Title | archive(pr-reviews): PR #11163 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T23:04:08Z |
| Merged at | 2026-08-16T23:25:12Z |
| Merge commit SHA | `55f71412d80a2aaeabab3377087e001e1a7e1efe` |
| Branch | `automation/pr-archive-11163-run-31978050957-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11170 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11163
...
PR title: fix(installer): picker forwards iSerial and UEFI keyfile binding
Workflow run: 31978050957
Workflow attempt: 1
