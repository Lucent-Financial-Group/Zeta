# PR #12486 -- archive(pr-reviews): PR #12479 on merge
...
|---|---|
| Number | 12486 |
| Title | archive(pr-reviews): PR #12479 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-19T18:20:31Z |
| Merged at | 2026-08-19T18:31:49Z |
| Merge commit SHA | `f1f634cf48ae6307451499f156def6f98cae76a4` |
| Branch | `automation/pr-archive-12479-run-32286722195-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/12486 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #12479
...
PR title: docs(security): model the measured YubiHSM findings in BOTH threat models, and red-team the attestation claim
Workflow run: 32286722195
Workflow attempt: 1
