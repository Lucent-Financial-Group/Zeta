# PR #7893 -- doc(B-0883): design better git-crypt post-quantum lattice-based architecture and relocate TS files
...
|---|---|
| Number | 7893 |
| Title | doc(B-0883): design better git-crypt post-quantum lattice-based architecture and relocate TS files |
...
| Branch | `lior/claim-better-gitcrypt-B-0883` |
| Base branch | `main` |
...
Why:
- Backlog item B-0883 requires a design specification for Better Git-Crypt resolving access revocation, review visibility, and post-quantum readiness.
