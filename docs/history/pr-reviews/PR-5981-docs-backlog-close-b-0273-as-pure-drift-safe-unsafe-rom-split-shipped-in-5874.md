...
- **`Copilot` (bot)** at 2026-05-29T12:25:55Z on `docs/backlog/P1/B-0273-atari-rom-safe-unsafe-folder-split-2026-05-08.md`:59 (association: NONE)
...
**Replies:**
  ...
  - **`AceHack` (human)** at 2026-05-29T12:30:41Z on `docs/backlog/P1/B-0273-atari-rom-safe-unsafe-folder-split-2026-05-08.md`:59 (association: MEMBER)
...
```
docs(backlog): close B-0273 as pure drift — safe/unsafe ROM split shi…
...
```
fix(backlog): reword B-0273 verification prose to clear MD032 + leadi…
