# PR #11307 -- archive(pr-reviews): PR #10843 on merge
...
|---|---|
| Number | 11307 |
| Title | archive(pr-reviews): PR #10843 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-17T03:25:53Z |
| Merged at | 2026-08-17T03:38:04Z |
| Merge commit SHA | `cf5fa63d398e6da3fb5391341c0e69bd1fb2a2d1` |
| Branch | `automation/pr-archive-10843-run-31991103755-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11307 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #10843
...
PR title: docs(consent): withhold a private individual's name; cite the published UX sources instead
Workflow run: 31991103755
Workflow attempt: 1
