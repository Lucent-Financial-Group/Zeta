# PR #1260 -- tools(substrate-claim-checker): v0 — count-drift detection + 081KQNJ500008QG0R003SCWBDV
...
|---|---|
| Number | 1260 |
| Title | tools(substrate-claim-checker): v0 — count-drift detection + 081KQNJ500008QG0R003SCWBDV |
...
- **`docs/backlog/P1/081KQNJ500008QG0R003SCWBDV-substrate-claim-checker-ts-tool-aaron-2026-05-03.md`** — backlog row with done-criteria + remaining 6 sub-classes mapped to v1+
...
- **081KQJZR90008QG0R002D6XYHB** (decision-archaeology skill) — same author per Aaron's skill-design rule (skills as hubs, knowledge in docs); this tool is one of the TS files the SKILL.md will eventually call
...
- [x] 081KQNJ500008QG0R003SCWBDV backlog row filed with done-criteria + 6 remaining sub-classes mapped to v1
- [x] depends_on: [] populated (no prereqs); composes_with: [081KQJZR90008QG0R002D6XYHB]
- [ ] CI green
...
- **`Copilot` (bot)** at 2026-05-03T01:07:58Z on `docs/backlog/P1/081KQNJ500008QG0R003SCWBDV-substrate-claim-checker-ts-tool-aaron-2026-05-03.md`:52 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-03T01:21:43Z on `docs/backlog/P1/081KQNJ500008QG0R003SCWBDV-substrate-claim-checker-ts-tool-aaron-2026-05-03.md`:18 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-03T01:33:30Z on `docs/BACKLOG.md`:51 (association: NONE)
  docs/BACKLOG.md is marked AUTO-GENERATED by tools/backlog/generate-index.sh, and CI enforces it matches the per-row files. This new 081KQNJ500008QG0R003SCWBDV entry text does not match the `title:` in docs/backlog/P1/081KQNJ500008QG0R003SCWBDV-...md (it includes a different parenthetical), so the generator drift check will fail. Regenerate docs/BACKLOG.md from the row file rather than editing this line manually.
...
- **`Copilot` (bot)** at 2026-05-03T01:33:30Z on `docs/hygiene-history/ticks/2026/05/03/0128Z.md`:1 (association: NONE)
  This tick row claims changes that don’t match the code/docs added in this PR (e.g., it references v0.4.3, and says README + 081KQNJ500008QG0R003SCWBDV removed specific "19+"/"20+" count claims, but those counts still appear in the README and 081KQNJ500008QG0R003SCWBDV content in this diff). Please correct the tick entry to reflect what actually changed in this PR so the hygiene-history log stays accurate.
...
081KQNJ500008QG0R003SCWBDV backlog row filed with done-criteria, depends_on:[],
composes_with [081KQJZR90008QG0R002D6XYHB decision-archaeology], canonical mapping
...
- **markdownlint MD032** in 081KQNJ500008QG0R003SCWBDV — added blank line before
...
```
review(pr-1260): v0.3 — separator regex + import.meta.main + 081KQNJ500008QG0R003SCWBDV s…
...
3. **081KQNJ500008QG0R003SCWBDV sub-class table mis-claim** — row "Frontmatter ↔
...
2. **(false positive)** docs/BACKLOG.md flagged as
   ...
   081KQNJ500008QG0R003SCWBDV was added; the diff is the auto-generated entry. No
   action needed.
...
```
review(pr-1260): v0.4.3 — bun:test unit tests + README/081KQNJ500008QG0R003SCWBDV count d…
...
3. **(real, fixed)** 081KQNJ500008QG0R003SCWBDV cited "19+" — same drift class.
...
review on 081KQJZR90008QG0R002D6XYHB (worked-examples-are-the-dry-run-eval-set).
...
worked-examples-are-the-eval-set finding. README + 081KQNJ500008QG0R003SCWBDV count
...
4. **(real, fixed)** BACKLOG.md auto-generated; regenerated to
   pick up 081KQNJ500008QG0R003SCWBDV title from the per-row file (drift was caused
...
5. **(real, fixed)** Remaining 19+/20+ claims:
   ...
   - 081KQNJ500008QG0R003SCWBDV line 18: "catalogues 19+ distinct" → "catalogues N
     distinct"
   - 081KQNJ500008QG0R003SCWBDV line 22: "19+ instances of substrate-authoring" →
     "N instances"
   - 081KQNJ500008QG0R003SCWBDV line 23: "19 × 20min ≈ 6 hours" → "compound to many
     hours"
   - 081KQNJ500008QG0R003SCWBDV line 71: "19+ historical drift instances" → "N
