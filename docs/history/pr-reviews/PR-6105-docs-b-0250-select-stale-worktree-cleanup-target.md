# PR #6105 -- docs(B-0250): select stale worktree cleanup target
...
|---|---|
| Number | 6105 |
| Title | docs(B-0250): select stale worktree cleanup target |
...
## Summary
- adds a B-0250 cleanup-selection packet for one clean local-only stale worktree
