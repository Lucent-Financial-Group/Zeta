# PR #11996 -- archive(pr-reviews): PR #11988 on merge
...
|---|---|
| Number | 11996 |
| Title | archive(pr-reviews): PR #11988 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-18T15:27:35Z |
| Merged at | 2026-08-18T15:34:07Z |
| Merge commit SHA | `2a7081eab7df2693b122bae7d2035af49132f258` |
| Branch | `automation/pr-archive-11988-run-32154505774-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11996 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11988
...
PR title: fix(archive): resolve the archiver against the reconciler, not the target repo — the sweep would have failed quietly
Workflow run: 32154505774
Workflow attempt: 1
