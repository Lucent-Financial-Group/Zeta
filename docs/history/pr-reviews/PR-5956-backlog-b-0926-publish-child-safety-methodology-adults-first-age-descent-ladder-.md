# PR #5956 -- backlog(B-0926): publish child-safety methodology (adults-first + age-descent ladder + consent-stratification)
...
|---|---|
| Number | 5956 |
| Title | backlog(B-0926): publish child-safety methodology (adults-first + age-descent ladder + consent-stratification) |
...
Adds a public **Methodology** section to the merged constitutional safety floor (B-0926), per operator authorization 2026-05-29 ("i'm good with it too").
