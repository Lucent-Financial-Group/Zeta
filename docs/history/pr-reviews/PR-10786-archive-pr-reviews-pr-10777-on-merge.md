# PR #10786 -- archive(pr-reviews): PR #10777 on merge
...
|---|---|
| Number | 10786 |
| Title | archive(pr-reviews): PR #10777 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-15T13:54:27Z |
| Merged at | 2026-08-15T13:58:00Z |
| Merge commit SHA | `6bf3d9679329c68a94693747feddccc85c5400a2` |
| Branch | `automation/pr-archive-10777-run-31888438440-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/10786 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #10777
...
PR title: fix(transport): clear pendingCorruptFrames on desync
Workflow run: 31888438440
Workflow attempt: 1
