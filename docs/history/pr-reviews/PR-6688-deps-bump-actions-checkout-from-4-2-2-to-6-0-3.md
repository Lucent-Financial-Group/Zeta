# PR #6688 -- deps: Bump actions/checkout from 4.2.2 to 6.0.3
...
|---|---|
| Number | 6688 |
| Title | deps: Bump actions/checkout from 4.2.2 to 6.0.3 |
| Author | `app/dependabot` (bot) |
| State | MERGED |
| Created at | 2026-06-06T07:15:16Z |
| Merged at | 2026-06-07T13:43:12Z |
| Merge commit SHA | `c09192cfa97983d8320bfb1790d09a28b6bffb36` |
| Branch | `dependabot/github_actions/actions/checkout-6.0.3` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/6688 |
| Changed files | 41 |
| Additions / deletions | +62 / -62 |

## Description

Bumps [actions/checkout](https://github.com/actions/checkout) from 4.2.2 to 6.0.3.
<details>
...
<li>Additional commits viewable in <a href="https://github.com/actions/checkout/compare/v4.2.2...df4cb1c069e1874edd31b4311f1884172cec0e10">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=actions/checkout&package-manager=github_actions&previous-version=4.2.2&new-version=6.0.3)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
