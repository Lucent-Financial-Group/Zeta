...
- **Path**: `docs/backlog/P3/081KRQ1AB0008QG0R001KQ9S4B-worktree-pool-primitive-per-otto-identity-2026-05-16.md`
- **Replies**: 0

**Initial comment:**

- **`Copilot` (bot)** at 2026-05-16T14:35:22Z on `docs/backlog/P3/081KRQ1AB0008QG0R001KQ9S4B-worktree-pool-primitive-per-otto-identity-2026-05-16.md`:12 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-16T14:35:22Z on `docs/backlog/P3/081KRQ1AB0008QG0R001KQ9S4B-worktree-pool-primitive-per-otto-identity-2026-05-16.md`:29 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-16T14:35:23Z on `docs/backlog/P3/081KRQ1AB0008QG0R001KQ9S4B-worktree-pool-primitive-per-otto-identity-2026-05-16.md`:55 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-16T14:35:23Z on `docs/backlog/P3/081KRQ1AB0008QG0R001KQ9S4B-worktree-pool-primitive-per-otto-identity-2026-05-16.md`:68 (association: NONE)
...
- `docs/BACKLOG.md`
- `docs/backlog/P3/081KRQ1AB0008QG0R001KQ9S4B-worktree-pool-primitive-per-otto-identity-2026-05-16.md`

**Message:**

```
backlog(081KRQ1AB0008QG0R001KQ9S4B): worktree-pool primitive — pre-allocated isolated sid…
...
re-applied to match current main's index state (081KRQ1AB0008QG0R003DYANMC now `[x]`).
...
sub-cases 3 + 4 need substrate engineering (081KRMEXM0008QG0R000X1PPGC + this row).
...
```
fix: MD032 blank-lines around lists in 081KRQ1AB0008QG0R001KQ9S4B file (lines 29 + 89)
...
…, type, 0715Z ref, git syntax, 081KRHWGX0008QG0R002DPG02X link, BACKLOG.md regen)
...
one-liner split into two commands; 081KRHWGX0008QG0R002DPG02X linked to its file).
