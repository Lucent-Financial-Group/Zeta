# PR #17344 -- deps: Bump types-pyyaml from 6.0.12.20260815 to 6.0.12.20260906 in /src/Core.Python
...
|---|---|
| Number | 17344 |
| Title | deps: Bump types-pyyaml from 6.0.12.20260815 to 6.0.12.20260906 in /src/Core.Python |
| Author | `app/dependabot` (bot) |
| State | MERGED |
| Created at | 2026-09-12T07:14:17Z |
| Merged at | 2026-09-12T14:02:09Z |
| Merge commit SHA | `630b4f24dfa33ed580e8fd2ff6e2bd44eed1a000` |
| Branch | `dependabot/uv/src/Core.Python/types-pyyaml-6.0.12.20260906` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/17344 |
| Changed files | 1 |
...
[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=types-pyyaml&package-manager=uv&previous-version=6.0.12.20260815&new-version=6.0.12.20260906)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
