# PR #9773 -- build(deps-dev): Bump vitest from 2.1.9 to 4.1.10 in /src/Renderers/website in the npm_and_yarn group across 1 directory
...
|---|---|
| Number | 9773 |
| Title | build(deps-dev): Bump vitest from 2.1.9 to 4.1.10 in /src/Renderers/website in the npm_and_yarn group across 1 directory |
| Author | `app/dependabot` (bot) |
| State | MERGED |
| Created at | 2026-07-17T23:30:16Z |
| Merged at | 2026-07-31T23:29:05Z |
| Merge commit SHA | `9537c55403157f4556f562936758637ad1da0e21` |
| Branch | `dependabot/npm_and_yarn/src/Renderers/website/npm_and_yarn-bc9680511c` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/9773 |
| Changed files | 1 |
| Additions / deletions | +1 / -1 |

## Description

Bumps the npm_and_yarn group with 1 update in the /src/Renderers/website directory: [vitest](https://github.com/vitest-dev/vitest/tree/HEAD/packages/vitest).
