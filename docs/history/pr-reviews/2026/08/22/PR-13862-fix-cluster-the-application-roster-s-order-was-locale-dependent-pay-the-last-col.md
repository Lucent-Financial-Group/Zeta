# PR #13862 -- fix(cluster): the Application roster's order was locale-dependent — pay the last collation debt row
...
|---|---|
| Number | 13862 |
| Title | fix(cluster): the Application roster's order was locale-dependent — pay the last collation debt row |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-22T18:30:23Z |
| Merged at | 2026-08-22T19:52:46Z |
| Merge commit SHA | `f6f22b9b8efd4943724a9f627b30a71fc741e74d` |
| Branch | `shadow-collation-argocd-roster` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/13862 |
| Changed files | 2 |
