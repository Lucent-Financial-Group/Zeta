# PR #13968 -- fix(heartbeats): data/ci-runs.jsonl needs merge=union — it is wedging every lane's tick
...
|---|---|
| Number | 13968 |
| Title | fix(heartbeats): data/ci-runs.jsonl needs merge=union — it is wedging every lane's tick |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-22T22:36:58Z |
| Merged at | 2026-08-22T22:46:59Z |
| Merge commit SHA | `453ed03e7d4bab8dc6b7688a41e314b568e8dcec` |
| Branch | `shadow-ci-runs-union-merge` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/13968 |
| Changed files | 2 |
