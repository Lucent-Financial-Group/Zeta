# PR #10749 -- deps: bump actions/upload-artifact from 4.6.2 to 7.0.1
...
|---|---|
| Number | 10749 |
| Title | deps: bump actions/upload-artifact from 4.6.2 to 7.0.1 |
| Author | `app/dependabot` (bot) |
| State | MERGED |
| Created at | 2026-08-15T07:23:16Z |
| Merged at | 2026-08-16T22:07:30Z |
| Merge commit SHA | `4ec9229487c486d2598cdd8837350714714d5d73` |
| Branch | `dependabot/github_actions/actions/upload-artifact-7.0.1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/10749 |
| Changed files | 1 |
