# PR #12264 -- archive(pr-reviews): PR #12252 on merge
...
|---|---|
| Number | 12264 |
| Title | archive(pr-reviews): PR #12252 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-19T02:48:37Z |
| Merged at | 2026-08-19T03:18:16Z |
| Merge commit SHA | `0a107500c9cb352576838d2fa5797fd65b85883b` |
| Branch | `automation/pr-archive-12252-run-32209850457-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/12264 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #12252
...
PR title: fix(ci): `gate (required)` publishes WHICH green it is, and names the legs that failed non-blockingly
Workflow run: 32209850457
Workflow attempt: 1
