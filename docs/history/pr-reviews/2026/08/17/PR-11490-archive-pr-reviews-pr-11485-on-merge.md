# PR #11490 -- archive(pr-reviews): PR #11485 on merge
...
|---|---|
| Number | 11490 |
| Title | archive(pr-reviews): PR #11485 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-17T14:17:16Z |
| Merged at | 2026-08-17T14:44:19Z |
| Merge commit SHA | `4c2cdf7477c00bd0559e9bc50760caea775f9feb` |
| Branch | `automation/pr-archive-11485-run-32038472008-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11490 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11485
...
PR title: fix(attestation): an attestation claim with no named vendor root was type-correct
Workflow run: 32038472008
Workflow attempt: 1
