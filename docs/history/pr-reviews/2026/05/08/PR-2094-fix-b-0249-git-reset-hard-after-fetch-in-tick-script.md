# PR #2094 -- fix(081KQZVQW0008QG0R000C35RNY): git reset --hard after fetch in tick script
...
|---|---|
| Number | 2094 |
| Title | fix(081KQZVQW0008QG0R000C35RNY): git reset --hard after fetch in tick script |
