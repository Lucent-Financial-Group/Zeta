...
```
feat(081KRMEXM0008QG0R002HBY56V): add-pipe-row-header.ts — backfill tool for shard schema

Implements 081KRMEXM0008QG0R002HBY56V Option 3 ("hybrid"): prepends a validator-compliant
...
slice per 081KRMEXM0008QG0R002HBY56V's scope discipline (bulk-edit blast radius warrants
its own review). The script ships now to make the retrofit a single-
command operation when the maintainer decides to run it.

Composes with:
- docs/backlog/P2/081KRMEXM0008QG0R002HBY56V-tick-shard-schema-validator-vs-practice-drift-2026-05-15.md
...
- Wire the script into a backfill PR per 081KRMEXM0008QG0R002HBY56V Recommendation
...
```
fix(081KRMEXM0008QG0R002HBY56V): --files with zero paths must not silently full-scan
...
```
fix(081KRMEXM0008QG0R002HBY56V): atomic write + timestamp-vs-path compliance check
...
```
fix(081KRMEXM0008QG0R002HBY56V): strict argument parsing + tests + comment hygiene
