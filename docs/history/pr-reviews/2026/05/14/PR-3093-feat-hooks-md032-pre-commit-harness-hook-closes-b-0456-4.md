# PR #3093 -- feat(hooks/md032): pre-commit harness hook closes 081KRHWGX0008QG0R000JEBCWZ #4
...
|---|---|
| Number | 3093 |
| Title | feat(hooks/md032): pre-commit harness hook closes 081KRHWGX0008QG0R000JEBCWZ #4 |
...
Closes 081KRHWGX0008QG0R000JEBCWZ acceptance criterion #4 (wire helper into pre-push hook OR tick-close ritual) by adding a Claude Code PreToolUse hook that mirrors the `verify-branch-pretooluse.ts` pattern.
...
- 081KRHWGX0008QG0R000JEBCWZ row → `status: closed`; all 5 acceptance criteria checked.
...
- [x] 081KRHWGX0008QG0R000JEBCWZ helper (already on main, PR #3075/3091/etc.) is reachable from the hook
- [x] All 5 acceptance criteria on 081KRHWGX0008QG0R000JEBCWZ now checked
