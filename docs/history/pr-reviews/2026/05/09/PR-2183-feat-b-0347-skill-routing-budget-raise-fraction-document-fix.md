# PR #2183 -- feat(081KR50HA0008QG0R002ZNFQBZ): skill routing budget — raise fraction + document fix
...
|---|---|
| Number | 2183 |
| Title | feat(081KR50HA0008QG0R002ZNFQBZ): skill routing budget — raise fraction + document fix |
...
- **File 081KR50HA0008QG0R002ZNFQBZ** — the structural fix: carve every skill's `description:` frontmatter to a single routing-quality sentence (<120 chars). Budget fraction is a lever; description length is the multiplier.
...
- [ ] After 081KR50HA0008QG0R002ZNFQBZ execution: `/doctor` reports 0 dropped descriptions
