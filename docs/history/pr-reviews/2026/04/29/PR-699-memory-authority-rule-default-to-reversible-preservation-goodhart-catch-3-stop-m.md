# PR #699 -- memory: Authority rule (default to reversible preservation) + Goodhart catch #3 + Stop Mythology directive + 081KQ8P5D0008QG0R003F6FNVF
...
|---|---|
| Number | 699 |
| Title | memory: Authority rule (default to reversible preservation) + Goodhart catch #3 + Stop Mythology directive + 081KQ8P5D0008QG0R003F6FNVF |
...
- 081KQ8P5D0008QG0R003F6FNVF — Veridicality rainbow-table research + graduation (Aaron concept; Ani caught + Amara elaborated)
- 081KQ8P5D0008QG0R0002TN22C — Cadenced lost-substrate recovery audit (worktrees + orphan branches + closed-not-merged PRs)
- 081KQ8P5D0008QG0R00353940P — Audit + rename ServiceTitan refs (COMPLETED in-row: 0 active rewrites needed after context-sensitive classification)
- 081KQ8P5D0008QG0R003ZF64GG — Public-company contributor compliance doc + cadenced trajectories
...
PR #704 carries the Candidate-count Goodhart rule + 081KQ8P5D0008QG0R003MY8246 (14 multi-AI synthesis enhancements) as separate scope per restraint discipline.

## Test plan

- [x] All MD032 violations fixed (verified locally)
- [x] 081KQ8P5D0008QG0R003F6FNVF frontmatter typo paraphrased (verbatim quote preserved in body)
- [x] 081KQ8P5D0008QG0R00353940P inspection completed — 0 active rewrites needed
...
- **Path**: `docs/backlog/P2/081KQ8P5D0008QG0R003F6FNVF-veridicality-rainbow-table-canonicalization-research-and-graduation-aaron-ani-amara-2026-04-28.md`
- **Replies**: 0

**Initial comment:**

- **`Copilot` (bot)** at 2026-04-28T22:48:50Z on `docs/backlog/P2/081KQ8P5D0008QG0R003F6FNVF-veridicality-rainbow-table-canonicalization-research-and-graduation-aaron-ani-amara-2026-04-28.md`:224 (association: NONE)
...
- **`Copilot` (bot)** at 2026-04-28T23:09:43Z on `docs/backlog/P2/081KQ8P5D0008QG0R003F6FNVF-veridicality-rainbow-table-canonicalization-research-and-graduation-aaron-ani-amara-2026-04-28.md`:104 (association: NONE)
...
- **`Copilot` (bot)** at 2026-04-28T23:09:43Z on `docs/backlog/P2/081KQ8P5D0008QG0R003F6FNVF-veridicality-rainbow-table-canonicalization-research-and-graduation-aaron-ani-amara-2026-04-28.md`:8 (association: NONE)
...
- **`Copilot` (bot)** at 2026-04-28T23:30:20Z on `memory/feedback_lost_substrate_recovery_cadenced_trajectory_aaron_2026_04_28.md`:124 (association: NONE)
  This section says “Files 081KQ8P5D0008QG0R0002TN22C (or equivalent next number)”, but this PR already introduces 081KQ8P5D0008QG0R0002TN22C. The parenthetical is now stale and may confuse readers; consider updating to refer to 081KQ8P5D0008QG0R0002TN22C directly (or link to the row file).
  ```suggestion
  Files **081KQ8P5D0008QG0R0002TN22C**: cadenced lost-substrate audit.
  Specifies:
  ```
...
- **Path**: `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`
- **Replies**: 0

**Initial comment:**

- **`chatgpt-codex-connector[bot]` (bot)** at 2026-04-28T23:33:35Z on `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`:55 (association: NONE)
...
- **`chatgpt-codex-connector[bot]` (bot)** at 2026-04-28T23:38:46Z on `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`:77 (association: NONE)
  **<sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub>  Relax 081KQ8P5D0008QG0R00353940P zero-match acceptance criterion**
...
- **`Copilot` (bot)** at 2026-04-28T23:42:12Z on `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`:60 (association: NONE)
  081KQ8P5D0008QG0R00353940P marks `docs/plans/servicetitan-crm-ui-scope.md` and `docs/pitch/README.md` as active rewrite targets, but the rule memory it references (`memory/feedback_servicetitan_naming_scope_of_org_access_external_ui_demo_aaron_2026_04_28.md`, table at ~lines 245-248) classifies both as **KEEP-NAME** in pitch context. Please reconcile this: either update 081KQ8P5D0008QG0R00353940P to match the context-sensitive rule (keep name in pitch artifacts) or adjust the rule memory if the intended policy is now “rewrite pitch docs to generic” too.
  ```suggestion
  ...
  4. **`docs/backlog/P2/081KQ0YZ80008QG0R0003GAYYN-operational-resonance-dashboard-frontier-bulk-alignment-ui-with-continuous-ux-research-meta-recursive.md`** — PER-ROW — rewrite naming references.
  5. **`docs/backlog/P2/081KQ8P5D0008QG0R0002TN22C-cadenced-lost-substrate-recovery-audit-aaron-2026-04-28.md`** — PER-ROW (just authored 2026-04-28) — already partially fixed in this session's commit; verify clean.
  6. **`docs/backlog/P3/081KQ0YZ80008QG0R000B6ETJS-investigate-ci-macos-slim-nightly-move-if-doubles-pr-wait-time.md`** — PER-ROW — rewrite naming references.
...
- **`Copilot` (bot)** at 2026-04-28T23:42:12Z on `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`:43 (association: NONE)
...
- **`Copilot` (bot)** at 2026-04-28T23:47:39Z on `memory/MEMORY.md`:13 (association: NONE)
  The PR description says this change adds 3 new memory files + 1 backlog row, but the diff updates the index and CURRENT file to add multiple additional memories and adds several backlog rows (e.g., 081KQ8P5D0008QG0R0002TN22C/081KQ8P5D0008QG0R00353940P/081KQ8P5D0008QG0R003ZF64GG, plus multiple new memory entries). Please update the PR description (or split the PR) so the stated scope matches the actual changes.
...
- **`Copilot` (bot)** at 2026-04-28T23:47:40Z on `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`:62 (association: NONE)
  ...
  5. **`docs/backlog/P2/081KQ0YZ80008QG0R0003GAYYN-operational-resonance-dashboard-frontier-bulk-alignment-ui-with-continuous-ux-research-meta-recursive.md`** — PER-ROW — rewrite naming references.
  6. **`docs/backlog/P2/081KQ8P5D0008QG0R0002TN22C-cadenced-lost-substrate-recovery-audit-aaron-2026-04-28.md`** — PER-ROW (just authored 2026-04-28) — already partially fixed in this session's commit; verify clean.
  7. **`docs/backlog/P3/081KQ0YZ80008QG0R000B6ETJS-investigate-ci-macos-slim-nightly-move-if-doubles-pr-wait-time.md`** — PER-ROW — rewrite naming references.
  
  ### Preserve / keep-name files (3)
  
  - `docs/pitch/README.md` — KEEP-NAME — pitch-context exception per the newer ServiceTitan naming audit table; do not genericize this file under 081KQ8P5D0008QG0R00353940P.
  ```
...
- **`Copilot` (bot)** at 2026-04-28T23:53:54Z on `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`:128 (association: NONE)
...
- **Path**: `docs/backlog/P2/081KQ8P5D0008QG0R003ZF64GG-public-company-contributor-compliance-doc-and-cadenced-trajectories-aaron-2026-04-28.md`
- **Replies**: 0

**Initial comment:**

- **`Copilot` (bot)** at 2026-04-28T23:53:55Z on `docs/backlog/P2/081KQ8P5D0008QG0R003ZF64GG-public-company-contributor-compliance-doc-and-cadenced-trajectories-aaron-2026-04-28.md`:13 (association: NONE)
...
- **`Copilot` (bot)** at 2026-04-29T00:09:45Z on `memory/MEMORY.md`:10 (association: NONE)
  The MEMORY index summary for the ServiceTitan naming rule says the live-repo audit found "8 need active rewriting (081KQ8P5D0008QG0R00353940P tracks)", but 081KQ8P5D0008QG0R00353940P’s Outcome section states 0 files needed active rewriting. Please update this summary to match the current audit result (or adjust 081KQ8P5D0008QG0R00353940P if the audit outcome changed).
  ```suggestion
  - [**ServiceTitan naming + scope-of-org-access rule (Aaron, 2026-04-28)**](feedback_servicetitan_naming_scope_of_org_access_external_ui_demo_aaron_2026_04_28.md) — Aaron 2026-04-28: forward-going naming uses generic "external UI demo" / "external CRM API demo"; ServiceTitan name avoided in code, sample dirs, file paths, public docs. Funding chain (ServiceTitan → Aaron → Otto) + org-access scope (LFG-only, NOT ServiceTitan) preserved as structural disclosure where contributor-relevant. Two coupled rules — naming + disclosure — operationalize Beacon-safe brand discipline. Live-repo audit found 12 files matching; 081KQ8P5D0008QG0R00353940P's outcome concluded 0 needed active rewriting. **Word-choice rule** (Aaron 2026-04-28 follow-up): avoid "insider" / "privileged" / "internal-only" register when describing contributor affiliation; use "industry-general experience" / "professional experience" / "domain expertise" instead. CRM workflow knowledge IS industry-general; "insider" word carries SEC-compliance register weight that's out-of-place.
  ```
...
- **`chatgpt-codex-connector[bot]` (bot)** at 2026-04-29T00:13:21Z on `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`:4 (association: NONE)
  **<sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub>  Mark 081KQ8P5D0008QG0R00353940P complete or remove completion language**
...
- **`Copilot` (bot)** at 2026-04-29T00:20:11Z on `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`:5 (association: NONE)
...
- **`Copilot` (bot)** at 2026-04-29T00:20:11Z on `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`:100 (association: NONE)
  The Acceptance section still has unchecked items (e.g., BACKLOG.md regeneration and “No new ServiceTitan references introduced…”), but later the row says it can be marked complete. If the row is actually complete, consider either checking these off, moving them into a follow-up row (e.g., 081KQ8P5D0008QG0R003ZF64GG trajectories / a BACKLOG.md regen row), or clarifying that they’re non-blocking so completion criteria stays unambiguous.
  ```suggestion
  ...
  - Future enforcement of "no new ServiceTitan references in non-pitch / non-disclosure contexts" is tracked as forward-going rule work under 081KQ8P5D0008QG0R003ZF64GG trajectories; it is not a blocker for 081KQ8P5D0008QG0R00353940P closure.
  ```
...
…t catch #3 (sample ≠ clearance) + Stop Mythology directive + 081KQ8P5D0008QG0R003F6FNVF (Veridicality rainbow-table research) (Amara via Aaron 2026-04-28)
...
## 4. 081KQ8P5D0008QG0R003F6FNVF — Veridicality rainbow-table canonicalization research
...
```
memory + 081KQ8P5D0008QG0R003F6FNVF: attribution correction — Ani caught it (voice-mode),…
...
1. Renamed 081KQ8P5D0008QG0R003F6FNVF file slug
   `aaron-amara-2026-04-28` → `aaron-ani-amara-2026-04-28`
   to reflect the corrected credit chain.

2. Updated 081KQ8P5D0008QG0R003F6FNVF row body with three-layer attribution:
   ...
   Voice-mode verbatim preserved in 081KQ8P5D0008QG0R003F6FNVF substrate (lower-case
...
Mythology directive + 081KQ8P5D0008QG0R003F6FNVF) — this commit corrects the 081KQ8P5D0008QG0R003F6FNVF
...
semantic canonicalization layer are future graduations per 081KQ8P5D0008QG0R003F6FNVF.
...
- Ani voice-mode: "Maintainer directive" table cell →
  ...
  → "Stop Mythology rule".
- 081KQ8P5D0008QG0R003F6FNVF: same pattern.
...
```
memory + 081KQ8P5D0008QG0R0002TN22C: lost-substrate recovery is a cadenced trajectory (Aa…
...
Encodes the cadenced-audit discipline + files 081KQ8P5D0008QG0R0002TN22C to schedule it.
...
## Cadence proposal (081KQ8P5D0008QG0R0002TN22C)
...
- `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-audit-and-rename-servicetitan-references-in-live-docs-aaron-2026-04-28.md`
- `memory/MEMORY.md`
...
```
memory + 081KQ8P5D0008QG0R00353940P: ServiceTitan naming + scope-of-org-access rule + liv…
...
- 8 need active rewriting (081KQ8P5D0008QG0R00353940P tracks):
  ...
  - docs/backlog/P2/081KQ0YZ80008QG0R0003GAYYN-*.md (PER-ROW)
  - docs/backlog/P2/081KQ8P5D0008QG0R0002TN22C-*.md (THIS-SESSION fix; partially
    addressed in this commit by removing "renamed from
    ServiceTitan" mention I just introduced)
  - docs/backlog/P3/081KQ0YZ80008QG0R000B6ETJS-*.md (PER-ROW)
...
- 081KQ8P5D0008QG0R0002TN22C NEEDS-FOLLOWUP item 3: rewrote "renamed from
  ServiceTitan" to "renamed to remove brand-bleed naming /
  external-UI-demo discipline" + cite the rule memory.

## Composes with

- 081KQ8P5D0008QG0R0002TN22C (cadenced lost-substrate recovery audit) — same
...
081KQ8P5D0008QG0R00353940P audit-and-rename row applies the more nuanced scope.
...
```
memory + 081KQ8P5D0008QG0R003ZF64GG: generalize public-company contributor compliance rul…
...
6. This memory + 081KQ8P5D0008QG0R003ZF64GG encodes the generalization

## Backlog row 081KQ8P5D0008QG0R003ZF64GG
...
1. 081KQ8P5D0008QG0R003F6FNVF line 223 — cross-newline backtick broke markdownlint.
...
```
memory + 081KQ8P5D0008QG0R0002TN22C/081KQ8P5D0008QG0R00353940P: address remaining PR #699 Copilot threads — i…

…nternal consistency + audit globs + stale parenthetical

Three thread fixes:

1. **081KQ8P5D0008QG0R00353940P internal inconsistency** (Copilot caught the
   contradiction with the refined rule):

   The audit table in 081KQ8P5D0008QG0R00353940P was drafted before the
...
2. **Audit commands missing references/upstreams exclude**:
   ...
   - `docs/backlog/P2/081KQ8P5D0008QG0R00353940P-*.md` (the row's audit command)
   - `memory/feedback_servicetitan_naming_*.md` (the rule's audit command)

3. **081KQ8P5D0008QG0R0002TN22C stale parenthetical**:

   "Files 081KQ8P5D0008QG0R0002TN22C (or equivalent next number)" was drafted when
   the row's number wasn't yet pinned. The row IS 081KQ8P5D0008QG0R0002TN22C; the
   parenthetical now confuses readers. Updated to "Filed as
   this row 081KQ8P5D0008QG0R0002TN22C."
...
…x 081KQ8P5D0008QG0R0002TN22C stale parenthetical (PR #699 thread cleanup)
```
...
```
memory + 081KQ8P5D0008QG0R003F6FNVF: paraphrase YAML ask: field (preserve verbatim typos …
...
```
081KQ8P5D0008QG0R00353940P: per-row inspection complete — 0 active rewrites needed (Aaron…
...
- 4 files: memory-file path pointers (KEEP-NAME-AS-MEMORY-POINTER) —
  HISTORICAL preservation per no-churn-history rule:
    ...
    - 081KQ0YZ80008QG0R0003GAYYN + 081KQ0YZ80008QG0R000B6ETJS — `composes_with:` references to
...
- 1 file: prior-fix verified clean (081KQ8P5D0008QG0R0002TN22C, addressed earlier this session)
...
Outcome: 081KQ8P5D0008QG0R00353940P marked COMPLETE in the body. Forward-going discipline is
encoded in:
- memory/feedback_servicetitan_naming_scope_of_org_access_external_ui_demo_aaron_2026_04_28.md (the rule)
- 081KQ8P5D0008QG0R003ZF64GG (cadenced trajectories — generalized public-company contributor compliance)
...
```
memory + 081KQ8P5D0008QG0R00353940P/081KQ8P5D0008QG0R003ZF64GG: address P1+P2 Copilot threads on PR #699
...
1. **081KQ8P5D0008QG0R00353940P line 140** — pickup step still said "Final state:
...
3. **081KQ8P5D0008QG0R003ZF64GG tag** — `secs-rule-10b-5` (ambiguous "seconds")
...
```
081KQ8P5D0008QG0R00353940P: convert ordered list to bullets to fix MD029 lint failure on …
...
…081KQ8P5D0008QG0R00353940P completed 0 active rewrites; Candidate-count Goodhart worked example)
```
...
```
memory + 081KQ8P5D0008QG0R00353940P: 4 hard-defect Copilot threads on PR #699 (P1 SOX mis…
...
GENERICIZE for reusable code/sample, with 081KQ8P5D0008QG0R00353940P's terminal-state
...
## P2 — 081KQ8P5D0008QG0R00353940P status: open → closed
...
```
081KQ8P5D0008QG0R00353940P: status: open → closed (audit completed 2026-04-28; row body O…
