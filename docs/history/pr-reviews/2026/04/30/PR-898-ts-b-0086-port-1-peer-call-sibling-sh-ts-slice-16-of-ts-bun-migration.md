# PR #898 -- ts(081KQ8P5D0008QG0R003BFZPRC): port 1 peer-call sibling (.sh→.ts) — slice 16 of TS/Bun migration
...
|---|---|
| Number | 898 |
| Title | ts(081KQ8P5D0008QG0R003BFZPRC): port 1 peer-call sibling (.sh→.ts) — slice 16 of TS/Bun migration |
...
The same `js/indirect-command-line-injection` alert that fired on grok.ts ([#896](https://github.com/Lucent-Financial-Group/Zeta/pull/896)) will fire here on `runContextCmd`. Per [081KQDTYV0008QG0R000FNYMK3](docs/backlog/P3/081KQDTYV0008QG0R000FNYMK3-codeql-peer-call-dismiss-pattern-2026-04-30.md) (filed in [#897](https://github.com/Lucent-Financial-Group/Zeta/pull/897)) the per-PR dismissal pattern applies until 081KQDTYV0008QG0R000FNYMK3 implements the structural fix.
...
```
ts(081KQ8P5D0008QG0R003BFZPRC): port 1 peer-call sibling (.sh→.ts) — slice 16 of TS/Bun m…
...
will fire here as on grok.ts; per 081KQDTYV0008QG0R000FNYMK3 (filed in PR #897)
