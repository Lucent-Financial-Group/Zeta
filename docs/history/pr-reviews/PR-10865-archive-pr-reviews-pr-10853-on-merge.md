# PR #10865 -- archive(pr-reviews): PR #10853 on merge
...
|---|---|
| Number | 10865 |
| Title | archive(pr-reviews): PR #10853 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T02:45:52Z |
| Merged at | 2026-08-16T03:14:07Z |
| Merge commit SHA | `193558c95ec1b876adbb553a12d7f72a5fdbf917` |
| Branch | `automation/pr-archive-10853-run-31922622066-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/10865 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #10853
...
PR title: fix(cli): eight destructive tools stop reading an unknown flag as consent
Workflow run: 31922622066
Workflow attempt: 1
