# PR #6327 -- feat(B-0954): agent-bus on the G-Set foundation — cross-machine merge view
...
|---|---|
| Number | 6327 |
| Title | feat(B-0954): agent-bus on the G-Set foundation — cross-machine merge view |
