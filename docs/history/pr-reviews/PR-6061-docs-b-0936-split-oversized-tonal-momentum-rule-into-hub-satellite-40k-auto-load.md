# PR #6061 -- docs(B-0936): split oversized tonal-momentum rule into hub + satellite (40k auto-load budget)
...
|---|---|
| Number | 6061 |
| Title | docs(B-0936): split oversized tonal-momentum rule into hub + satellite (40k auto-load budget) |
...
Closes **B-0936**. Addresses the harness warning Aaron flagged: `tonal-momentum-equals-meme-emergent-harmonic-coercion.md` was **77,777 chars (~1.94× the 40k per-file auto-load warning)**.
...
- **B-0936 row** filed with inventory (B-0161/B-0351 ran the *opposite* direction — out of CLAUDE.md; this is the inverse failure mode at single-rule scope).
