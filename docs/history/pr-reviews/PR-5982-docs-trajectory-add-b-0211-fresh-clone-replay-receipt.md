# PR #5982 -- docs(trajectory): add B-0211 fresh-clone replay receipt
...
|---|---|
| Number | 5982 |
| Title | docs(trajectory): add B-0211 fresh-clone replay receipt |
...
## Summary
- add a B-0211 local/remote cluster replay receipt from a fresh clone
