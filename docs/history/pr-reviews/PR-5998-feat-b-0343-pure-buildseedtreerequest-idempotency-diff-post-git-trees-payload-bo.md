# PR #5998 -- feat(B-0343): pure buildSeedTreeRequest — idempotency diff → POST /git/trees payload (bounded slice 6)
...
|---|---|
| Number | 5998 |
| Title | feat(B-0343): pure buildSeedTreeRequest — idempotency diff → POST /git/trees payload (bounded slice 6) |
