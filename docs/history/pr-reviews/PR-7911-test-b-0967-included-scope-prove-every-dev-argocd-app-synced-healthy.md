# PR #7911 -- test(B-0967): included scope — prove every dev ArgoCD app Synced+Healthy
...
|---|---|
| Number | 7911 |
| Title | test(B-0967): included scope — prove every dev ArgoCD app Synced+Healthy |
