# PR #7796 -- feat(inference): richer case families — theirs-tests-ours caught a real semantic bug; the loopy honesty case + the reversal (B-1033 closed)
...
|---|---|
| Number | 7796 |
| Title | feat(inference): richer case families — theirs-tests-ours caught a real semantic bug; the loopy honesty case + the reversal (B-1033 closed) |
