...
- **Path**: `docs/backlog/P2/B-0728-destructive-tool-authoring-contract-rails-plus-permission-grants-invocation-plus-runtime-acceptance-gate-2026-05-25.md`
- **Replies**: 0

**Initial comment:**

- **`Copilot` (bot)** at 2026-05-25T19:26:59Z on `docs/backlog/P2/B-0728-destructive-tool-authoring-contract-rails-plus-permission-grants-invocation-plus-runtime-acceptance-gate-2026-05-25.md`:52 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-25T19:26:59Z on `docs/backlog/P2/B-0728-destructive-tool-authoring-contract-rails-plus-permission-grants-invocation-plus-runtime-acceptance-gate-2026-05-25.md`:141 (association: NONE)
...
- `docs/backlog/P2/B-0728-destructive-tool-authoring-contract-rails-plus-permission-grants-invocation-plus-runtime-acceptance-gate-2026-05-25.md`

**Message:**

```
backlog(B-0728): destructive-tool authoring contract (rails + permiss…
