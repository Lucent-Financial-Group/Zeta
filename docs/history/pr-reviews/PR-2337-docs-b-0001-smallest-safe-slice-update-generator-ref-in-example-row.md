# PR #2337 -- docs(081KPYCJH0008QG0R003MDS51N): smallest safe slice — update generator ref in example row
...
|---|---|
| Number | 2337 |
| Title | docs(081KPYCJH0008QG0R003MDS51N): smallest safe slice — update generator ref in example row |
