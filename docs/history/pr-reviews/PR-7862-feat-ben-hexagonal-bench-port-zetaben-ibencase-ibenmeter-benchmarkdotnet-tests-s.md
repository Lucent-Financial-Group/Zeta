# PR #7862 -- feat(ben): hexagonal bench port — [<ZetaBen>] + IBenCase/IBenMeter; BenchmarkDotNet tests-side adapter (B-1039)
...
|---|---|
| Number | 7862 |
| Title | feat(ben): hexagonal bench port — [<ZetaBen>] + IBenCase/IBenMeter; BenchmarkDotNet tests-side adapter (B-1039) |
