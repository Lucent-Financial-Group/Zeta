# PR #6247 -- test(ci): option B — relocate docker data-root to D:\ so Windows-CI can install ollama (B-0857)
...
|---|---|
| Number | 6247 |
| Title | test(ci): option B — relocate docker data-root to D:\\ so Windows-CI can install ollama (B-0857) |
