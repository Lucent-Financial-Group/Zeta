...
- **Path**: `docs/backlog/P1/B-0793-role-as-capability-composition-NOT-baked-host-control-plane-AND-gpu-AND-storage-on-single-node-decouple-roles-from-flake-host-configs-aaron-2026-05-26.md`
- **Replies**: 0

**Initial comment:**

- **`Copilot` (bot)** at 2026-05-26T05:47:45Z on `docs/backlog/P1/B-0793-role-as-capability-composition-NOT-baked-host-control-plane-AND-gpu-AND-storage-on-single-node-decouple-roles-from-flake-host-configs-aaron-2026-05-26.md`:5 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-26T05:53:07Z on `docs/backlog/P1/B-0793-role-as-capability-composition-NOT-baked-host-control-plane-AND-gpu-AND-storage-on-single-node-decouple-roles-from-flake-host-configs-aaron-2026-05-26.md`:148 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-26T05:53:08Z on `docs/backlog/P1/B-0793-role-as-capability-composition-NOT-baked-host-control-plane-AND-gpu-AND-storage-on-single-node-decouple-roles-from-flake-host-configs-aaron-2026-05-26.md`:56 (association: NONE)
...
- `docs/BACKLOG.md`
- `docs/backlog/P1/B-0793-role-as-capability-composition-NOT-baked-host-control-plane-AND-gpu-AND-storage-on-single-node-decouple-roles-from-flake-host-configs-aaron-2026-05-26.md`

**Message:**

```
backlog(B-0793 P1): role-as-capability composition (NOT baked host) —…
...
```
fix(B-0793): replace <role> placeholder with {role} — angle brackets …
...
```
fix(B-0793): preserve verbatim 'eleglant [sic]' typo from Aaron's ori…
