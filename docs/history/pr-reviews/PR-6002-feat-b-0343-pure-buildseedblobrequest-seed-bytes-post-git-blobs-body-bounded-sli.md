# PR #6002 -- feat(B-0343): pure buildSeedBlobRequest — seed bytes → POST /git/blobs body (bounded slice 9)
...
|---|---|
| Number | 6002 |
| Title | feat(B-0343): pure buildSeedBlobRequest — seed bytes → POST /git/blobs body (bounded slice 9) |
