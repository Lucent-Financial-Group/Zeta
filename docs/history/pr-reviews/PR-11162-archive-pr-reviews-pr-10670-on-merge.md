# PR #11162 -- archive(pr-reviews): PR #10670 on merge
...
|---|---|
| Number | 11162 |
| Title | archive(pr-reviews): PR #10670 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T22:49:03Z |
| Merged at | 2026-08-17T00:06:39Z |
| Merge commit SHA | `e2804ffb8d561c175cea53d0639a676b0fa89023` |
| Branch | `automation/pr-archive-10670-run-31977355438-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11162 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #10670
...
PR title: feat(persona-keys): a share can be revoked without the revoked party's cooperation
Workflow run: 31977355438
Workflow attempt: 1
