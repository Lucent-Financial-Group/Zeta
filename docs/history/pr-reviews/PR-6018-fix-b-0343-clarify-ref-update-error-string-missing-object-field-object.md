# PR #6018 -- fix(B-0343): clarify ref-update error string — "missing object field `object`"
...
|---|---|
| Number | 6018 |
| Title | fix(B-0343): clarify ref-update error string — "missing object field `object`" |
