# PR #1874 -- backlog(081KQZVQW0008QG0R000C35RNY P0): autonomous backlog pickup — self-sustaining NEW WORK
...
|---|---|
| Number | 1874 |
| Title | backlog(081KQZVQW0008QG0R000C35RNY P0): autonomous backlog pickup — self-sustaining NEW WORK |
...
- **Path**: `docs/backlog/P0/081KQZVQW0008QG0R000C35RNY-autonomous-backlog-pickup-self-sustaining-new-work-2026-05-07.md`
- **Replies**: 0

**Initial comment:**

- **`Copilot` (bot)** at 2026-05-07T13:13:37Z on `docs/backlog/P0/081KQZVQW0008QG0R000C35RNY-autonomous-backlog-pickup-self-sustaining-new-work-2026-05-07.md`:52 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-07T13:13:38Z on `docs/backlog/P0/081KQZVQW0008QG0R000C35RNY-autonomous-backlog-pickup-self-sustaining-new-work-2026-05-07.md`:60 (association: NONE)

  <pre>
  The "Composes with" bullet says "All 081KQZVQW0008QG0R002QZAFB2..081KQZVQW0008QG0R0032TPKT8 items — the first items to be picked up", but 081KQZVQW0008QG0R002QZAFB2..081KQZVQW0008QG0R0032TPKT8 are currently P1 rows. That conflicts with the earlier acceptance criterion that selection follows priority order (P0 &gt; P1 &gt; P2). Suggest either referencing the actual intended first-pick set (likely P0s) or clarifying that these are the first items *after* P0 is empty / for a specific loop.
...
```
backlog(081KQZVQW0008QG0R000C35RNY P0): autonomous backlog pickup — loops must build, not…
