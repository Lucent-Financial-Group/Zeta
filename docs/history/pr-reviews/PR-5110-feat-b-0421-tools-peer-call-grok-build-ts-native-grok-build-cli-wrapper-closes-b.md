...
```
feat(B-0421): tools/peer-call/grok-build.ts — wraps native Grok-Build…
...
```
fix(B-0421): mitigate 2 CodeQL findings on #5110 — TOCTOU on stat+ope…
...
```
fix(B-0421): 12 Copilot findings on #5110 — converge grok-build.ts on…
