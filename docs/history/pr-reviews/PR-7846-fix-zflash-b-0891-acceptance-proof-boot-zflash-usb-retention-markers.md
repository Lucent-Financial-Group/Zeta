# PR #7846 -- fix(zflash): B-0891 acceptance proof — boot zflash USB + retention markers
...
|---|---|
| Number | 7846 |
| Title | fix(zflash): B-0891 acceptance proof — boot zflash USB + retention markers |
