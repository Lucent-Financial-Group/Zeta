# PR #2504 -- feat(081KR2E4K0008QG0R002N1C3YJ): append-only mutation drain log with revert()
...
|---|---|
| Number | 2504 |
| Title | feat(081KR2E4K0008QG0R002N1C3YJ): append-only mutation drain log with revert() |
...
| Branch | `feat/081KR2E4K0008QG0R002N1C3YJ-mutation-drain-log` |
| Base branch | `main` |
...
- Implements `tools/playwright/github-ui/drain-log.ts` — the append-only JSONL reversibility substrate required by 081KQ8P5D0008QG0R0010FP5SY Phase 2
...
Wire `appendEntry()` into the `mutate()` call site so entries are written automatically on every real mutation. That coupling was explicitly deferred from 081KR2E4K0008QG0R000YH9DC6 per the backlog split.
...
- **Path**: `docs/backlog/P1/081KR2E4K0008QG0R002N1C3YJ-playwright-github-mutation-reversibility-log.md`
- **Replies**: 0

**Initial comment:**

- **`Copilot` (bot)** at 2026-05-10T14:44:50Z on `docs/backlog/P1/081KR2E4K0008QG0R002N1C3YJ-playwright-github-mutation-reversibility-log.md`:4 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-10T14:44:50Z on `docs/backlog/P1/081KR2E4K0008QG0R002N1C3YJ-playwright-github-mutation-reversibility-log.md`:65 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-10T14:44:51Z on `docs/backlog/P1/081KR2E4K0008QG0R002N1C3YJ-playwright-github-mutation-reversibility-log.md`:7 (association: NONE)
...
- `docs/backlog/P1/081KR2E4K0008QG0R002N1C3YJ-playwright-github-mutation-reversibility-log.md`
- `tools/playwright/github-ui/drain-log.ts`

**Message:**

```
feat(081KR2E4K0008QG0R002N1C3YJ): append-only drain log with revert() for UI mutations

Implements drain-log.ts — the substrate-visible reversibility record
081KQ8P5D0008QG0R0010FP5SY Phase 2 requires so that every Playwright UI mutation has a
...
```
fix(081KR2E4K0008QG0R002N1C3YJ): address Copilot + Codex review findings
...
Three 081KR2E4K0008QG0R002N1C3YJ.md fixes:
...
```
fix(081KR2E4K0008QG0R002N1C3YJ): harden drain-log revert edge cases
...
```
fix(081KR2E4K0008QG0R002N1C3YJ): harden readAllLines schema validation + revert append fa…
...
```
fix(081KR2E4K0008QG0R002N1C3YJ): harden drain-log revert safety
...
```
fix(081KR2E4K0008QG0R002N1C3YJ): share drain-log append path
...
```
fix(081KR2E4K0008QG0R002N1C3YJ): persist indeterminate revert state
...
```
fix(081KR2E4K0008QG0R002N1C3YJ): contain drain-log read failures
