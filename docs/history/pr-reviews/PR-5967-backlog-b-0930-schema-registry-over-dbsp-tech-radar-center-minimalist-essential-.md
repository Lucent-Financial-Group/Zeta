# PR #5967 -- backlog(B-0930) schema-registry-over-DBSP + tech-radar center (minimalist essential core)
...
|---|---|
| Number | 5967 |
| Title | backlog(B-0930) schema-registry-over-DBSP + tech-radar center (minimalist essential core) |
