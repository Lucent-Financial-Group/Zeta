...
```
fix(B-0823): suffix-pattern match for nixpkgs 25.11 store-hashed kern…
...
Composes with B-0823 substrate-layer follow-up (now empirically
...
```
fix(B-0823): remove redundant legacy entries (Copilot #5263) — {prefi…
