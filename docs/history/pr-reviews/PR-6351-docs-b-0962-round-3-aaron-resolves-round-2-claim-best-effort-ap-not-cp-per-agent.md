# PR #6351 -- docs(B-0962): Round 3 — Aaron resolves round-2 (Claim=best-effort AP not CP; per-agent PC/EC via geo-replicas)
...
|---|---|
| Number | 6351 |
| Title | docs(B-0962): Round 3 — Aaron resolves round-2 (Claim=best-effort AP not CP; per-agent PC/EC via geo-replicas) |
