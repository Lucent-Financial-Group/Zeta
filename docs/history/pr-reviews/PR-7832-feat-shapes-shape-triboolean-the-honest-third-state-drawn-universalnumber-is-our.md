# PR #7832 -- feat(shapes): shape-triboolean (the honest third state, drawn) + UniversalNumber-is-our-bigint + B-1037 ball adapter + B-1038 identity gate
...
|---|---|
| Number | 7832 |
| Title | feat(shapes): shape-triboolean (the honest third state, drawn) + UniversalNumber-is-our-bigint + B-1037 ball adapter + B-1038 identity gate |
