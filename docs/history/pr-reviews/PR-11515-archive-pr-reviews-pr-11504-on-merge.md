# PR #11515 -- archive(pr-reviews): PR #11504 on merge
...
|---|---|
| Number | 11515 |
| Title | archive(pr-reviews): PR #11504 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-17T14:53:39Z |
| Merged at | 2026-08-17T14:58:00Z |
| Merge commit SHA | `241d43b9404bedea343b73ff70f5ab0d50bbaafc` |
| Branch | `automation/pr-archive-11504-run-32040510382-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11515 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11504
...
PR title: feat(zflash): the wrapper reaches the Linux arm — bake the ESP, never mount the stick
Workflow run: 32040510382
Workflow attempt: 1
