# PR #2991 -- test(memory): 081KRFA460008QG0R0006Q6BWP — extend reindex-memory-md.ts test coverage
...
|---|---|
| Number | 2991 |
| Title | test(memory): 081KRFA460008QG0R0006Q6BWP — extend reindex-memory-md.ts test coverage |
...
| Branch | `feat/081KRFA460008QG0R0006Q6BWP-reindex-test-coverage` |
| Base branch | `main` |
...
- 12 new tests covering all acceptance criteria from 081KRFA460008QG0R0006Q6BWP
...
Closes 081KRFA460008QG0R0006Q6BWP. Gates 081KRFA460008QG0R0034C2W0E (loop wiring) and 081KRFA460008QG0R0035NKRHG (CI relaxation).
