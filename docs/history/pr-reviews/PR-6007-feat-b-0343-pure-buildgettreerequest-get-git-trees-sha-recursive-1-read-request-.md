# PR #6007 -- feat(B-0343): pure buildGetTreeRequest — GET /git/trees/{sha}?recursive=1 read request (read-side pair)
...
|---|---|
| Number | 6007 |
| Title | feat(B-0343): pure buildGetTreeRequest — GET /git/trees/{sha}?recursive=1 read request (read-side pair) |
