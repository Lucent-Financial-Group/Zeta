...
- **`Copilot` (bot)** at 2026-05-26T16:53:34Z on `docs/backlog/P2/B-0817-tools-cluster-register-node-ts-operator-invocation-companion-symmetric-to-deregister-for-manual-re-register-after-wipe-aaron-2026-05-26.md`:23 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-26T16:53:35Z on `docs/backlog/P2/B-0817-tools-cluster-register-node-ts-operator-invocation-companion-symmetric-to-deregister-for-manual-re-register-after-wipe-aaron-2026-05-26.md`:59 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-26T16:53:35Z on `docs/backlog/P2/B-0817-tools-cluster-register-node-ts-operator-invocation-companion-symmetric-to-deregister-for-manual-re-register-after-wipe-aaron-2026-05-26.md`:84 (association: NONE)
...
```
backlog(B-0817 P2): tools/cluster/register-node.ts — operator-invocat…

…ion companion symmetric to deregister (B-0814)
