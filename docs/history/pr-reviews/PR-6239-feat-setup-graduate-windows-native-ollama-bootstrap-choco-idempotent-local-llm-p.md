# PR #6239 -- feat(setup): graduate Windows-native ollama + bootstrap choco; idempotent local-LLM pull (B-0857)
...
|---|---|
| Number | 6239 |
| Title | feat(setup): graduate Windows-native ollama + bootstrap choco; idempotent local-LLM pull (B-0857) |
