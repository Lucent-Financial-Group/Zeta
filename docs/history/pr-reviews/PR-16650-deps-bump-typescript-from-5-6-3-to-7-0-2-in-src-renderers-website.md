# PR #16650 -- deps: bump typescript from 5.6.3 to 7.0.2 in /src/Renderers/website
...
|---|---|
| Number | 16650 |
| Title | deps: bump typescript from 5.6.3 to 7.0.2 in /src/Renderers/website |
| Author | `app/dependabot` (bot) |
| State | MERGED |
| Created at | 2026-09-05T07:23:10Z |
| Merged at | 2026-09-05T08:08:10Z |
| Merge commit SHA | `89962d6bf2478ffa17300b7b55fd9ea3ca74c17c` |
| Branch | `dependabot/npm_and_yarn/src/Renderers/website/typescript-7.0.2` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/16650 |
| Changed files | 2 |
