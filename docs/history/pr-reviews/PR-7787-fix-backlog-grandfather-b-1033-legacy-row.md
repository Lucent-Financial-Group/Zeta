# PR #7787 -- fix(backlog): grandfather B-1033 legacy row
...
|---|---|
| Number | 7787 |
| Title | fix(backlog): grandfather B-1033 legacy row |
...
## Summary
- add already-landed `B-1033` to `tools/backlog/frozen-bnnnn-ids.json`
...
## Root Cause
After #7786 fixed B-1032, #7785 had also landed `docs/backlog/P2/B-1033-...md`, so the frozen-backlog guard advanced to B-1033. This preserves an already-merged legacy row; future work should still use ZetaId workitems.
