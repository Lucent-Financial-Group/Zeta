# PR #6581 -- docs(B-0995 + prism-ferry): integrity_index — say-do gap as observability metric (Prism/DeepSeek)
...
|---|---|
| Number | 6581 |
| Title | docs(B-0995 + prism-ferry): integrity_index — say-do gap as observability metric (Prism/DeepSeek) |
