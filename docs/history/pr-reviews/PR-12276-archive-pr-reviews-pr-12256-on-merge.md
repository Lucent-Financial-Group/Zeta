# PR #12276 -- archive(pr-reviews): PR #12256 on merge
...
|---|---|
| Number | 12276 |
| Title | archive(pr-reviews): PR #12256 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-19T03:34:14Z |
| Merged at | 2026-08-19T04:02:57Z |
| Merge commit SHA | `955dd9f50831b5522f5b4dea43354b01b60e673a` |
| Branch | `automation/pr-archive-12256-run-32212578754-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/12276 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #12256
...
PR title: fix(observe): an attestation now names what it attests, and can be bound to a key
Workflow run: 32212578754
Workflow attempt: 1
