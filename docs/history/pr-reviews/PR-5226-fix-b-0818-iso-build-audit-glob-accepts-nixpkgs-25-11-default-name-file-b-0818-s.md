...
- **Path**: `docs/backlog/P2/B-0818-investigate-isoname-mkforce-not-sticking-on-nixpkgs-25-11-aaron-2026-05-26.md`
- **Replies**: 0

**Initial comment:**

- **`Copilot` (bot)** at 2026-05-26T17:07:14Z on `docs/backlog/P2/B-0818-investigate-isoname-mkforce-not-sticking-on-nixpkgs-25-11-aaron-2026-05-26.md`:23 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-26T17:07:14Z on `docs/backlog/P2/B-0818-investigate-isoname-mkforce-not-sticking-on-nixpkgs-25-11-aaron-2026-05-26.md`:89 (association: NONE)
...
- `docs/backlog/P2/B-0818-investigate-isoname-mkforce-not-sticking-on-nixpkgs-25-11-aaron-2026-05-26.md`

**Message:**

```
fix(B-0818): ISO build audit-glob accepts nixpkgs-25.11 default name …

…(zeta-installer-*.iso OR nixos-minimal-*.iso) + file B-0818 substrate-layer fix
...
2. B-0818 (substrate-layer follow-up) — investigate which 25.11 option
...
```
fix(B-0818): address 2 Copilot threads — stale line ref + non-portabl…
