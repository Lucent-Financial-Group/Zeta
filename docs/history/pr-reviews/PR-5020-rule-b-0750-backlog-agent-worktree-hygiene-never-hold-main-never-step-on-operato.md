...
- **Path**: `docs/backlog/P2/B-0750-agent-worktree-hygiene-rule-landing-plus-mechanization-target-cleanup-tooling-plus-worktree-pool-primitive-aaron-2026-05-25.md`
- **Replies**: 1

**Initial comment:**

- **`Copilot` (bot)** at 2026-05-25T22:52:33Z on `docs/backlog/P2/B-0750-agent-worktree-hygiene-rule-landing-plus-mechanization-target-cleanup-tooling-plus-worktree-pool-primitive-aaron-2026-05-25.md`:66 (association: NONE)
...
**Replies:**
  ...
  - **`AceHack` (human)** at 2026-05-26T00:52:41Z on `docs/backlog/P2/B-0750-agent-worktree-hygiene-rule-landing-plus-mechanization-target-cleanup-tooling-plus-worktree-pool-primitive-aaron-2026-05-25.md`:66 (association: MEMBER)
...
- **`Copilot` (bot)** at 2026-05-25T22:52:34Z on `docs/backlog/P2/B-0750-agent-worktree-hygiene-rule-landing-plus-mechanization-target-cleanup-tooling-plus-worktree-pool-primitive-aaron-2026-05-25.md`:66 (association: NONE)
...
**Replies:**
  ...
  - **`AceHack` (human)** at 2026-05-26T00:52:43Z on `docs/backlog/P2/B-0750-agent-worktree-hygiene-rule-landing-plus-mechanization-target-cleanup-tooling-plus-worktree-pool-primitive-aaron-2026-05-25.md`:66 (association: MEMBER)
...
- **`Copilot` (bot)** at 2026-05-26T00:51:39Z on `docs/backlog/P2/B-0750-agent-worktree-hygiene-rule-landing-plus-mechanization-target-cleanup-tooling-plus-worktree-pool-primitive-aaron-2026-05-25.md`:81 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-26T00:51:39Z on `docs/backlog/P2/B-0750-agent-worktree-hygiene-rule-landing-plus-mechanization-target-cleanup-tooling-plus-worktree-pool-primitive-aaron-2026-05-25.md`:66 (association: NONE)
...
- **`Copilot` (bot)** at 2026-05-26T01:04:51Z on `docs/backlog/P2/B-0750-agent-worktree-hygiene-rule-landing-plus-mechanization-target-cleanup-tooling-plus-worktree-pool-primitive-aaron-2026-05-25.md`:14 (association: NONE)
...
- `docs/backlog/P2/B-0750-agent-worktree-hygiene-rule-landing-plus-mechanization-target-cleanup-tooling-plus-worktree-pool-primitive-aaron-2026-05-25.md`

**Message:**

```
rule(B-0750)+backlog: agent worktree hygiene — never hold main + neve…
...
2. B-0750 backlog row with 5 substrate-engineering mechanization
   scope items:
   - Periodic cleanup tooling (TS script)
   - Worktree-pool primitive (composes with B-0530)
...
own-substrate-cascade leftovers from today's B-0728→B-0749 cascade);
...
```
fix(B-0750): resolve 4 Copilot threads on PR #5020
...
- B-0750 backlog row Scope item 2: explicitly compose-with B-0558
  (existing Otto-only worktree-pool row); name B-0751 as potential
  superseder
- B-0750 backlog row Composes-with section: list B-0558 + B-0751 with
  same framing
