# PR #11313 -- archive(pr-reviews): PR #10795 on merge
...
|---|---|
| Number | 11313 |
| Title | archive(pr-reviews): PR #10795 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-17T03:30:47Z |
| Merged at | 2026-08-17T03:47:42Z |
| Merge commit SHA | `0805ef3ded6fc8523d309035c3a2551bfc9c6a58` |
| Branch | `automation/pr-archive-10795-run-31991355898-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11313 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #10795
...
PR title: fix(ci): a signal death read as a pass — 20 lean proof gates passed with a segfaulting prover (and the machine is the cause)
Workflow run: 31991355898
Workflow attempt: 1
