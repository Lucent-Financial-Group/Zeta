# PR #6166 -- backlog(B-0947): Windows CI checkout fails 'Filename too long' (MAX_PATH) on long persona-archive names
...
|---|---|
| Number | 6166 |
| Title | backlog(B-0947): Windows CI checkout fails 'Filename too long' (MAX_PATH) on long persona-archive names |
...
P3 (non-blocking). Search-first confirmed a genuine gap. Composes with B-0083 (naming-tooling), the refresh/blocked-green-ci rules.
