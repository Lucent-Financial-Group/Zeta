# PR #6121 -- backlog(B-0942): co-dominant git mirrors + git-native CRDT coordination (no host needed)
...
|---|---|
| Number | 6121 |
| Title | backlog(B-0942): co-dominant git mirrors + git-native CRDT coordination (no host needed) |
...
- **B-0883.2's anti-monoculture hedge at git-host scope** (don't lock to one host, same as don't-lock-to-NIST-lattices).
