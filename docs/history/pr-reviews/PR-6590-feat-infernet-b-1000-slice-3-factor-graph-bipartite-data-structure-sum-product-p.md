# PR #6590 -- feat(infernet B-1000 slice 3): factor graph — bipartite data structure + sum-product passOnce + prior/equality factors
...
|---|---|
| Number | 6590 |
| Title | feat(infernet B-1000 slice 3): factor graph — bipartite data structure + sum-product passOnce + prior/equality factors |
