# PR #11977 -- archive(pr-reviews): PR #11974 on merge
...
|---|---|
| Number | 11977 |
| Title | archive(pr-reviews): PR #11974 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-18T14:48:23Z |
| Merged at | 2026-08-18T15:07:49Z |
| Merge commit SHA | `699abb36afaf9e9afc3259dfe4721f74edd45990` |
| Branch | `automation/pr-archive-11974-run-32150472993-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11977 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11974
...
PR title: feat(observe): widen the self-claim surface to standing practice claims, with a real consumer
Workflow run: 32150472993
Workflow attempt: 1
