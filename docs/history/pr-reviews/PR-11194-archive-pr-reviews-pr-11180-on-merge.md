# PR #11194 -- archive(pr-reviews): PR #11180 on merge
...
|---|---|
| Number | 11194 |
| Title | archive(pr-reviews): PR #11180 on merge |
| Author | `AceHack` (human) |
| State | MERGED |
| Created at | 2026-08-16T23:38:00Z |
| Merged at | 2026-08-17T00:04:52Z |
| Merge commit SHA | `1cd647a0ea84026568cdd68285d67ed7d43abd88` |
| Branch | `automation/pr-archive-11180-run-31979653053-attempt-1` |
| Base branch | `main` |
| URL | https://github.com/Lucent-Financial-Group/Zeta/pull/11194 |
| Changed files | 2 |
...
- Archive review substrate for merged PR #11180
...
PR title: fix(installer): collapse the duplicate installer flake — one ISO definition, one mise pin
Workflow run: 31979653053
Workflow attempt: 1
