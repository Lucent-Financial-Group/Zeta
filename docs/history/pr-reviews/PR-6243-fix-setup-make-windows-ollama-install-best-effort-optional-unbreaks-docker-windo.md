# PR #6243 -- fix(setup): make Windows ollama install best-effort (optional) — unbreaks docker-windows shield (B-0857)
...
|---|---|
| Number | 6243 |
| Title | fix(setup): make Windows ollama install best-effort (optional) — unbreaks docker-windows shield (B-0857) |
