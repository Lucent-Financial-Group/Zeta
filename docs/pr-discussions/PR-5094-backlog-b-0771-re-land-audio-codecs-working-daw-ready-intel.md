---
pr_number: 5094
title: "backlog(B-0771): re-land audio codecs working (DAW-ready) + Intel NPU/VPU exposed + ONNX as operator contract"
author: "AceHack"
state: "MERGED"
...
# PR #5094: backlog(B-0771): re-land audio codecs working (DAW-ready) + Intel NPU/VPU exposed + ONNX as operator contract
...
- Same B-0771 row (269 lines from PR #5058 head `cf9f8e2fc`)
...
### Thread 1: docs/backlog/P2/B-0771-audio-codecs-working-plus-intel-npu-vpu-exposed-for-daw-and-ai-workloads-aaron-2026-05-25.md:12 (unresolved)
