...
- Class B (3 threads): VERIFIED REAL persona namespace split (`memory/kiro/` vs existing `memory/alexa/`) — left for operator review
...
- [x] `ls memory/alexa/` confirms existing roster-aligned namespace
