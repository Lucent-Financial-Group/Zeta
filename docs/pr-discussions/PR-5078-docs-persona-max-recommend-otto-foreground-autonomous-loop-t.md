...
### Thread 1: memory/persona/max/STARTING-POINT.md:125 (unresolved)
...
### Thread 2: memory/persona/max/STARTING-POINT.md:132 (unresolved)
...
### Thread 3: memory/persona/max/STARTING-POINT.md:139 (unresolved)
