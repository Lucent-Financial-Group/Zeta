---
pr_number: 5091
title: "feat(B-0789 iter-4.3): zflash stale-checkout detection + auto-download fresh ISO from CI"
author: "AceHack"
state: "MERGED"
...
# PR #5091: feat(B-0789 iter-4.3): zflash stale-checkout detection + auto-download fresh ISO from CI
...
- _"any fixes lets make sure they make it in main"_
- _"does the script not auto download the latest?"_
- _"we want to run what a contributor will run"_
- _"no rush we can wait on main we are going for right not fast"_
...
- B-0759 first-time-CLI-user persona — contributor onboarding flow ("just run zflash") now works without manual ISO-download dance
- B-0780 tier-2 dev experience — Max + Addison onboarding benefits
