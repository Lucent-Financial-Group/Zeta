---
pr_number: 5216
title: "feat(B-0814) + backlog(B-0815): TS deregister-node tool + heartbeat/expiration design \u2014 the maintainer 2026-05-26 dual ask"
author: "AceHack"
state: "MERGED"
...
# PR #5216: feat(B-0814) + backlog(B-0815): TS deregister-node tool + heartbeat/expiration design — the maintainer 2026-05-26 dual ask
...
### Thread 6: docs/backlog/P1/B-0814-tools-cluster-deregister-node-ts-removes-registered-machine-from-git-sibling-to-iter-5-4-1-self-registration-aaron-2026-05-26.md:4 (resolved)
...
### Thread 7: docs/backlog/P1/B-0814-tools-cluster-deregister-node-ts-removes-registered-machine-from-git-sibling-to-iter-5-4-1-self-registration-aaron-2026-05-26.md:92 (resolved)
...
### Thread 8: docs/backlog/P2/B-0815-cluster-node-registration-heartbeat-expiration-pattern-physical-sync-design-aaron-2026-05-26.md:118 (resolved)
