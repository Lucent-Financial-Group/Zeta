...
| File | Description |
| ---- | ----------- |
| memory/riven/ide/conversations/2026-05-22-aaron-riven-full-session-substrate-trajectory.md | Removed the full-session substrate trajectory file (sensitive-content removal). |
