---
pr_number: 4004
title: "docs(hygiene): endorse hybrid shard format (pipe-row + H1 body) per 081KRMEXM0008QG0R002HBY56V Option 3"
author: "AceHack"
state: "MERGED"
...
- [ ] **081KRMEXM0008QG0R002HBY56V Recommendation "Later" item — wire validator into gate.yml as non-required check** — separate row, not in this PR
