---
pr_number: 5352
title: "feat(B-0812 / B-0835 Bug 4): iter-5.4.1 self-registration commit+push (Step 6.9) \u2014 opens registration PR per node-install; fixes CORE REQUIREMENT failure"
author: "AceHack"
state: "MERGED"
...
# PR #5352: feat(B-0812 / B-0835 Bug 4): iter-5.4.1 self-registration commit+push (Step 6.9) — opens registration PR per node-install; fixes CORE REQUIREMENT failure
