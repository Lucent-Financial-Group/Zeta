---
pr_number: 4681
title: "feat(B-0170): extend check-self-recursive.ts with `existence` topic (v0.9.1)"
author: "AceHack"
state: "MERGED"
...
# PR #4681: feat(B-0170): extend check-self-recursive.ts with `existence` topic (v0.9.1)
