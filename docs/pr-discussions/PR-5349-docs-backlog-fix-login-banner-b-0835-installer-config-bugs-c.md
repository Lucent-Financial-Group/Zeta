---
pr_number: 5349
title: "docs(backlog) + fix(login-banner): B-0835 \u2014 installer config-bugs cluster (CORE: post-boot fully-operational chain without operator login; 5 sub-failures; CRITICAL self-reg didn't happen)"
author: "AceHack"
state: "MERGED"
...
# PR #5349: docs(backlog) + fix(login-banner): B-0835 — installer config-bugs cluster (CORE: post-boot fully-operational chain without operator login; 5 sub-failures; CRITICAL self-reg didn't happen)
...
### Thread 1: docs/backlog/P1/B-0835-installer-config-bugs-cluster-hostname-not-unique-gh-auth-not-respected-banner-password-disclosure-empirical-aaron-2026-05-26.md:24 (unresolved)

**@copilot-pull-request-reviewer** (2026-05-26T23:12:27Z):

P1: These cross-references are currently dangling: no B-0833 or B-0834 backlog row exists under docs/backlog/P0, P1, or P2 in this branch. Either add those rows in the same PR or remove/defer the references so the backlog graph does not point at missing work items.

### Thread 2: docs/backlog/P1/B-0835-installer-config-bugs-cluster-hostname-not-unique-gh-auth-not-respected-banner-password-disclosure-empirical-aaron-2026-05-26.md:23 (unresolved)
...
### Thread 3: docs/backlog/P1/B-0835-installer-config-bugs-cluster-hostname-not-unique-gh-auth-not-respected-banner-password-disclosure-empirical-aaron-2026-05-26.md:55 (unresolved)
...
### Thread 4: docs/backlog/P1/B-0835-installer-config-bugs-cluster-hostname-not-unique-gh-auth-not-respected-banner-password-disclosure-empirical-aaron-2026-05-26.md:71 (unresolved)
...
### Thread 5: docs/backlog/P1/B-0835-installer-config-bugs-cluster-hostname-not-unique-gh-auth-not-respected-banner-password-disclosure-empirical-aaron-2026-05-26.md:202 (unresolved)
...
### Thread 6: docs/backlog/P1/B-0835-installer-config-bugs-cluster-hostname-not-unique-gh-auth-not-respected-banner-password-disclosure-empirical-aaron-2026-05-26.md:194 (unresolved)
