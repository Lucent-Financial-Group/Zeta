...
4. `D ∘ Q ∘ I` is the incrementalization _identity_, not a monad (per [PR #3626](https://github.com/Lucent-Financial-Group/Zeta/pull/3626))
...
- Line 131 (Arc 5 open question — "DBSP incrementalization monad") → "DBSP I/D pair... incrementalization _identity_, not a monad"
