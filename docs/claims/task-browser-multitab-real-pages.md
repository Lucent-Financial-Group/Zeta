# Claim - task-browser-multitab-real-pages
...
Alexa owns the vault-state emitter in PR #9932. Iris owns page rendering. This
claim tests their surrounding browser substrate without editing either surface.
