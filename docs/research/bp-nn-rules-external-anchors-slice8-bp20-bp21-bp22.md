...
BP-19 pending — slice 7 in-progress). This slice covers the three rules in the "Repo ontology & Rule Zero"
...
## BP-20 — Skills split when context needs to split to reduce reader cognitive load, not when a length threshold is crossed
...
## BP-21 — Non-exempt capability skills declare or imply their three facet values: epistemic stance × abstraction level × function
...
## BP-22 — Optimizer and balancer are distinct roles with distinct objective functions
