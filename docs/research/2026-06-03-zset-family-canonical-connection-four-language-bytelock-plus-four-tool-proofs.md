...
1. ~~**Z3 covers only 2 of the 6 abelian-group laws** (assoc, commut)... *Candidate:* add the 4 missing Z3 Z-set lemmas...~~ **CLOSED 2026-06-03.** Z3 now covers the full set — assoc, commut, identity, inverse, double-neg, neg-distributes, and **subtraction** (`a - b = a + (-b)`, the DBSP-retraction law, added 2026-06-03; verified unsat with a sat negative control). The Z3↔FsCheck (BP-16) cross-check for the abelian-group laws is complete. (Note for the record: this gap was already partly self-closing — identity/inverse/double-neg/neg-dist had landed in `Z3.Laws.Tests.fs` after this note's original "2 of 6" snapshot; only subtraction remained, now added.)
