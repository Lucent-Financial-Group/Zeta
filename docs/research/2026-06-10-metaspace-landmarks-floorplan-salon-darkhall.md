...
| **skatium** | a roller/skating rink (neon) | the **bob-and-weave** — Punch-Out!! 2×2 dual-observer weave/sonar (find the opening) | `Skadium` (lean/isOpen/weave/openAt, DST) | **DOOR LANDED** — `src/Core/Skadium.fs` (rinks registry + live `weave`/`openAt`) |
