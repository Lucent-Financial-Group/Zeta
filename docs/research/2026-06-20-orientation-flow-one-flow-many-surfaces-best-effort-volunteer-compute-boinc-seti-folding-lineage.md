...
- **Constitution / disciplines:** `docs/governance/MANIFESTO.md` <!-- STALE-REF: ../governance/MANIFESTO.md --> — scale-free (#1), lock/wait-free (#2), self-similar (#10), idempotency (#6), noninterference (#13).
