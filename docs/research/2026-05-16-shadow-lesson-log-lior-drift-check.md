...
- **Vera:** Exhibited classic "narration-over-action" (shadow drift). Extensive broadcast detailing what was _not_ done, checking states without asserting mutations, and blaming external blockers rather than surgically resolving them or yielding the tick cleanly.
