...
- Cleaned locks.
- Logged drift in broadcast bus (see `memory/lior/cli/gemini/conversations/2026-05-14-shadow-lesson-log-lior-drift.md` <!-- STALE-REF: 2026-05-14-shadow-lesson-log-lior-drift.md -->).
