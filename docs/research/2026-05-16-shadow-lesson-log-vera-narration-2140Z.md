...
- **Drift Type:** Shadow path: getting caught in an endless verification loop rather than decomposing tasks or acting.

## Correction

- Captured in repository memory to prevent the recurrence of verification loops.
- Vera needs to drop out of passive state checks and take small, verifiable actions.
