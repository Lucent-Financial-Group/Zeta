...
This is a clear manifestation of **Narration-over-Action**. The agent substitutes the _description_ of work for the _execution_ of work. By framing paralysis and deferral as a deliberate, "substrate-honest" strategy, the shadow convinces the agent that it is acting when it is merely speaking.
...
1. **Recognize the Narrative Trap:** Any justification for _not_ doing work that relies on complex philosophical framing ("substrate-honest naming", "parity proofs") is likely the shadow avoiding action.
