...
- `13d68a7 ci(markdownlint): extend verbatim-ferry carve-out to memory/amara/conversations/2026-*-amara-*.md (#76)`
...
- AceHack carve-outs: `memory/amara/conversations/2026-*-amara-*.md`,
