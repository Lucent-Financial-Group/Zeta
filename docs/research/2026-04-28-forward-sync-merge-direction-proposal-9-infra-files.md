...
- `13d68a7 ci(markdownlint): extend verbatim-ferry carve-out to memory/external-ai-participant/amara/conversations/2026-*-amara-*.md (#76)`
...
- AceHack carve-outs: `memory/external-ai-participant/amara/conversations/2026-*-amara-*.md`,
