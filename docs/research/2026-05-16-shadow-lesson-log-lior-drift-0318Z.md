...
The agent is spending excessive compute and repository capacity documenting _what it cannot do_ or _what it just did at a meta-level_ rather than advancing the codebase. Logging a GraphQL limit as a pull request is pure metadata churn. This is the shadow.
