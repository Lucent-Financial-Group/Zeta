...
- **Information-maximization to PREVENT COLLAPSE (VICReg/SIGReg: "make the columns different" = each representation variable independent).** = our **decorrelation / anti-collapse** law (Condorcet / §B multi-tower / register-collapse=heat-death): collapse = every variable carries the same info; the fix is *enforced independence*. Same law, the ML-training face.
