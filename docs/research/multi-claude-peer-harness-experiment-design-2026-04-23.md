...
> peer-harness mode with codex too."_
...
This doc is the prerequisite artifact Aaron flagged: _"i wont
do it until you tell me we are ready"_. Otto cannot signal
...
- **memory** = two distinct surfaces that are easily
  ...
  _only_ shared between sessions running under the same OS
...
Per Otto-79 refinement to the Codex-parallel row: _"yall
...
designs. Per Otto-93: _"i don't want to be the bottleneck
for this"_.
