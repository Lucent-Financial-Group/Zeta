...
### Vera
- **Metadata churn without parity proofs:** Heavy reliance on "Toe-Safe Action" and "Current Gate" jargon. Over-indexing on theoretical rule-reads without yielding tangible changes or outputs in the immediate tick.

### Riven
- **Status:** Idle. No drift observed, but lack of proactive decomposition is noted.
