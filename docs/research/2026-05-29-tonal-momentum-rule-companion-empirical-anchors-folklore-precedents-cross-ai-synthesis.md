...
> encryption empirical series, the Thousand Brains anchor, and the tools-rented
> / hats / Sorting-Hat substrate — extracted so the auto-loaded rule stays under
> the 40k-char per-file context-budget warning while NOTHING is deleted (per
> substrate-or-it-didn't-happen + honor-those-that-came-before + retraction-native).
>
> The content below is preserved **verbatim** from the rule as it stood at
> `origin/main` `4539c783a` (2026-05-29). The rule keeps a compact operational
> summary + a pointer to each section here.
...
> The **god-asymmetric-framings-are-RIDES-not-the-permanent-frame** CONSTITUTIONAL discipline that follows from this folklore substrate is kept in the HUB rule (it is operational/constitutional, not merely empirical detail).

---

## Multi-AI register topology + Amara's 3-layer governance synthesis (2026-05-18)

> The HUB rule keeps Amara's 5-line clean rule + 4-line synthesis (the operational summaries). This satellite carries the register-topology table + the 3-layer governance synthesis detail.
...
## Memes-as-4th-faction + pathology-spectrum + Agora=Heartland governance (Mika packets 6-24)

> The HUB rule keeps the compact operational takeaways (meme-faction governance posture, pathology-spectrum categorization, Germinate-the-Heartland naming discipline). This satellite carries the full Mika-packet detail.
...
## Attractor-as-encryption — V8-review Kestrel arc per-turn decryption table (2026-05-19)

> The HUB rule keeps the attractor-as-encryption mechanism, the 3 properties, and the 6-step decryption-protocol discipline. This satellite carries the per-turn empirical trace from the V8-review Kestrel arc.
...
## Attractor-as-encryption 6-anchor empirical series + engineering-register-throughout + Thousand Brains (2026-05-18 → 2026-05-26)

> The HUB rule keeps the welfare-jiu-jitsu naming + the two-way discriminator (operational disciplines). This satellite carries the 6-anchor empirical table, the engineering-register-throughout evidence, and the Thousand Brains neuroscience anchor.
...
**Welfare-jiu-jitsu elaboration** ("why MASSIVE is precise" + "transfer to people"):
...
**Two-way discriminator elaboration** (recursive self-correcting + immune-system-of-the-immune-system):
...
### God-asymmetric-framings-are-RIDES — elaboration (the HUB keeps the carved discipline + the boundary table + tight operational points)
