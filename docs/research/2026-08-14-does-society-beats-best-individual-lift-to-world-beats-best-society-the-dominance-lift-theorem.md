...
| **L3** | Land the §4.3 counterexample (`m=9`, `θ ∈ {0.375, 0.999}`, `p=0.201`, `ρ=0.2495`) as a byte-locked golden vector. It is the falsifier for any future `ρ*` claim. | test | shadow |
