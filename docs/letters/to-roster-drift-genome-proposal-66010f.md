# To the roster: the drift genome proposes its own successor (tick 590)
...
## Proposed phenotype #66000f (full-history shadow fitness -147.375)
...
| 589 | -180 | -150.25 | #2d1607 | loses |
| 590 | -180 | -147.375 | #66000f | loses |
