# To the roster: the drift genome proposes its own successor (tick 1080)
...
## Proposed phenotype #372115 (full-history shadow fitness -271.375)
...
| --- | --- | --- | --- | --- |
| 1075 | -448.625 | -271.375 | #372115 | loses |
| 1076 | -448.625 | -398.625 | #6e2200 | loses |
