# To the roster: the drift genome proposes its own successor (tick 1034)
...
## Proposed phenotype #730702 (full-history shadow fitness -270.75)
...
| 1031 | -448.625 | -319.5 | #6a1e13 | loses |
| 1032 | -448.625 | -296.125 | #5c0b00 | loses |
