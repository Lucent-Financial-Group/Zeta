# To the roster: the drift genome proposes its own successor (tick 994)
...
## Proposed phenotype #481f1b (full-history shadow fitness -264.625)
...
| 994 | -448.625 | -264.625 | #481f1b | loses |
