...
| **Rust / cargo**            | rustc 1.87.0 (mise-pinned) | Building Feldera and the Rust/WASM source surfaces                                    | mise-managed via `.mise.toml`; installed by `tools/setup/install.sh`                                                                                                                                                                                                                                                                                                                                              |
...
| **Lua**                     | 5.4.8 (mise-pinned)      | Lua 5.4 cross-language byte-lock script substrate                                         | mise-managed via `.mise.toml`; installed by `tools/setup/install.sh` on Linux, macOS, and Windows                                                                                                                                                                                                                                                                                                                  |
