...
| ------------------------- | -------------------- | ---------------------------------------- | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **TLA+ / TLC** | `TLC2 Version 2026.09.09.201538 (rev: 94db4a6)` | `src/Core.TLA/tla2tools.jar` (gitignored) | Model-check every `src/Core.TLA/specs/*.tla` spec in CI | `tools/setup/install.sh` fetches the tlaplus v1.8.0 `tla2tools.jar` asset, pinned sha256 `f629a67c1ade2cadfcd12670de9172e07629418502df76e9b9ccbf4a5aa0ed6e`, `rolling=` (re-pin with `tools/setup/repin-rolling.ts`) |
