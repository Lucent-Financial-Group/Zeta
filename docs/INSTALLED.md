...
| **Rust / cargo**            | rustc 1.96.0 (mise-pinned) | Building Feldera and the Rust/WASM source surfaces                                    | mise-managed via `.mise.toml`; installed by `tools/setup/install.sh`. Last-good vs Feldera 0.342.0 `dbsp` (first-bad rustc 1.97.0).                                                                                                                                                                                                                                                                                                                                              |
...
| **Feldera (cloned)**      | 0.342.0 `48312b6` (main, 2026-09-01) | `references/prior-art/feldera/` (gitignored) | Apples-to-apples Nexmark; MSRV 1.93.1, build with factory rust 1.96.0 | `git clone --depth 1 https://github.com/feldera/feldera.git` |
