...
**Agent fairness protocol (Aaron 2026-09-10, named not invented):** if A references B, B sees the edge; B may reply; the reply cannot overwrite the cite. Two graphs (content DAG vs EntityId references) share the algebra and must not be fused into a knowledge-graph filesystem. Reverse index is `IncrementalJoin`; notify is a Reaqtor standing query; both accounts held. Research-grade: [`docs/research/2026-09-10-agent-fairness-protocol-inbound-references-are-visible-reply-cannot-overwrite.md`](../research/2026-09-10-agent-fairness-protocol-inbound-references-are-visible-reply-cannot-overwrite.md) (`081M26HWSZ6087G0R00373BN0Q`). Not first-class algebra. Not FUSE. Not shipped.
