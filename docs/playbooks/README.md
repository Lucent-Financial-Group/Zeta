...
[`docs/backlog/P2/B-0867.22-...md`](../backlog/P2/B-0867.22-playbook-directory-convention-personal-personas-dir-vs-system-docs-playbooks-folder-plus-agents-author-playbooks-too-aaron-2026-05-28.md).
...
- **[B-0730](../backlog/P2/B-0730-runme-runbook-substrate-aaron-2026-05-25.md)** — runme + runbook substrate; playbooks can EMBED runme cells
- **[B-0732](../backlog/P2/B-0732-runme-bcl-extension-tradeoff-analysis-kestrel-aaron-2026-05-26.md)** — runme BCL extension tradeoff analysis
- **[B-0733](../backlog/P2/B-0733-runme-md-jit-triage-pattern-naming-kestrel-aaron-2026-05-26.md)** — runme.md + JIT-triage pattern
- **[B-0819](../backlog/P2/B-0819-continue-with-auto-jit-trigger-annotations-agent-swarm-coordination-aaron-2026-05-27.md)** — Continue-With + auto-JIT trigger annotations for agent swarm coordination
- **[B-0826](../backlog/P2/B-0826-runme-core-bcl-extension-runbook-as-queryable-substrate-kestrel-aaron-2026-05-27.md)** — runme-core-BCL + runbook-as-queryable-substrate
- **[B-0827](../backlog/P2/B-0827-runme-md-jit-triage-runbook-as-evolving-substrate-kestrel-aaron-2026-05-27.md)** — runme.md + JIT-triage + runbook-as-evolving-substrate

## Agents author playbooks too (B-0867.22 sharpening + B-0867.21 two-path interface)
...
- Letting multiple lanes (encryption + zflash + state-machine-substrate
  per [B-0892](../backlog/P1/B-0892-three-lanes-concurrent-operating-discipline-encryption-zflash-state-machine-substrate-all-advancing-aaron-2026-05-28.md))
...
- Being glass-halo-visible (no decryption ceremony to catch up; see
  [B-0883.16](../backlog/P1/B-0883.16-glass-halo-open-by-default-encryption-as-earned-via-agora-v6-budget-not-encrypt-everything-aaron-2026-05-28.md))
...
- **System playbook candidates per existing backlog substrate** (not yet
  ...
  - `docs/playbooks/library-evaluation.md` — canonical sonatype-guide +
    audit invocation per [B-0887.2](../backlog/P2/B-0887.2-move-sonatype-guide-invocation-into-playbook-substrate-drop-pr-gated-review-no-vendor-lockin-aaron-2026-05-28.md)
  - `docs/playbooks/encryption-budget-request.md` — when encryption is
    needed, this playbook gates the request per B-0883.16 Agora V6 budget
    mechanics
  - `docs/playbooks/cluster-bootstrap.md` — Zeta cluster fresh-format +
    join sequence per zflash + B-0891 acceptance criteria
...
Per [B-0883.16](../backlog/P1/B-0883.16-glass-halo-open-by-default-encryption-as-earned-via-agora-v6-budget-not-encrypt-everything-aaron-2026-05-28.md):
...
- [`docs/backlog/P2/B-0867.22-...md`](../backlog/P2/B-0867.22-playbook-directory-convention-personal-personas-dir-vs-system-docs-playbooks-folder-plus-agents-author-playbooks-too-aaron-2026-05-28.md) — this directory convention (canonical)
- [`docs/backlog/P1/B-0867.21-...md`](../backlog/P1/B-0867.21-two-path-interface-discriminated-union-execute-vs-conversational-declare-intent-aaron-ani-2026-05-28.md) — two-path interface: DU executes, conversational documents declare
- [`docs/backlog/P1/B-0892.1-...md`](../backlog/P1/B-0892.1-interface-for-async-scatterbrains-operator-experience-design-property-multi-thread-drop-resume-context-switch-aaron-2026-05-28.md) — async-scatterbrains design property
- [`docs/backlog/P1/B-0892-...md`](../backlog/P1/B-0892-three-lanes-concurrent-operating-discipline-encryption-zflash-state-machine-substrate-all-advancing-aaron-2026-05-28.md) — three-lanes-concurrent operating discipline (playbooks compose with each lane)
- [`docs/backlog/P1/B-0883.16-...md`](../backlog/P1/B-0883.16-glass-halo-open-by-default-encryption-as-earned-via-agora-v6-budget-not-encrypt-everything-aaron-2026-05-28.md) — encryption-as-earned via Agora V6 budget
- [`docs/backlog/P2/B-0887.2-...md`](../backlog/P2/B-0887.2-move-sonatype-guide-invocation-into-playbook-substrate-drop-pr-gated-review-no-vendor-lockin-aaron-2026-05-28.md) — sonatype-guide-into-playbook (a system-playbook candidate)
- [`.claude/skills/agent-loop/SKILL.md`](../../.claude/skills/agent-loop/SKILL.md) — workflow engine that EXECUTES playbook intent via the DU path
