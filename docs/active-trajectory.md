...
| `tools/setup/mechanisms/from-elan.sh` | SAFE_TO_RESET_LFG_SUPERSEDES | AceHack used streamed pipe-to-sh. LFG uses pinned tarball + SHA256 verify via `from-elan.sh` mechanism. |
