...
Per the human maintainer 2026-04-23: _"we should likely
...
a check now manually just like i do on current memories."_
...
1. **Resolutions are additive.** When a conflict gets
   ...
   history (inline markers like _(superseded YYYY-MM-DD
   by ...)_).
...
_(No open entries at creation. Agents file rows when a
...
_(Empty at creation. Stale = context died, neither
position is any longer relevant; row kept for history.)_
