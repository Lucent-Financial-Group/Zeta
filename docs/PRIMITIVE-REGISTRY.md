...
| **Shared ABI**                     | a calling convention + interface contract | C ABI (JNI / P-Invoke / ctypes / SWIG / UniFFI), **WASM Component Model + WIT** (shipped 2026, WASI 0.2, wasmtime 30+ — "COM done right": sandboxed, language-neutral)                                     |
