...
| **Metadata** | labels (Z-set facets) / tags (G-Set) + scopes (OTel-baggage/DI-scope propagation) | B-0957, B-0668 | facets are **folds**; scopes **propagate** |
...
- **Metadata/policy/identity:** B-0957 (labels/tags/scopes) · B-0668 (meta-tagged dims) · B-0776 (OPA) · B-0646 (agora-v6) · KSK consent (B-0245/B-0290/B-0293) · SPIFFE/SPIRE + AgencySignature
