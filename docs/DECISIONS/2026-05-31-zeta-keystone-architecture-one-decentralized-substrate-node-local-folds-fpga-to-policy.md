...
> _"it's the whole thing pretty much + eventually all the way to hardware with
> microkernels/unikernels, FPGA signal processing etc… that's all of it together."_
...
_node-local fold_ with _no central authority_; the same G-Set/Bag/Z-set algebra runs top to
...
(B-0956) are the _same algebra_ at silicon and at planning. Folds all the way down. That is
