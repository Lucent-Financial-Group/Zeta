...
- FourCorner C₄ / IStarRing / not Cl(p,q) / not a fermion or qubit (pipe ≠ QubitIso; S=4 measured seed-shared; 2√2 predicted floor to-be-measured): `docs/research/2026-08-26-fourcorner-c4-istarring-not-clpq.md` · `src/Core/FourCornerC4.fs` · `src/Core/FeedbackThrottle.fs` · `081M10CBYF9087G0R003GWBNHG`
