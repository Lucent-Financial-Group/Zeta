...
## The surface map — six surfaces, and they are NOT copies of one list
...
|---|---|---|---|---|
| ZetaId register | `register` | `inventory/items/*.md` → `inventory/items.json` | slow (hub) | identity of record, one file per physical asset, git-as-database |
