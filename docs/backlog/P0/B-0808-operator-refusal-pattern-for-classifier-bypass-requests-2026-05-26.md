...
# B-0808 - Operator-refusal pattern for classifier-bypass requests
...
- route ambiguous requests to B-0798/B-0806 instead of improvising;
...
- B-0806 - findings schema and redaction rules.
