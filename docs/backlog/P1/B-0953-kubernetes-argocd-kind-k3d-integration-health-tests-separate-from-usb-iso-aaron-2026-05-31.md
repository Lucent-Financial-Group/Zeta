...
renumbered_from: "B-0951; B-0952 (2026-05-31 duplicate-ID repair; DORA metrics row retains B-0952)"
depends_on:
  - B-0742
  - B-0794
composes_with:
...
# B-0953 -- Kubernetes + ArgoCD integration health tests via kind/k3d
