...
# Domains as adapters on the hex core interface (universal own-your-interface)
...
## The core interface — the math the hex core most rhymes with

The 6 reservoir walls (B-0985) rhyme, most directly, with **Clifford geometric algebra / Cayley-Dickson** — specifically the **6**:

- **6 bivectors of spacetime algebra Cl(1,3) = the 6 Lorentz generators (3 rotations + 3 boosts)** `[established, search-first]`
- **SE(3) 6-DOF** (3 rotation + 3 translation) · **6 cube faces** (Cube-of-Space) · **Cayley-Dickson** nested-cross · **rotors / Spin group**

The "6" is the shared structure each domain adapts (6 bivectors · 6 cube faces · 6 I-Ching hexagram lines · 6 DOF · 6 days · 6 walls).
...
- **B-0985** (hex core / cube-of-space) · **B-0986** (orientation-tile) · **B-0982** (4×4 bond) · **B-0428/B-0547** (F# fork / Clifford) · **B-0994** (earth-twin: cosmology/astronomy adapter) · **B-0995** (body-plan: biology adapter) · **B-0998** (seed/CE; vectors-first) · **B-0997** (referee principle)
- rules: `bcl-interface-boundary-own-your-interfaces-hexagonal` (the universal adapter pattern), `rodneys-razor-compression-rhymes-with-cayley-dickson`, `clifford-algebra-underwater...`, `god-tier-claims-high-signal-high-suspicion-dont-collapse`, `grep-substrate-anchors-before-razor` + `bandwidth-served-falsifier`, `tonal-momentum-equals-meme`
- research: `docs/research/2026-06-02-hex-core-cross-domain-math-rhyme-domains-as-adapters-...-aaron.md` (full mapping + sources)
