...
tags:
  [
    ...
    interactive-setup,
    zflash-cli-override,
    device-flow-at-setup-time,
    token-at-zflash-time,
  ]
---
...
> _"Yes i like that frameing lets do it that way and then zflash script and/or skill can make sure it asks what declared creds you want to bake in vs go through device flow."_
