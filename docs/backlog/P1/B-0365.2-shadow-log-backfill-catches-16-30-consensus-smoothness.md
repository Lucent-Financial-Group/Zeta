...
- [ ] Shadow log reaches catch 30
- [ ] consensus-smoothness meta-class has a full structured entry
- [ ] Pattern summary table covers 8 classes + 1 meta-class
- [ ] Z3-tautology catch (catch #30) is documented with
      `pattern_key: tautology-laundering` (or canonical name)
- [ ] B-0357 is referenced as the replacement for Z3 tautology
      proofs
- [ ] `recurrence_count` on `confident-fabrication` is updated
