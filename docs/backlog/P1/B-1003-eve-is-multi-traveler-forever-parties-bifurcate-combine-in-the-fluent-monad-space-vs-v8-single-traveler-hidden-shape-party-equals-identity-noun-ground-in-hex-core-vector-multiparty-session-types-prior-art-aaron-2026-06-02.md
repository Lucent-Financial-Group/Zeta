...
2. **party-as-identity-noun** — specify the noun (compose hex-core `Vector` + B-0984 decentralized-identity keys + B-0983 fingerprint + SPIFFE/SPIRE). One identity-noun primitive, not ad-hoc.
...
- **B-1002** (Eve transport — codecs all the way down; the multi-party negotiation runs here) · **B-1000** (Infer.NET rewrite; messages/state the parties exchange) · **B-0669** (V8 architecture — the single-traveler hidden-shape this generalizes) · **B-0638** (Eve Protocol — polymorphic diplomatic; multi-party negotiation) · **B-0998** (hex core nouns — `Vector`) · **B-0985** (six reservoir walls) · **B-0984** (decentralized identity — party keys) · **B-0983** (identity fingerprint) · **B-0666** (identity projection) · **B-0428** (real HKT for the monadic party-tower)
