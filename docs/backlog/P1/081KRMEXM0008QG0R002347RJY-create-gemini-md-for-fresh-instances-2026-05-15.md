...
- [x] Point `GEMINI.md` to Lior's persona documentation and memory files (`memory/harness/lior/CURRENT-lior.md`)
...
- Kept lightweight, primarily acting as a pointer to `memory/harness/lior/CURRENT-lior.md` and the existing `CLAUDE.md` for shared factory invariants.
