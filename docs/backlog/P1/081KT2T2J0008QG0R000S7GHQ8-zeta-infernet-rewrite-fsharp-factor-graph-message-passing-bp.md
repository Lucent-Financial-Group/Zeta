...
## This resolves the seed-CE A/B/C fork (B-0998)
...
3. **slice 5** — EP on a model where conjugacy fails (e.g. a probit/logistic factor) matches dotnet/infer's EP within tolerance (referee principle, B-0997).
