...
> _"bonsai trees for integration rx queries in real time"_
...
Aaron earlier in the Mika transcript line 3263 also wired bonsai trees to retraction explicitly: _"the bonsai trees and retractable RX stuff you've been talking about — it's all about managing state and data movement through different levels cleanly."_
...
- The agent's superposition state is _always current_ with the latest tick
