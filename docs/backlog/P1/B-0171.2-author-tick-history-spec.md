...
- The frontmatter schema for the shard files.
- The format of the shard body.
- The invariants that are enforced by the hygiene tools (e.g., chronological order, relative paths).
...
- A new spec file `openspec/specs/tick-history/README.md` is created.
- The spec formally defines the tick-history schema.
- The spec documents the frontmatter fields and their expected values.
