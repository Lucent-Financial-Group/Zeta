...
- [x] Multi-agent review of this design — Otto + Vera reviewed in PR #2969; review doc at `memory/otto/cli/claude/conversations/2026-05-13-b-0400-bus-protocol-otto-review.md` (slice 6)
