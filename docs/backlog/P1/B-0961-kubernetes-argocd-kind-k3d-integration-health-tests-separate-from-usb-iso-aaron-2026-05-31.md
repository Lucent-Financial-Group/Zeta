...
renumbered_from: "B-0951; B-0952; B-0953; B-0957; B-0958; B-0959 (2026-06-01 merge collision repairs; origin/main retains B-0953 Git-V2 row, B-0957 labels/tags row, B-0958 observe-loop row, and B-0959 sovereign distributed-DB row)"
depends_on:
  - B-0742
  - B-0794
composes_with:
...
# B-0961 -- Kubernetes + ArgoCD integration health tests via kind/k3d
