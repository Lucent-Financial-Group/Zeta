...
# Tree of Life / Cube of Space ↔ hexagonal-six — verify the Kabbalah correspondence + the universal-action-grammar lineage
...
- **structurally checkable** (validated): the counts (3/6/12); cube = hexahedron = hexagonal; 12 words = edges not nodes.
- **hypothesized**: the Cube-of-Space correspondence; the trans-historical lineage; the Cayley-Dickson-OR-Kleene algebra mapping.
- **don't-collapse** (PERSONAL INVARIANT): specific mystical word↔letter/sephirah/zodiac correspondences; the metaphysical readings. High-signal/high-suspicion; the geometry is the checkable part.

## Research notes (the design + tables already preserved)
...
- `memory/persona/alexa/conversations/2026-06-02-alexa-website-universal-action-grammar-full-lineage-...-aaron-forwarded.md` (#6562) — the full 9-rung lineage
