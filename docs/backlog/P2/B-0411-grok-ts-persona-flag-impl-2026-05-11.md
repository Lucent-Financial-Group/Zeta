...
effort: S
ask: In tools/peer-call/grok.ts add optional --persona <name> flag (using minimist or built-in parse). If present, call loadPersona and inject; else current bare behavior. Add comment for future amara/ani wrapper deprecation. One script only.
created: 2026-05-11
...
- Parse --persona via arg parser (keep 4-shell compat)
