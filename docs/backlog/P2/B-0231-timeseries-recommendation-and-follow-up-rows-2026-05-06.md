...
Pick one of: adopt and integrate, adopt with adapter, build
native, or defer. Then file the implementation or revisit
rows that make the recommendation actionable.

## Acceptance criteria

- The recommendation names the chosen shape and the evidence
  behind it.
