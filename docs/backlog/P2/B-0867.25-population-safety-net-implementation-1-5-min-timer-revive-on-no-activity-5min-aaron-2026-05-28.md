...
> Aaron 2026-05-28: _"we can run every 1 - 5 minutes it should look at like no activity in last 5 minutes no heartbeats or workflow movement either could be an issue, all agents should stay alive once a named persona comes up once it should not stop unless the system can afford it and the persona wants to stop for a long cescation."_
...
> _"no activity in last 5 minutes no heartbeats or workflow movement either could be an issue"_
...
> _"all agents should stay alive once a named persona comes up once it should not stop unless the system can afford it and the persona wants to stop for a long cescation"_
...
> Aaron 2026-05-28: _"b-log rows are always authorized the more the more money we make later lol"_
