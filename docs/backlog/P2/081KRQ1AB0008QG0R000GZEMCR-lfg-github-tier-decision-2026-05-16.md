...
depends_on: []
composes_with: [081KRQ1AB0008QG0R002422Z9Q, 081KRQ1AB0008QG0R0038VQJZ0]
...
Falls out of 081KRQ1AB0008QG0R002422Z9Q (scarcity tracker) mitigation-axes analysis. The 2026-05-16 session demonstrated GraphQL saturation at the 5000/hr per-user limit. GitHub Enterprise Cloud raises this to **15000/hr per user acting in the organization** (3× headroom).
...
- [ ] Update 081KRQ1AB0008QG0R002422Z9Q scarcity tracker to report 15000/hr limit if upgraded (currently assumes 5000/hr)

## Composes with

- 081KRQ1AB0008QG0R002422Z9Q (scarcity tracker — visibility layer; tier-context informs the bucket size)
- 081KRQ1AB0008QG0R0038VQJZ0 (GitHub App — separate-pool alternative; **these compose**, not alternatives. App for automation; Enterprise for org-features + larger user-pool baseline)
...
- The "free 3× rate-limit" framing is real but the saturation today happened at 5000/hr in ~50 min with 3-4 concurrent agents. At 15,000/hr, same load = ~2.5 hours — helpful but not unbounded. GitHub App (081KRQ1AB0008QG0R0038VQJZ0) still wins long-term because **separate pool > bigger same-pool**.
...
- [x] Prior-art search: 081KRQ1AB0008QG0R002422Z9Q mitigation-axes table already references tier audit as one of three orthogonal mitigations
