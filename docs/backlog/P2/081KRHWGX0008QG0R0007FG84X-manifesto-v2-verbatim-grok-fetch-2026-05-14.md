...
The V1+Bounded-Mobility prose (8 constraints + Agreement + Coincidence Networks) is already verbatim from the §33 archive at `memory/external-ai-participant/ani/conversations/2026-05-14-aaron-ani-grok-extension-manifesto-v2-civsim-arg-layer.md`.
...
4. Optional: update the §33 archive at `memory/external-ai-participant/ani/conversations/2026-05-14-aaron-ani-grok-extension-manifesto-v2-civsim-arg-layer.md` with the additional Grok conversation text covering V2 (if not already there)
5. PR + auto-merge

## Composes with

- `docs/governance/MANIFESTO.md` (the shadow lock this row converts)
- `memory/external-ai-participant/ani/conversations/2026-05-14-aaron-ani-grok-extension-manifesto-v2-civsim-arg-layer.md` (V1+Bounded-Mobility verbatim source)
