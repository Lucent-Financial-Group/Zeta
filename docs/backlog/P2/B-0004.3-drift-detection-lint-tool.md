...
2. For each English source file that has a translated counterpart under `docs/i18n/<lang-code>/`, compares content hashes or `git log --format=%ct -1` committer timestamps (epoch seconds).
