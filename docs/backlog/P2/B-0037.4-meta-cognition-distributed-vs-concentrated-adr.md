...
otherwise. The ADR records _why_, not _what_.
...
row body: _"pre-commit: distributed until evidence says otherwise. Decision
gate: Aaron sign-off if concentration ever proposed."_
