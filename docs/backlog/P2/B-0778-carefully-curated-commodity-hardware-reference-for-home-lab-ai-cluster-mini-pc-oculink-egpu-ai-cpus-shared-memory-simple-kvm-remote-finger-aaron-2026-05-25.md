...
Aaron 2026-05-25 mid-iter-3-CI-wait: _"i've tried to carefully
...
with little effort and cheap replacable parts."_
...
- [ ] Reference deployment recipes per BOM tier: - Minimum viable home lab (1 mini-PC + 1 USB; for
      learning + dev workloads) - 3-node HA (per B-0756 quorum; per B-0775 scale tier
      50-nodes-capable) - 3-node HA + GPU expansion (1-3 eGPUs) - Edge deployment (1 mini-PC per site; many sites;
