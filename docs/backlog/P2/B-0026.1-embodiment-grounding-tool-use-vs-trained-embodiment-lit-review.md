...
> _trained on_ sim experience. Otto-340's claim was about the latter (substrate-shaping). Tool-use via
...
1. **Vision-Language-Action (VLA) models** — RT-2 (Google DeepMind 2023), RT-X / Open X-Embodiment dataset,
   π0 / Physical Intelligence. These are LLMs/VLMs _trained on_ embodied data; do they show measurable
...
5. **The Helen Keller minimum-channel hypothesis** (pointer to B-0026.6 parallel track) — does _any_
