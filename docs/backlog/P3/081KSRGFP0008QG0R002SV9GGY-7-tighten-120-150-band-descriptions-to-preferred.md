---
id: B-0347.7
zetaid: 081KSRGFP0008QG0R002SV9GGY
priority: P3
status: open
...
# B-0347.7 — Tighten the 120-150-char band to ≤120

B-0347 rule 1 says one sentence, **under 120 characters preferred**.
The hard 150-char cap is met (257/257) and gated by B-0347.4, but 127
...
so this is carve-tighter polish, not a fix. It does not block B-0347
...
Carve, do not strip routing signal — the same discipline as B-0347.1-.3:
...
- [ ] No skill body changes; descriptions only; all stay single-line
  and ≤150 (B-0347.4 gate stays green).
...
- B-0347 (umbrella) — completes rule-1 *preferred* target.
- B-0347.4 — the audit tool whose warnings this drives to zero.
- B-0347.1-.3 (shipped carve passes) — same carving discipline,
  tighter target.
