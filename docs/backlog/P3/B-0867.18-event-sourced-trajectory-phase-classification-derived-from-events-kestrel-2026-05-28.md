...
Per Kestrel 2026-05-28: _"That's a derivation from the event log. Doesn't require any separate state tracking. The trajectory phase is always current because it's computed from current events."_
