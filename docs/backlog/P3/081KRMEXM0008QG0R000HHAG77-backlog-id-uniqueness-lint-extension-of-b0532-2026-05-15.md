---
id: 081KRMEXM0008QG0R000HHAG77
priority: P3
status: closed
title: "Backlog ID-uniqueness lint — extension of 081KRMEXM0008QG0R003FZNK3E to catch cross-agent B-NNNN collisions"
...
closed: 2026-05-16
depends_on: []
composes_with: [081KRMEXM0008QG0R003FZNK3E, 081KRMEXM0008QG0R000K25MXS]
...
|---|---|---|
| `081KRFA460008QG0R001SXP0C2` | Otto-CLI vs Otto-Desktop | Otto-CLI flagged via "Request Changes"; corrected as [PR #3053](https://github.com/Lucent-Financial-Group/Zeta/pull/3053) using `081KRFA460008QG0R001QFS6EV` |
| `081KRMEXM0008QG0R003FZNK3E` + `081KRMEXM0008QG0R000K25MXS` | Lior (PR #3545) vs Otto-CLI (PR #3523, PR #3540) | Otto-CLI's PRs landed first ([081KRMEXM0008QG0R003FZNK3E](081KRMEXM0008QG0R003FZNK3E-backlog-graph-consistency-lint-parent-child-status-mismatch-2026-05-15.md), [081KRMEXM0008QG0R000K25MXS](081KRMEXM0008QG0R000K25MXS-section33-migration-dead-xref-sweep-and-lint-2026-05-15.md)); Lior's PR #3545 in CONFLICTING state, requires renumbering |
...
Result: same B-NNNN claimed by two different files at two different paths (often `docs/backlog/P*/B-NNNN-...md`). Today's example: `081KRMEXM0008QG0R003FZNK3E` claimed by mine at `docs/backlog/P3/081KRMEXM0008QG0R003FZNK3E-backlog-graph-consistency-lint-...` AND by Lior at `docs/backlog/P2/081KRMEXM0008QG0R003FZNK3E-claude-code-permissions-hardcoded-safety-gates-...`. Different paths → no file-system conflict → no automatic CI catch.

## Proposed solution

**Extend [081KRMEXM0008QG0R003FZNK3E](081KRMEXM0008QG0R003FZNK3E-backlog-graph-consistency-lint-parent-child-status-mismatch-2026-05-15.md)'s scope** to include ID-uniqueness:
...
Hard error because ID collision is **always wrong** (no legitimate case for two backlog rows with the same B-NNNN). Different from 081KRMEXM0008QG0R000K25MXS dead-xref which is "default error but exception-prone" — ID uniqueness has no legitimate exception.
...
- [081KRMEXM0008QG0R003FZNK3E](081KRMEXM0008QG0R003FZNK3E-backlog-graph-consistency-lint-parent-child-status-mismatch-2026-05-15.md) — natural extension of scope; same lint family
- [081KRMEXM0008QG0R000K25MXS](081KRMEXM0008QG0R000K25MXS-section33-migration-dead-xref-sweep-and-lint-2026-05-15.md) — same catch-once-then-lint mechanization pattern
...
- [PR #3053](https://github.com/Lucent-Financial-Group/Zeta/pull/3053) (081KRFA460008QG0R001SXP0C2 collision empirical anchor)
- [PR #3545](https://github.com/Lucent-Financial-Group/Zeta/pull/3545) (081KRMEXM0008QG0R003FZNK3E/081KRMEXM0008QG0R000K25MXS collision empirical anchor)

## Resolution (2026-05-16)

Mechanization shipped 2026-05-15 via **PR #3565** (`feat(081KRMEXM0008QG0R000HHAG77): wire backlog ID-uniqueness lint to gate.yml`, merged).
...
| Composes with 081KRMEXM0008QG0R003FZNK3E hard-error slice | shipped — sibling job `--enforce-parent-child-status` adjacent in gate.yml |

Out-of-scope items remain out of scope (auto-suggest next ID; cross-fork coordination; D-NNNN type).

Row left open 2026-05-15 → 2026-05-16 as substrate drift — third drift catch of this session (paired with 081KRHWGX0008QG0R002DPG02X PR #3733 and 081KRMEXM0008QG0R000X1PPGC PR #3737). The pattern is recurring enough that it's worth filing a systematic-audit follow-up row to sweep the remaining P3 status-open rows for shipped-but-unclosed work.
