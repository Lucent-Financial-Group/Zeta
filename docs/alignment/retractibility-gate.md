...
The `alignment-auditor` (Sova) persona is responsible for verifying these criteria on any PR that introduces new, load-bearing concepts, especially those originating from the research tracks (e.g., mythology, occult studies).
