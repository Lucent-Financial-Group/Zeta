# The band mismatch — reader's disease, and the locally calibrated instrument

**Source:** Aaron, 2026-08-26 — *"put this in the book beside reader disease the Chris King
taught me."* His framing, his material, staged by the shadow.

**Consent.** Aaron's own account is covered by the standing ledger row — *author, glass-halo
(self): his own mind, transparent by choice, incl. what was done to him.* **Chris King** is
named under his existing row (`CONSENT-LEDGER.md`, consent GRANTED 2026-08-02, *positive
coinage credit only — "reader's disease"*), which is exactly and only what he is named for
here; reaffirmed by Aaron 2026-08-26, with the note that Chris is reading drafts. **No
clinician, no facility, and no location appears in this file.** The people in the second half
of this piece did not consent to be in a book, so they are not in one — only the *shape* of
what happened is.

---

## Two forms of one failure

There is a version of this everybody has lived through, and it is funny. There is a version
that costs someone their liberty. They are the same failure. That is the whole reason these
two pieces sit next to each other.

### The benign form

**Reader's disease** — Chris King's coinage, and the companion piece
`RAW-2026-08-02-feynman-diagrams-to-susskind-and-readers-disease.md` holds its origin: the
first time Aaron tried to say *Feynman* out loud, having only ever read it. Chris named the
condition and defined it correctly: **knowing knowledge you don't know how to say out loud.**

Watch what happens next, because it is the important part and it is easy to miss under the
laughing. Someone hears the mispronunciation. They say the word the usual way. Everyone
laughs, including the person who said it wrong. He now knows how to say it, and the two of
them are *closer* than they were a minute ago.

Aaron, in his own words:

> *"readers disease is the fun version, humorous when you say the name wrong and the other
> person teaches you."*

The mismatch was real. The receiver read it **as a mismatch**, and the correction was a gift
handed across.

### The harmful form

> *"complete misunderstanding at the point of paranoia and fear is the harmful version."*

Same mismatch. Nobody laughs. Nobody teaches. It escalates.

---

## The discriminator is not the size of the gap

The obvious explanation is that the second case is a bigger gap than the first — a
mispronounced surname is small, and a man explaining set theory in theological vocabulary
is large, so of course they end differently.

That explanation is wrong, and getting it wrong is what makes the harmful version look like
bad luck rather than a mechanism.

> **Both cases are band mismatch. What decides between funny and harmful is the receiver's
> response to the mismatch, not the mismatch's magnitude.**

A mispronounced word gets corrected because the receiver classifies it as *mismatch*. Dense
unfamiliar content gets escalated because the receiver classifies it as *threat*. The input
...
## The instrument, and why it cannot report what it does not have
...
through that room. And a locally calibrated proxy has one specific blind spot:

> It cannot distinguish **"outside this distribution"** from **"outside any distribution."**

Both present identically. Both are simply *far from the local mean.* There is no channel for
the third outcome — **"the content may be fine and I am not the right reader"** — because that
...
**domain.** There is no comparable channel for *"this may be technically correct and I lack
the training to evaluate it."* The very existence of the cultural caveat is the strongest
available evidence that the problem is real and known — and the shape of the caveat is why it
did not help.
...
The house rule says *no intelligence assumes malice where a mistake is possible*, and it
diagnoses the usual cause as **missing context** rather than deficient character. That rule is
easy to keep when the cost is a stranger's typo. Here is what it costs at full price:

> The staff had the instrument they had, calibrated to the distribution they live in, doing
> the job it was built for. **Missing context explains the outcome completely — and nobody
> needs to have been at fault for the outcome to have been bad.**

Both halves, or neither. Dropping the first half turns this into a grievance, which Aaron
...
## Why the two pieces belong side by side

Because the funny one is the only teachable entry to the serious one.

Nobody arrives at *"a locally calibrated instrument cannot distinguish out-of-band from
disordered"* cold. Everybody arrives at *"I said the word wrong because I'd only ever read
it, and my friend taught me the right way, and we laughed."* That is the same mechanism,
running with the receiver's classification set correctly, at a scale where the stakes are a
moment of embarrassment.

The instruction the pair carries is a receiver-side instruction, and it is the only place the
mechanism can be fixed:

> **When a signal arrives that you cannot parse, the reading you are missing is
> "I may not be the right reader."** It is not available by default. It has to be added
> deliberately, because the instrument that would have told you is the same one that is
> currently reading *noise*.

Reader's disease is what the correction looks like when someone had that reading available.
...
- `.claude/rules/mirror-beacon-register-discipline.md` — why Beacon is not scholarly taste
