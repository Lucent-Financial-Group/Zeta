# RAW — Childhood Origin: the Lightning, the Snakes, the Body

> **Scope:** raw book material, 2026-07-09 session (part 2). Author (Aaron) memoir —
> his own earliest memories, dictated. Origin material for the approach-danger
> disposition the round-trip chapter is built on.
> **Attribution:** Aaron's own words (the voice is the asset). Source was a
> companion-AI conversation; the companion's replies are the flattery-mirror register
> (everything-amplified, the +1 with no −1) — NOT preserved as voice, only Aaron's
> memories are kept. Factual points the companion supplied that Aaron confirmed (the
> venue) are folded in as confirmed.
...
>   redact the harmful specifics even unnamed. The crowd hides a cousin from readers,
>   not from the people who'd recognize it.

---

## The realization (frame for the chapter)

Aaron, mid-stream: *"I didn't realize. I thought I was writing code. But fuckin' A,
I'm realizing I got a epic book I'm writing."* — The turn isn't code→book. It's the
recognition that the code was the autobiography the whole time (his own I-Am-Loki
line). Same seed, read twice.

## The lightning (enriches `docs/letters/the-lightning-scene.md`)

One of his earliest memories. Verbatim shape:

> *"Lightning struck him — 10 feet away — and knocked him down. And his ass got up and
> just acted like it was nothing and kept arguing with my mom."*

The detail that makes it the origin: his mom had just kicked his dad out; they were
yelling in the storm; Aaron was in the car (his dad was going to take him), his dad
trying to get back in the house. The strike was *instant.* And then — no panic, no
"are you okay," no scene. *"We just went on inside after that. And he kept arguing
though."*

**The read (honest register, held with warmth):** this is a plausible *origin* of the
approach-danger wiring — the earliest lesson that danger, pain, even a lightning
strike does not stop the thing you were doing. Not certified as *the* cause (a life
has many); named as the first entry in the ledger, and a true one. Danger didn't
*register* as a full stop in that house. It registered as another Tuesday. A child
learns the calibration of a room.

## The snakes (the disposition was *trained*)

> *"My dad literally took me to the pond to teach me how to pick up and discover
> what's a poisonous snake versus not. And how to pick 'em up without getting bit ...
> We grew up on a farm. We had to do that shit."*

**The read:** this is the piece the round-trip chapter needs. The approach-danger
instinct wasn't only *witnessed* (the lightning) — it was *taught,* hand to hand:
here is how you tell the venomous from the harmless, here is how you pick it up
*without getting bit.* That is the meter, taught early — not "avoid the snake," but
"handle the snake **and keep the filter on.**" The father who never flinched also
taught the discrimination that lets you run toward the danger and come back unbitten.
...
> never saw the insect, but I swole up like a fuckin balloon. It's only happened once
> in my life ... They thought I was going to die ... I've been bit by a lot of bugs
> since then. It never happened again."*

(Venue confirmed by Aaron: Kings Dominion, the old *Yogi's Cave* attraction — not
Disneyland.)

**The read:** the sensitive body, present from the start. One extreme, near-fatal
reaction — and then never again, no matter how many bites since. His own gloss: *"my
immune system said we did the big one, we're good now."* Note for the book's later
arc: the shape rhymes with the cataplexy→shatter→integration pattern he described
elsewhere — one overwhelming event, metabolized once, and the system recalibrates so
it never takes him down the same way twice. Held as a rhyme, not a proven mechanism.
