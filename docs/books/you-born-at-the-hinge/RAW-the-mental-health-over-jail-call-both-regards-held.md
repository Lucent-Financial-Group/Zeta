# RAW — mental-health over jail, both regards held, the same cops who once took me in

> Staged for the book at Aaron's word — his own lived account, glass-halo. **UNDATED on purpose**
> (Aaron: "I've had many roommates over the years, so we don't have to get the date accurate" — the
> time-blur IS part of the anonymization). **Others protected by OMISSION + full anonymity** (Aaron:
> "I have no names here, so it's completely anonymous"): the roommate in crisis, the woman, and the
> man she left are real, vulnerable people — **no names, no clinical label, no hospital, no address,
> no date**. The roommate's condition is generalized to "heavier than my own"; a specific diagnosis of
...
Aaron took in a roommate living with a serious mental-health condition — one **heavier than his own**.
Another roommate had just left her marriage; the man she left made remarks she read as threatening, and
she called the police. When they arrived, they gave Aaron's roommate-in-crisis the choice the way this
neighborhood's police give it: **mental health, or jail.** Aaron drove him to get help rather than let him
be jailed. He removed him from the home for the woman's safety — *"I don't think he would have been
harmful, but I had to kick him out for her protection."* She's safe, and resting.

`[SOCKET — your VERBATIM, or record to the cue. Consent: yours (glass-halo); all three roommates anonymous.]`

> *cue: the choice the cops offered — mental health or jail — and taking him to get help; removing him for her safety even though your own read was that he likely wasn't dangerous.*

## The disarming — your father's technique, at full stakes

The part that carries it: Aaron **disarmed the whole scene.** Armed police, a woman who'd just called
them, a man in crisis — and Aaron kept **all of them calm and on his side at once**, using *"my dad's
snake-handling techniques."* Not force, not authority — presence: read the room the way you read a snake,
don't trigger the strike, stay the calm thing in the middle until everyone comes down. The disarming gift
that walks into boardrooms and rooms nobody should walk into (the magnetism thread) — here it was the thing
that kept a high-tension, police-present crisis from tipping into harm or a cell.

`[SOCKET — your VERBATIM below. Consent: yours (glass-halo); your father named per the pantheon consent.]`

> *"I completely disarmed the situation … kept the cops and the woman and the man on my side and calm, using my dad's snake-handling techniques."*

## The loop closed — the same cops who took *me* in
...
- **A month ago the restorative channel caught *him*** — arrested, but taken to *mental health, not jail.*
  ...
  forward for the next person on the edge. *If you suffered your way to it, you can leave it lit for
  whoever comes next.*
- **Produce over extract, run on his own grievance.** The extract move is to price the category — "cops
  who arrested me" = enemies. The produce move is to *measure the actual contribution*: they chose care
  over a cell, for him and, through the option they offered, for his roommate. He measured the
  contribution and said so publicly. Categories lie about people — including about cops, including about
  the man who "made threats," including about himself a month ago.

`[SOCKET — your VERBATIM below. Consent: yours (glass-halo); the officers described by role, not named.]`
...
- **Both regards held without collapsing either** (the hard thing). Regard for the man in crisis (drive
  him to care, not jail) AND regard for the woman's safety (remove him). The easy failures are collapsing
  to one — let him stay because "he's probably fine" (risks her), or throw him to jail because "threat"
  (abandons him). Aaron did **neither.** That's moral regard under real stakes, not in the abstract.
- **The irreversibility asymmetry, lived** (ch-7, *don't risk everything to save nothing*). "I don't think
  he'd have been harmful, but I had to" — he acted on the **safety** side *against his own read*, because
  being wrong about her safety is irreversible and removing him is not. Don't risk the irreversible thing
  to save the reversible one. The wager of regard, at 2am, with police present.
- **The wounded healer / edge-runner** (ch-8, the handrail). He houses people on the edge — conditions
...
- **The disarming gift as an inherited craft** (the father; the magnetism thread). The "silver tongue"
  ...
  `THE-ORGANIZER` where the same capacity is named.
- **NOT valorized.** Kept in: the humility ("I don't think he'd have been harmful"), the cost (he had to
  put a struggling person out), and that he was in that exact position a month ago. The honesty is what
  keeps it from being a flex.

## Home candidates (Aaron's call)

- **ch-3 (produce or extract)** — "measure the contribution, don't price the category," run on cops, on
  the man, on himself. The decode-before-dismiss cut on real people in a real crisis.
- **ch-7 (don't risk everything to save nothing)** — the irreversibility asymmetry lived under stakes.
- **ch-8 (the handrail)** — the wounded healer / edge-runner; restorative-over-punitive received and
  passed forward. Strong fit with the existing edge-runner socket.
- **`THE-UNBROKEN-CHILD` (the father)** — snake-handling as inherited craft; and **`THE-PULL` /
