...
export function packageHash(pkg: AcePackage): string {
  return (
    "sha256:" +
    createHash("sha256")
      .update(canonicalBytes({ manifest: pkg.manifest, files: pkg.files }))
      .digest("hex")
  );
}
```
    ...
    },
    {
      ...
      "package": {
        "manifest": {
          ...
          "signature": { "algo": "ed25519", "key_id": "ed25519:abcd", "sig": "AAAA" }
        },
        "files": { "a.txt": "a" }
      },
      "expected_canonical_json": "",
    ...
    },
    {
      ...
      "package": {
        "manifest": {
          ...
          "dependencies": [{ "kind": "registry", "name": "dep", "version": "^1.0.0" }]
        },
        "files": { "r.txt": "r" }
      },
      "expected_canonical_json": "",
