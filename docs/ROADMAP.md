...
- **ZetaDB product** — map landed 2026-09-02 (event log as WAL, tables as views, Flink/Reaqtor feel, Feldera as DBSP competitor not Postgres-on-DBSP). SQL is a package targeting Core, not inside Core. Next: ZD2 freeze-through-ferry (D4), ZD9/PR12 ReFS-shaped crash DST for FS *and* DB, ZD1 standing-query bench, ZD4 FS product-existence bench. D9–D12: pointer-not-copy, one cache authority, CoW amplification bound, crash DST. [`docs/design/2026-09-02-zetadb-roadmap-event-sourced-streaming-sql-not-feldera-on-postgres.md`](design/2026-09-02-zetadb-roadmap-event-sourced-streaming-sql-not-feldera-on-postgres.md) `081M1HGD1QA087G0R001GRHPFW` · `081M1HK4AQE087G0R002RRJXWE`
