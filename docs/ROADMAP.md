...
- Blocked + counting Bloom (`BloomFilter.fs`) ✅ — 4-bit counters, `CounterSaturated` at 15. **Bloom vs anti-bloom** (two grow-only filters, three-valued membership) is analysis on the ZetaDB satellite, not a result (ZD10). Not a filesystem feature. Does not reopen WONT-DO deletable Bloom.
- HyperLogLog ✅
- Count-Min Sketch ✅
- KLL quantile ✅
- HyperMinHash ✅
