...
> **NOT OK — RED 8 · UNKNOWN 4, incl. NEVER observed · coverage 62/66 (SHORTFALL 4) · green 56 · on-demand 14**
...
| `k8s-lane-partition` | 15m | unknown | run 32587132920 concluded 'failure' |
| `gate` | 30s | on-change | run 32587132916 concluded 'failure' |
...
| `rerun-cancelled-gate` | skipped | run 32587986007 was skipped |
...
| `agencysignature-enforcement` | 11s | on-change |
| `agent-heartbeat` | 3m | periodic |
...
| `docker-ubuntu-jammy-install-sh-test` | 5h | on-change |
...
| `heartbeat-liveness` | 8m | periodic |
| `helm-validate` | 2h | periodic |
| `installer-unit-tests` | 16h | on-change |
| `inventory-hardening-check` | 3d | on-change |
| `inventory-heartbeat` | 11h | periodic |
| `k8s-argocd-health-test` | 2m | periodic |
| `keyring-dst1000` | 16h | on-change |
| `lean-proof` | 5d | on-change |
| `lint-autofix-apply` | 1s | on-demand |
...
| `mux-swarm-tick` | 26m | periodic |
| `pages-build-deployment` | 15d | unknown |
| `pages-deploy` | 6m | periodic |
...
| `tick-metrics` | 8m | periodic |
| `udp-lossy-tests` | 32s | on-change |
| `update-graph` | 21d | unknown |
| `vocab-hygiene` | 12d | on-change |
| `wsl-install-sh-test` | 6h | on-change |
| `zetadb-scheduled-node` | 12m | periodic |
