...
- **Undeclared unhashed:** 172 — visible and countable, but not yet declarable. This number must only fall.
- **Digest-covered:** 1923.
...
|---|---|---|---|---|
| `from-installer` | `grok` | unpinned | xai-serves-one-unversioned-install-endpoint-and-publishes-no-release-artifact | `tools/setup/manifests/from-installer:27` |
| `from-installer` | `cursor-agent` | unpinned | cursor-publishes-a-single-rolling-install-endpoint-with-no-version-in-the-path | `tools/setup/manifests/from-installer:28` |
| `from-installer` | `kiro-cli` | unpinned | kiro-cli-endpoint-is-unversioned-and-upstream-publishes-no-tagged-installer | `tools/setup/manifests/from-installer:29` |
| `from-installer` | `hermes` | unpinned | installer-is-served-from-the-main-branch-so-there-is-no-tag-and-no-stable-digest | `tools/setup/manifests/from-installer:30` |
| `from-installer` | `forge` | unpinned | forgecode-serves-one-rolling-cli-endpoint-with-no-versioned-path | `tools/setup/manifests/from-installer:31` |
| `from-installer` | `agy` | unpinned | antigravity-serves-one-unversioned-install-endpoint-per-release-channel | `tools/setup/manifests/from-installer:32` |
...
| `docker` | 1 | `node:24-slim` | a container base is pinnable with @sha256: at its point of use; this one is not, and has no tools/setup/manifests/pinned-refs row either | `agentic-organization/Dockerfile:6` |
...
| `pip` | 1 | `.venv-yamllint/bin/python -m pip install --upgrade pip` | pip can verify wheels with --require-hashes against a hashed requirements file; this call site uses neither | `.github/workflows/gate.yml:1053` |
| `pip` | 1 | `.venv-yamllint/bin/pip install yamllint==1.38.0` | pip can verify wheels with --require-hashes against a hashed requirements file; this call site uses neither | `.github/workflows/gate.yml:1054` |
...
|---|---|---|
| `docker` | `oven/bun:1.3.14-alpine@sha256:5acc90a93e91ff07bf72aa90a7c9f0fa189765aec90b47bdbf2152d2196383c0` | `full-ai-cluster/openbao-unseal/Dockerfile:16` |
| `docker` | `oven/bun:1.3.14-alpine@sha256:5acc90a93e91ff07bf72aa90a7c9f0fa189765aec90b47bdbf2152d2196383c0` | `full-ai-cluster/openbao-unseal/Dockerfile:24` |
| `docker` | `mcr.microsoft.com/dotnet/runtime:10.0-noble@sha256:399e54a8a7e35c3aba78398b2840455d45185cba20b831b8a2b46f849f4f5001` | `full-ai-cluster/orleans-silo/Dockerfile:16` |
| `docker` | `mcr.microsoft.com/dotnet/sdk:10.0-noble@sha256:4ea6fe75dd36706bb6d8c3c293d4c4315840f5d76ea28ac97def77e3ec487fa5` | `full-ai-cluster/orleans-silo/Dockerfile:6` |
| `docker` | `oven/bun:1.3.14-alpine@sha256:5acc90a93e91ff07bf72aa90a7c9f0fa189765aec90b47bdbf2152d2196383c0` | `full-ai-cluster/platform-controller/Dockerfile:3` |
| `docker` | `oven/bun:1.3.14-alpine@sha256:5acc90a93e91ff07bf72aa90a7c9f0fa189765aec90b47bdbf2152d2196383c0` | `full-ai-cluster/portal/Dockerfile:10` |
| `docker` | `oven/bun:1.3.14-alpine@sha256:5acc90a93e91ff07bf72aa90a7c9f0fa189765aec90b47bdbf2152d2196383c0` | `full-ai-cluster/portal/Dockerfile:3` |
| `docker` | `mcr.microsoft.com/dotnet/sdk:10.0-noble@sha256:4ea6fe75dd36706bb6d8c3c293d4c4315840f5d76ea28ac97def77e3ec487fa5` | `genesis/_src/auth-backend/Dockerfile:2` |
| `docker` | `mcr.microsoft.com/dotnet/aspnet:10.0-noble@sha256:1fe86375600b62e6566b465da9553eef0621f13c67f40fe764cd8dbb1dee1497` | `genesis/_src/auth-backend/Dockerfile:9` |
| `docker` | `ubuntu:24.04@sha256:c4a8d5503dfb2a3eb8ab5f807da5bc69a85730fb49b5cfca2330194ebcc41c7b` | `src/Core.TypeScript/ci/dockerfiles/ci-runtime/Dockerfile:42` |
| `docker` | `nixos/nix:2.31.2@sha256:29fc5fe207f159ceb0143c25c19c774062fee02ce5eda118f3067547b3054894` | `src/Core.TypeScript/ci/dockerfiles/nixos-install-sh-test/Dockerfile:36` |
| `docker` | `ubuntu:24.04@sha256:c4a8d5503dfb2a3eb8ab5f807da5bc69a85730fb49b5cfca2330194ebcc41c7b` | `src/Core.TypeScript/ci/dockerfiles/ubuntu-install-sh-test/Dockerfile:22` |
| `docker` | `ubuntu:22.04@sha256:ce941a2a18bbb922e434d6d6d2b31e571a5c3826eaf6ada0a41dcc905bd2d906` | `src/Core.TypeScript/ci/dockerfiles/ubuntu-jammy-install-sh-test/Dockerfile:16` |
| `docker` | `mcr.microsoft.com/windows/servercore:ltsc2025@sha256:e18a49cbc074dfaa8e106296d51cebd62bbf6effb999f134a5c48eed1c2334e1` | `src/Core.TypeScript/ci/dockerfiles/windows-install-ps1-test/Dockerfile:25` |
| `from-agda-cubical` | `cubical` | `tools/setup/manifests/from-agda-cubical:32` |
| `from-agda-cubical` | `cubical` | `tools/setup/manifests/from-agda-cubical:33` |
| `from-agda-cubical` | `cubical` | `tools/setup/manifests/from-agda-cubical:34` |
| `from-agda-cubical` | `cubical` | `tools/setup/manifests/from-agda-cubical:35` |
| `from-autotools-tarball` | `eprover` | `tools/setup/manifests/from-autotools-tarball:16` |
| `from-elan` | `elan` | `tools/setup/manifests/from-elan:9` |
| `from-opam-git` | `tlapm` | `tools/setup/manifests/from-opam-git:8` |
| `from-url` | `src/Core.TLA/tla2tools.jar` | `tools/setup/manifests/from-url:111` |
| `from-url` | `src/Core.Alloy/alloy.jar` | `tools/setup/manifests/from-url:29` |
| `github-actions` | `321 SHA-pinned reference(s)` | `.github/workflows` |
| `npm` | `40 integrity-covered package(s)` | `agentic-organization/package-lock.json` |
| `npm` | `430 integrity-covered package(s)` | `bun.lock` |
...
| `npm` | `864 integrity-covered package(s)` | `package-lock.json` |
