...
row #47 (_missing-prevention-layer meta-audit_). For every row in
...
not a correctness-enforcement one (Aaron 2026-04-22: _"we are
enforcing intentional decsions"_). The script cannot compute
whether a row's classification is _right_ — that judgement
