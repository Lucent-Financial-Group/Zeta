...
Aaron 2026-05-13 22:08Z: _"any changes you need to make to it so it's more
...
file). For full 3-surface convergence at the _prompt-substrate_ level
(not just the _discipline_ level), Anthropic would need to support a
