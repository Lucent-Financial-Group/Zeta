...
1. `check docs/BACKLOG.md generated-index drift` — 081KRQ1AB0008QG0R001YAF3TR row required `BACKLOG_WRITE_FORCE=1 bun tools/backlog/generate-index.ts` regen
...
3. `lint (markdownlint)` MD047 — 081KRQ1AB0008QG0R001YAF3TR row missing trailing newline
...
1. `BACKLOG_WRITE_FORCE=1 bun tools/backlog/generate-index.ts` → wrote docs/BACKLOG.md (081KRQ1AB0008QG0R001YAF3TR + composite-index updates)
...
5. `bunx markdownlint-cli2` on 5 files (081KRQ1AB0008QG0R001YAF3TR + 2 research + 1019Z.md + regenerated BACKLOG.md) → only 081KRQ1AB0008QG0R001YAF3TR missing MD047 trailing newline; fixed
...
- Commit `b8d6947` on PR #4059 branch: 3 mechanical CI fixes (BACKLOG.md regen + 1019Z.md depth fix + 081KRQ1AB0008QG0R001YAF3TR MD047)
...
- 081KRHWGX0008QG0R000M9RFY2 status close + Soraya/Kestrel NOTEBOOK expansions (overlap-check needed)
