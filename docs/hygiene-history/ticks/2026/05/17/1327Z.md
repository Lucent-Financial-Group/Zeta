...
- `memory/external-ai-participant/kestrel/NOTEBOOK.md` + `memory/formal-verification-expert/soraya/NOTEBOOK.md` modifications — overlap-check with PRs #4034/#4043
