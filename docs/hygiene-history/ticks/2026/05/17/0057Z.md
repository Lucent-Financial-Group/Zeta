...
# Tick 2026-05-17 0057Z — 081KQGDBJ0008QG0R000A4EZS5 AC #2 smoke test for tools/profile.ts
...
- `bun tools/bus/claim.ts acquire --from otto-cli --item 081KQGDBJ0008QG0R000A4EZS5
...
081KQGDBJ0008QG0R000A4EZS5's "Non-install `.sh` files without TS sibling (3 ports
...
(081KRA5AR0008QG0R0011ZGRZT acceptance #4). `tools/profile.ts` has no test.
