...
Operator-instruction received: _"30 open PRs ... Own your PRs through merge"_
plus _"For any PR where gate=BLOCKED and nextAction=resolve-threads: check out
branch, read review comments, fix code issues, push, reply to threads,
resolve via GraphQL, arm auto-merge."_
