...
**Real finding.** I had double-counted: `docs/backlog/P2/081KRA5AR0008QG0R0011ZGRZT-...md` is both a "backlog-row file" reference AND part of the "3 backlog rows" tally (which includes 081KRA5AR0008QG0R0011ZGRZT). The correct deduplicated count is 28, not 29. Codex caught the arithmetic mismatch.
...
**Documentation clarity finding.** The `B-NNNN` token in shard prose was shorthand for "iterate per row" — the actual commands were `ls docs/backlog/P*/081KR2E4K0008QG0R001HQF27C-*.md`, `ls docs/backlog/P*/081KR2E4K0008QG0R002KNZ29V-*.md`, `ls docs/backlog/P*/081KRA5AR0008QG0R0011ZGRZT-*.md`. Codex correctly noted that, taken literally, the documented command wouldn't validate anything.
...
- **Codex caught real arithmetic error**: 29 ≠ 6+12+7+3 (= 28); 081KRA5AR0008QG0R0011ZGRZT was double-counted as both "row file" and "row ref". Cumulative tally corrected.
