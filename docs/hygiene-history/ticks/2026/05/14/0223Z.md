...
→ Keep peer-call B-0409. Renumber others (NOTE: initial targets
shown here; FINAL IDs in this PR are B-0462/B-0463 — see 0238Z
shard for the bump that avoided PR 3070's reservations):

  amara-persona-bootstrap B-0409 → B-0459 (SUPERSEDED → B-0462)
  wallet-immune-system B-0409 → B-0460 (SUPERSEDED → B-0463)

## Chain remap

PR 3069 left B-0457's depends_on referencing the to-be-renumbered
amara B-0409. This PR remaps it (SUPERSEDED — final values shown):

- B-0457.depends_on: [B-0409] → [B-0462] (initial: B-0459)
- B-0457.composes_with also updated to B-0462
