...
| Artifact | Where | What |
|---|---|---|
| `0054Z.md:38` | PR #3066 `5156433` | Escaped pipe in regex: `[^0-9.]\|$` → `[^0-9.]\\|$` |
...
break-even-on-mechanization analysis from tick 0100Z (occurrence
#10) moved another step closer (now at occurrence #7).
