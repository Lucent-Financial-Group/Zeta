...
**081KRHWGX0008QG0R003S6KGGE — civsim repo scaffolding tooling (Stage 1, product-repo split)**
...
1. **`docs/backlog/P1/081KRHWGX0008QG0R003S6KGGE-civsim-repo-scaffolding-2026-05-14.md`** — new backlog row
...
3. **`tools/scaffold/civsim/`** — 5 day-one scaffold files:
   ...
   - `LICENSE` — honor-system text from 081KRHWGX0008QG0R000BWAXNP (mutual-privacy clause)
...
4. **`docs/BACKLOG.md`** regenerated to include 081KRHWGX0008QG0R003S6KGGE
...
1. **Speculative work** — 081KRHWGX0008QG0R003S6KGGE (Stage 1 civsim scaffolding from ADR) ✓
...
- Wait for PR #3126 CI to pass (14 checks in-progress); auto-merge will close 081KRHWGX0008QG0R003S6KGGE
