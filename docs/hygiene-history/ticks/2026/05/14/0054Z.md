...
| 3 | Copilot | memory file:20 | Procedure references audit tool + 081KRFA460008QG0R00308W7FJ but branch is behind main (false positive — both ARE on origin/main now) |
| 4 | Copilot | memory file:40 | Procedure's grep recipe treats `B-0XXX` as regex; for sub-row IDs like `081KRA5AR0008QG0R001JVT5FX` the dot matches any char. Also `\b` is GNU-grep, not portable to macOS BSD grep |
...
strengthen 081KRHWGX0008QG0R000JEBCWZ's case (file already opened in PR #3065). The
...
| #3065 | 081KR2E4K0008QG0R000ARCH0X-0373 P2 renumber + 2 MD032 + 081KRHWGX0008QG0R000JEBCWZ row | wait-ci |
| #3066 | 081KRFA460008QG0R00308W7FJ procedure (4-issue fix: frontmatter + MD018 + grep recipe + 2 threads) | wait-ci |
