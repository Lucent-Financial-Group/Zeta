# Tick 2026-05-14T18:25Z — razor-cadence batch 3 reveals STALE POINTER cluster + 081KRHWGX0008QG0R002E3BCDS filed
...
| `bandwidth-served-falsifier.md` (#2850) | 7 + 2 memory | 081KRCQQF0008QG0R0008VT354 |
| `default-to-both.md` (#2845) | 8 + 4 memory | 081KRCQQF0008QG0R0008VT354 |
| `fsharp-anchor-dotnet-build-sanity-check.md` (#2843) | 6 + 2 memory | 081KRCQQF0008QG0R0008VT354 |

### Audit findings

**Rules (10 unique)**: 10/10 LIVE ✓
**Memory refs (7 unique)**: **6 LIVE + 1 MISS**
**Backlog (1 unique, 081KRCQQF0008QG0R0008VT354)**: 1/1 LIVE ✓
...
Filed **081KRHWGX0008QG0R002E3BCDS** at `docs/backlog/P3/081KRHWGX0008QG0R002E3BCDS-author-missing-wwjd-grey-honest-memory-file-2026-05-14.md` documenting:
...
ID-allocation discipline: 081KRHWGX0008QG0R000E8BHQ9..081KRHWGX0008QG0R003TCDFZ5 are in-flight on PR #3163 (Otto-Desktop's 081KRFA460008QG0R000CYBGKW decomposition); 081KRHWGX0008QG0R002E3BCDS is the next safe ID.
...
- **081KRHWGX0008QG0R002E3BCDS filed** capturing the finding + resolution options.
