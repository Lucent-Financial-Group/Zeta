...
- Local HEAD: `6f91e9c fix(081KRSKQ20008QG0R002TH55X6): drop Option A from zsh fallback recommendation`
...
- 081KRSKQ20008QG0R002TH55X6 disposition: closed via Option C on main (`cbf70d7`); Option A/B prior work may
...
2. **8 prior commits on `otto/b0613-zsh-portability-followup-1443z`**: cascade-shard
   substrate (PR #4097 brief-acks #1/#2/#3 + 081KRSKQ20008QG0R002TH55X6 zsh portability follow-up).
...
- `memory/kestrel/NOTEBOOK.md` + `memory/soraya/NOTEBOOK.md`
