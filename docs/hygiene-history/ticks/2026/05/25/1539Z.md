...
- **~10 with failed required checks** (`requiredChecks.failed=1`): #4831, #4932, #4933, #4935, #4936, #4938, #4939, #4940, #4941, #4942, #4943, #4944 — even a clean rebase would not move these to CLEAN
- **3 with auto-merge already armed**: #4857, #4868, #4876, #4929 (auto-merge will fire when DIRTY clears + threads resolve)
