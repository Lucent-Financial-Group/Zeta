...
- **Mutex empirically works**: invoked from a main-sync'd worktree reports `peerDetected=true, peerCount=6, exit=7` — diagnostic correctly identifies the multi-Otto-CLI concurrency that originally motivated 081KRMEXM0008QG0R000X1PPGC.
- **Primary worktree still stuck on Lior's rebase** at `65c7865` (~8 hours since the 0230Z contamination observation). Per [081KRHWGX0008QG0R001HMWM1W Pattern 7](../../../../../backlog/P3/081KRHWGX0008QG0R001HMWM1W-multi-otto-branch-state-contamination-rca-2026-05-14.md), the prescribed recovery is to NOT touch peer state and operate from dedicated worktrees — that's what I've been doing for ~all of today's work.
