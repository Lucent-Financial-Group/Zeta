# Tick 0329Z — PR #3342 review-cycle-3 close-out; 081KRHWGX0008QG0R001HMWM1W Pattern 7 + 081KRMEXM0008QG0R000T0A28T filed
...
- [081KRHWGX0008QG0R001HMWM1W RCA](../../../../../backlog/P3/081KRHWGX0008QG0R001HMWM1W-multi-otto-branch-state-contamination-rca-2026-05-14.md) updated: Pattern 7 "Abandoned rebase state in shared `.git/` dir" added with field-test pointer + cheap-mechanization sketch (stale-rebase-state diagnostic). Committed in `f6789dd`.
- [081KRMEXM0008QG0R000T0A28T](../../../../../backlog/P3/081KRMEXM0008QG0R000T0A28T-shadow-launchd-installer-unit-tests-2026-05-15.md) filed for the deferred test-coverage P1. Committed in `cd4964e`. Effort: S; P3 because behavior is correct (smoke-tested) — tests harden against regression.
...
| Copilot P1 | ts:185 | No unit tests for safety-critical helpers | Deferred to [081KRMEXM0008QG0R000T0A28T](../../../../../backlog/P3/081KRMEXM0008QG0R000T0A28T-shadow-launchd-installer-unit-tests-2026-05-15.md) (substrate-honest scope management); PR comment linked the row |
...
3. **Test coverage as backlog-row vs in-PR**: per substrate-honest scope-management, the test file is a separate piece of work. Filing 081KRMEXM0008QG0R000T0A28T + linking it from the PR thread + commit message is the canonical way to defer without dropping the finding on the floor.
...
| 081KRHWGX0008QG0R001HMWM1W RCA pattern count | 6 (1-6 from 2026-05-14) | 7 (added "abandoned rebase state in shared .git/") |
| Backlog rows in flight | (no 081KRMEXM0008QG0R000T0A28T) | 081KRMEXM0008QG0R000T0A28T filed (deferred test coverage) |
