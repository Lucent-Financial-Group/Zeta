# Tick 1807Z — broader §33 dead-xref pattern surfaced; filed as 081KRMEXM0008QG0R000K25MXS for two-slice fix
...
- Filed [081KRMEXM0008QG0R000K25MXS](https://github.com/Lucent-Financial-Group/Zeta/pull/3540) — §33 migration dead-xref sweep + static lint (P3, two-slice). Composes with [081KRMEXM0008QG0R003FZNK3E](../../../../../backlog/P3/081KRMEXM0008QG0R003FZNK3E-backlog-graph-consistency-lint-parent-child-status-mismatch-2026-05-15.md) (mechanization sibling).
...
1. **Capture the finding** as a durable backlog row (substrate-or-it-didn't-happen) — done as 081KRMEXM0008QG0R000K25MXS
...
For 081KRMEXM0008QG0R000K25MXS:

- 081KRMEXM0008QG0R000X1PPGC = max free on `origin/main` (verified via `git ls-tree origin/main -- docs/backlog/`)
- 081KRMEXM0008QG0R00070X79J = in-flight via PR [#3520](https://github.com/Lucent-Financial-Group/Zeta/pull/3520) (Lior)
- 081KRMEXM0008QG0R003FZNK3E = on main (PR [#3523](https://github.com/Lucent-Financial-Group/Zeta/pull/3523), backlog-graph consistency lint)
- 081KRMEXM0008QG0R000K25MXS = **free** (verified via `gh pr list --search "081KRMEXM0008QG0R000K25MXS"` returned empty)
...
4. **Verify**: scan returned 20+ hits in live-nav surfaces; ID-allocation cross-checked 081KRMEXM0008QG0R000K25MXS.
5. **Shard**: this file.
6. **CronList**: sentinel live.
7. **Visibility**: PR #3540 (081KRMEXM0008QG0R000K25MXS) + this shard.
...
| **1807Z** | **Scale-up the dead-xref scan** | **20+ pattern instances → 081KRMEXM0008QG0R000K25MXS + #3540** |
