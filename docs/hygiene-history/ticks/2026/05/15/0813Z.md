...
This composes with the earlier 081KRHWGX0008QG0R0015EE8VE restraint pattern (after 2 unactioned bus advisories, no third republish). The same shape: when there's no new signal demanding action, the discipline is to NOT generate one for its own sake.
