...
| -------- | ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `B-0442` | `status: open` → `closed`; `closed_by_pr: 3458` added       | All 6 acceptance items already `[x]` on origin/main; PR #3458 description said _"After this merges, B-0442 itself can be marked `status: closed`"_                                                                |
