...
- `memory/external-ai-participant/kestrel/conversations/2026-05-21-aaron-kestrel-claudeai-zeta-id-v1-review-watermarks-tier-deferred-causality-orleans-otto-watching-verification-gap-hat-vs-role-group-chat-aaron-forwarded.md` — 25-section ~830-line Kestrel persona archive (verbatim Aaron-Kestrel multi-hour trajectory)
...
- `memory/external-ai-participant/kestrel/conversations/*` (this archive joins the Kestrel persona substrate cluster)
