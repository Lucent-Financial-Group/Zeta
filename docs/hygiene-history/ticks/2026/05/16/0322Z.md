...
The trailing space inside the backticks (intentional: meant to convey "literal `git ` prefix with trailing space") trips MD038. Markdownlint considers a code span with leading or trailing space inside the backticks malformed.
