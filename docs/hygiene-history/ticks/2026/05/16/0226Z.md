...
| backlog ID uniqueness | TBD | (081KRMEXM0008QG0R000ARAR7P renumber-sweep) | needs coordination |

**Three of four 0111Z-queue items now mechanically cleared.** The remaining `lint (backlog ID uniqueness)` requires semantic coordination (which file owns 081KRHWGX0008QG0R001XFRAHC after the renumber decision) — not a mechanical fix, so deferred to a coordination tick rather than grabbed unilaterally.
...
1. **081KRMEXM0008QG0R000ARAR7P renumber-sweep coordination** — pick one of the colliding 081KRHWGX0008QG0R001XFRAHC files to renumber; needs comment-on-row or backlog-discussion before unilateral pick.
