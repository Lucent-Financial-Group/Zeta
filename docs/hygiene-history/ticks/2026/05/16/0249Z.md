...
- Real bug classes caught:
  - Wrong-depth `..` (e.g., 1436Z's `../../../../backlog/P1/081KRFA460008QG0R00061SXRW-...` resolves to `docs/hygiene-history/backlog/...` instead of `docs/backlog/...`)
...
4. **081KRMEXM0008QG0R000ARAR7P renumber-sweep** (still pending, prior session's claim from 01:44Z still active)
