...
This session has been exactly that shape: 5 ticks × ~3-5 `gh` calls
+ Lior's continuous PR-archive work + peer Otto-Desktop's parallel
PR-creates = budget exhausted at ~5003/5000.
