...
- **All 6 PR #3614 review threads now closed** on `main`:
  ...
  5. ✅ `last_updated` schema discipline (081KRMEXM0008QG0R003YWZC21 + preemptive 081KRMEXM0008QG0R002YSPW1X) — PR #3639
...
1. **081KRMEXM0008QG0R003YWZC21 Step 1.5 decomposition** — file a new backlog row (B-NNNN) for the strength `θ : M(Ω) → Ω` and the `A`-lifting `Ã : Zeta → Zeta` research per the three resolution paths documented in the Step 1 research doc
