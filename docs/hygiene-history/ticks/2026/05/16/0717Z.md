...
- **Class 1 (Pure drift) closed**: B-0506, B-0530, B-0535, B-0494 (4; my lane) + B-0528, B-0045.1, B-0046.1, B-0049.1 (4; peer's lane) = **8 total**
...
> Fix-up: B-0159 removed from Class 1 examples — it is Class 4
...
> 154-161) to match B-0440 slice-status table location per
> Copilot P2 review.
