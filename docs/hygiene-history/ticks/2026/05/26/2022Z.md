...
> _"those N PRs are probably peer-Otto territory; not touching per the fighting-past-self-vs-peer-agent discipline"_ — IS the failure mode the rule exists to catch, dressed in the rule's own vocabulary.
