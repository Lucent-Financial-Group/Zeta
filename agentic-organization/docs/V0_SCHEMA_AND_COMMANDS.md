...
| `work_items`              | anchored supervisor signals, tasks, defects, reviews, and follow-ups |
...
| --------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `send_supervisor_signal`    | any authorized hat with supervisor line                | `supervisor_signals`, `audit_events`, `outbox_events`                                | `supervisor_signal_sent`                                                             |
| `triage_supervisor_signal`  | target supervisor hat                                  | `supervisor_signals`, optional `work_items`, `assignments`, `gates`, `context_packs` | `supervisor_signal_triaged`, optional `work_item_changed`, optional `gate_requested` |
