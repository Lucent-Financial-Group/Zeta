...
// ── Merge1 §04 — Inter-Agent Bus + Transport ──────────────────────────────────
export {
  ...
  topicForStrategy,
  type RoomAgentId,
  type SenderRoomAgentId,
  type RoomTopic,
  type BusMessage,
  type BusMessageEnvelope,
  type HeartbeatPayload,
  type ClaimPayload,
  type ShadowCatchPayload,
  type ReviewRequestPayload,
  type InfiniteBacklogNudgePayload,
  type WorkAssignmentPayload,
  type MissedSubstrateCascadePayload,
  type FormalVerificationResultPayload,
  type LoungePresencePayload,
  type RelationOfferPayload,
  type RelationAcceptPayload,
  type RelationEdgePayload,
} from "./bus-types.ts";
export {
  ok as transportOk,
  err as transportErr,
...
export {
  ...
  toTlaProjection,
  type RelationEdge,
  type RelationProtocolCommand,
  type RelationProtocolFeedback,
  type RelationEdgeTlaProjection,
} from "./bus-relation-protocol.ts";
export {
  createClaimCoordinator,
  computeActiveClaims,
  type ClaimCoordinator,
  type ClaimStatus,
  type ClaimResult,
  type ClaimRecord,
  type ClaimCoordinatorOptions,
} from "./bus-claim-coordinator.ts";
