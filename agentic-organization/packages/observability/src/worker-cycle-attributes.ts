...
export const WorkerCycleAttributeKey = {
  ...
  FirstFailureClaimId: "agentic.worker.failure.claim_id",
  FirstFailureCommandId: "agentic.worker.failure.command_id",
  FirstFailureCurrentClaimId: "agentic.worker.failure.current_claim_id",
  FirstFailureEventId: "agentic.worker.failure.event_id",
  FirstFailureLane: "agentic.worker.failure.first_lane",
  FirstFailureMessage: "agentic.worker.failure.first_message",
  FirstFailureOutboxEventId: "agentic.worker.failure.outbox_event_id",
  FirstFailurePublishedAt: "agentic.worker.failure.published_at",
  FirstFailureStage: "agentic.worker.failure.stage",
  FirstFailureTraceId: "agentic.worker.failure.trace_id",
} as const;
