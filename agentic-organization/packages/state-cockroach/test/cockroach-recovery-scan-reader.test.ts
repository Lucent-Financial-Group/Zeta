...
test("cockroach recovery reader uses bounded tenant-scoped lifecycle predicates", async () => {
  ...
  await reader.listStaleReactionPlanCandidates({
    organizationId: "org-lfg",
    nowIso: "2026-05-30T12:00:00.000Z",
    staleBeforeIso: "2026-05-30T11:50:00.000Z",
    limit: 25,
  });
  await reader.listStrandedScheduleCandidates({
    organizationId: "org-lfg",
    nowIso: "2026-05-30T12:00:00.000Z",
    endedBeforeIso: "2026-05-30T11:55:00.000Z",
    limit: 25,
  });
  await reader.listAbandonedRunBindingCandidates({
    organizationId: "org-lfg",
    nowMs: Date.parse("2026-05-30T12:00:00.000Z"),
    heartbeatBeforeIso: "2026-05-30T11:59:00.000Z",
    limit: 25,
  });
...
test("cockroach recovery reader maps lifecycle rows into scanner candidates", async () => {
  ...
  const stale = await reader.listStaleReactionPlanCandidates({
    organizationId: "org-lfg",
    nowIso: "2026-05-30T12:00:00.000Z",
    staleBeforeIso: "2026-05-30T11:50:00.000Z",
    limit: 25,
  });
  const stranded = await reader.listStrandedScheduleCandidates({
    organizationId: "org-lfg",
    nowIso: "2026-05-30T12:00:00.000Z",
    endedBeforeIso: "2026-05-30T11:55:00.000Z",
    limit: 25,
  });
  const abandoned = await reader.listAbandonedRunBindingCandidates({
    organizationId: "org-lfg",
    nowMs: Date.parse("2026-05-30T12:00:00.000Z"),
    heartbeatBeforeIso: "2026-05-30T11:59:00.000Z",
    limit: 25,
