/**
 * tools/workflow-engine/du-cluster.ts
 *
 ...
 *
 * Composes with:
 *   - tools/workflow-engine/types.ts (Action / State / TickCyclePattern substrate)
 *   - tools/workflow-engine/cli.ts (--list-du-cluster mode)
