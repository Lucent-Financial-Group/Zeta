...
describe("buildIndexDoc", () => {
  ...
  test("duplicate name@version → error", () => {
    const doc = buildIndexDoc({
      packages: [{ pkg: pkg("leaf", "1.0.0") }, { pkg: pkg("leaf", "1.0.0") }],
      baseUrl: "https://pkgs",
      sequence: 1,
      issuedAt,
      privatePem: kp.privatePem,
  ...
  test("packages sorted by name then version regardless of input order", () => {
    const doc = buildIndexDoc({
      packages: [{ pkg: pkg("zeta", "1.0.0") }, { pkg: pkg("alpha", "1.0.0") }],
      baseUrl: "https://pkgs",
      sequence: 1,
      issuedAt,
      privatePem: kp.privatePem,
