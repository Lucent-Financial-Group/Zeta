...
import { formatStatus, realEffects, renderAuthorizedKeys, resolveIdentities, resolveTrustSet, } from "./github-trust.js";
...
async function main() {
    if (mode !== "status" && mode !== "resolve") {
        console.error("usage: bun github-trust-cli.ts <status|resolve> [--user <gh-user> ...] [--allowlist <path>] [--gpg] [--dry-run] [--emit]");
        return 2;
    }
