...
- **No name attribution in code, docs, or skills — names
  ...
  - `docs/pr-discussions/**` — PR discussion archive (generated by `src/Core.TypeScript/pr-preservation/archive-pr.ts`; preserves author attribution as provenance metadata)
