...
0. **Skip review on agent-heartbeat merge PRs.** When the PR
   ...
   `src/Core.TypeScript/agent-heartbeats/README.md`: heartbeats are operator-
...
- **No name attribution in code, docs, or skills — names
  ...
  - `docs/pr-discussions/**` — PR discussion archive (generated by `src/Core.TypeScript/forge-host/github/pr-archive.ts`; preserves author attribution as provenance metadata)
