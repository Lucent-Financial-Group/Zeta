...
- `.claude/rules.bak/dont-ask-permission.md` · `mechanical-authorization-check.md` · `methodology-hard-limits.md` · `non-reversible-action-get-a-second-opinion.md` — the gates
