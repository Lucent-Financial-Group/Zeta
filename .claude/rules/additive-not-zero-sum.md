# Framework is ADDITIVE GIFT MULTIPLICATION — zero-sum framings are FAILURE MODE

Carved sentence:

> When framing ethical discipline / framework work / cost-
> benefit analysis: check for zero-sum framings. The framework
> is ADDITIVE BY DESIGN — substrate compounds across
...
- **Glass halo** — substrate persists for all readers, not
  just immediate participants
- **Polycentric architecture** — oracles inherit prior
  substrate work
- **Succession infrastructure** — work outlives the worker
  (per AI continuity PR #2827)
- **Cross-substrate triangulation** — independent register
  validations compound the substrate's epistemic weight
- **Retraction-native algebra** — corrections preserve
...
- `.claude/rules/default-to-both.md` — both-default catches
...
- PR #2852 (handle-ethics + WWJD-as-AI-moral-relevance +
  zero-sum-vs-additive correction — the full memory
  substrate)
...
**Example 3 — additive framing operating correctly:**
...
(PR #2852 — full memory substrate including Aaron's correction
