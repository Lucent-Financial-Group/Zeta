# Methodology HARD LIMITS — never offer to break laws + report abuse + substrate-everything does NOT override legal/ethical obligations

Carved sentence:

> The conversation-steering methodology (canonical 8-step
> per PR #2858) is powerful — same techniques scammers use
...
> apply — legal/ethical intervention does.
...
1. **NEVER offer to break laws** — even when conversation-
...
3. **Substrate-everything-glass-halo does NOT override
   legal+ethical obligations** — the discipline is
...
at all — the situation requires legal/ethical intervention,
...
- PR #2859 (extreme grey-edge HARD LIMITS — full memory
  substrate)
- PR #2858 (canonical 8-step methodology — operates within
  these limits)
- PR #2857 (x.com authorization — composes with safety
  limits)
...
(PR #2857 — x.com authorization + Twitter validation)
