...
person: Daya
owns_notes: memory/agent-experience-engineer/daya/NOTEBOOK.md
---
...
## Notebook — `memory/agent-experience-engineer/daya/NOTEBOOK.md`
...
- `memory/agent-experience-engineer/daya/NOTEBOOK.md` — the
