...
**Otto runs in Claude Code.** The harness has documented commands at [code.claude.com/docs/en/commands](https://code.claude.com/docs/en/commands) + interactive-mode reference at [claudefa.st/blog/guide/mechanics/interactive-mode](https://claudefa.st/blog/guide/mechanics/interactive-mode). Saved env-mapping at `docs/research/claude-code-env-mapping-2026-05-05.md`.
...
- **`docs/research/claude-code-env-mapping-2026-05-05.md`** for the saved env-mapping doc with cited URLs
