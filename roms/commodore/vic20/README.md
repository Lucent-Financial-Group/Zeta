# `roms/commodore/vic20/` — Commodore VIC-20 (1980)

C64 predecessor

## What to drop here

ROM / disc image / cassette dump files for **Commodore VIC-20**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `vic20` matches
