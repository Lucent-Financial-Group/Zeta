# `roms/commodore/c64/` — Commodore 64 (1982)

best-selling 8-bit home computer

## What to drop here

ROM / disc image / cassette dump files for **Commodore 64**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `c64` matches
