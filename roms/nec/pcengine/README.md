# `roms/nec/pcengine/` — NEC PC Engine / TurboGrafx-16 (1987)

8-bit CPU + 16-bit graphics; cartridge

## What to drop here

ROM / disc image / cassette dump files for **NEC PC Engine / TurboGrafx-16**.
Common extensions: see the emulator core's documentation.
The directory slug `pcengine` matches the EmulationStation /
