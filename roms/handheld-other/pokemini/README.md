# `roms/handheld-other/pokemini/` — Pokemon mini (2001)

tiny Nintendo handheld

## What to drop here

ROM / disc image / cassette dump files for **Pokemon mini**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `pokemini` matches
