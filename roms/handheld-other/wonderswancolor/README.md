# `roms/handheld-other/wonderswancolor/` — Bandai WonderSwan Color (2000)

handheld; colour

## What to drop here

ROM / disc image / cassette dump files for **Bandai WonderSwan Color**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `wonderswancolor` matches
the EmulationStation / libretro convention (under the
`handheld-other/` manufacturer branch, so the fully-qualified path
...
- `roms/handheld-other/README.md` — the branch folder listing this platform alongside siblings.
