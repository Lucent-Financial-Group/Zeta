# `roms/handheld-other/wonderswan/` — Bandai WonderSwan (1999)

handheld; monochrome

## What to drop here

ROM / disc image / cassette dump files for **Bandai WonderSwan**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `wonderswan` matches
