# `roms/computers/amstradcpc/` — Amstrad CPC (1984)

UK/EU 8-bit

## What to drop here

ROM / disc image / cassette dump files for **Amstrad CPC**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `amstradcpc` matches
