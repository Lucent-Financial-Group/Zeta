# `roms/computers/bbcmicro/` — BBC Micro (1981)

UK educational 8-bit

## What to drop here

ROM / disc image / cassette dump files for **BBC Micro**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `bbcmicro` matches
