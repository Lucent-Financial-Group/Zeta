# `roms/atari/5200/` — Atari 5200 (1982)

8-bit; analogue controllers

## What to drop here

ROM / disc image / cassette dump files for **Atari 5200**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `5200` matches
