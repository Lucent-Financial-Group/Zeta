# `roms/atari/7800/` — Atari 7800 (1986)

8-bit; 2600-compatible

## What to drop here

ROM / disc image / cassette dump files for **Atari 7800**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `7800` matches
