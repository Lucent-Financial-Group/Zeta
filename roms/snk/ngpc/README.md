# `roms/snk/ngpc/` — SNK Neo Geo Pocket Color (1999)

handheld; colour

## What to drop here

ROM / disc image / cassette dump files for **SNK Neo Geo Pocket Color**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `ngpc` matches
