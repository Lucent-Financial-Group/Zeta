# `roms/snk/neogeo/` — SNK Neo Geo AES / MVS (1990)

arcade-grade home console

## What to drop here

ROM / disc image / cassette dump files for **SNK Neo Geo AES / MVS**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `neogeo` matches
the EmulationStation / libretro convention (under the
`snk/` manufacturer branch, so the fully-qualified path
...
- `roms/snk/README.md` — the branch folder listing this platform alongside siblings.
