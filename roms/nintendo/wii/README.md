# `roms/nintendo/wii/` — Nintendo Wii (2006)

optical disc; motion controls

## What to drop here

ROM / disc image / cassette dump files for **Nintendo Wii**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `wii` matches
