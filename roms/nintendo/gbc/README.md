# `roms/nintendo/gbc/` — Game Boy Color (1998)

handheld; backward-compatible with GB

## What to drop here

ROM / disc image / cassette dump files for **Game Boy Color**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `gbc` matches
