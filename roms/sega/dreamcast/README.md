# `roms/sega/dreamcast/` — Sega Dreamcast (1998)

128-bit; last Sega console

## What to drop here

ROM / disc image / cassette dump files for **Sega Dreamcast**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `dreamcast` matches
