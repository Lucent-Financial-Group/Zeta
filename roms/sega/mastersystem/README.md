# `roms/sega/mastersystem/` — Sega Master System (1985)

8-bit; Mark III in Japan

## What to drop here

ROM / disc image / cassette dump files for **Sega Master System**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `mastersystem` matches
