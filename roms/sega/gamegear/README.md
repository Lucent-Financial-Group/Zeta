# `roms/sega/gamegear/` — Sega Game Gear (1990)

handheld

## What to drop here

ROM / disc image / cassette dump files for **Sega Game Gear**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `gamegear` matches
