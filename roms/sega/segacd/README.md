# `roms/sega/segacd/` — Sega CD / Mega-CD (1991)

CD add-on for Mega Drive

## What to drop here

ROM / disc image / cassette dump files for **Sega CD / Mega-CD**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `segacd` matches
