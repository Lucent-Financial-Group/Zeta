# `roms/sony/psx/` — Sony PlayStation (PS1) (1994)

optical disc; 32-bit

## What to drop here

ROM / disc image / cassette dump files for **Sony PlayStation (PS1)**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `psx` matches
