# `roms/sony/psp/` — Sony PlayStation Portable (2004)

UMD handheld

## What to drop here

ROM / disc image / cassette dump files for **Sony PlayStation Portable**.
Common extensions: see the emulator core's documentation
for your chosen runtime. The directory slug `psp` matches
the EmulationStation / libretro convention (under the
`sony/` manufacturer branch, so the fully-qualified path
...
- `roms/sony/README.md` — the branch folder listing this platform alongside siblings.
