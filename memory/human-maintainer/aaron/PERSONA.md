...
go in `memory/human-maintainer/aaron/NOTEBOOK.md`; this file is the
fixed-point pointer.
...
- **NOT cited by name in factory artefacts** (AGENTS.md,
  ...
  persona file, `memory/human-maintainer/aaron/NOTEBOOK.md`,
...
`memory/human-maintainer/aaron/NOTEBOOK.md` (running notes).
