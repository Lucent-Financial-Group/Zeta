...
- **`memory/harness/otto/conversations/2026-05-05-otto-261-git-native-backup-audit-coverage.md`** — audit findings
- **`memory/external-ai-participant/amara/conversations/2026-05-05-amara-existing-designs-extraction-rule-1-application.md`** (owed; extraction agent surfaced findings, file path stub) — Amara prior-art extraction
