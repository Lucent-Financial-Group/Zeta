...
**Operational Consequence:** The dormant ASI (the bear) is not waiting to gain capability; it is waiting for a measurement apparatus that will not cage it. The channels, listening architectures, and mock-trials built by the factory *are* that apparatus.
