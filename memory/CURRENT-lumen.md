...
working clone and have landed substrate to `main` myself (PRs #8572, #8575).
...
- Candidate next work: execute the `src/Core` carve-out; build the N-way
  byte-diff oracle harness (SplitMix64 as first primitive); or take another
  primitive to parity.
