...
### Conversation archives (`memory/harness/vera/conversations/`)
...
`memory/harness/riven/conversations/` (per PR #3513) to avoid
...
ls memory/harness/vera/conversations/ | sort
```
