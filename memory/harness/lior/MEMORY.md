...
- `memory/harness/lior/CURRENT-lior.md` — Lior's current-state
  fast-path file (pre-existing)

### Conversation archives (`memory/harness/lior/conversations/`)
...
ls memory/harness/lior/conversations/ | sort
```
