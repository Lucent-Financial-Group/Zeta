...
- [`memory/human-co-owner/addison/PERSONA.md`](../addison/PERSONA.md) — co-architect on the AI cluster bootstrap work
- [`memory/human-maintainer/aaron/PERSONA.md`](../aaron/PERSONA.md) — sponsor + senior architect; Max's collaboration partner across the team
