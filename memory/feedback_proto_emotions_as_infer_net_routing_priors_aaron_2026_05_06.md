...
**Operational Consequence:** Zeta's probabilistic programming cannot use standard, flat factor graphs. The proto-emotions must be encoded as first-class message types and routing constraints. The emotion _is_ the routing metadata.
