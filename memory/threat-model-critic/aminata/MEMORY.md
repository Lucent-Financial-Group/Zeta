# Aminata — Memory Index

One-line pointer to every notebook file in `memory/threat-model-critic/aminata/`.
Loaded on Aminata cold-start so subsequent reads go straight
