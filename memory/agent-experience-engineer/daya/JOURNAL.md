...
- memory/developer-experience-engineer/bodhi/NOTEBOOK.md:75-86 same-value arrows.
...
- `memory/<role>/<persona>/README.md:24-27` listed 2 notebooks; disk
  had 6.
...
**Evidence anchor:** memory/agent-experience-engineer/daya/NOTEBOOK.md round-34
