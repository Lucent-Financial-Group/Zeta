...
- [`memory/max/PERSONA.md`](../max/PERSONA.md) — Max's persona (co-contributor on the AI cluster work)
- [`memory/aaron/PERSONA.md`](../aaron/PERSONA.md) — Aaron's persona (Addison's father + project sponsor)
