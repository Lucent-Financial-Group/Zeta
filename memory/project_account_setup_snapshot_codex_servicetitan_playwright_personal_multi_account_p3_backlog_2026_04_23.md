...
_"FYI don't get confused i switchd the codex CLI to service
...
_"for some of the personal accounts i can't get api keys
...
titan but might be for lfg thats my company lol."_
...
this is the _intentional_ current configuration, because:
...
- Multi-account-as-a-feature is explicitly **not today's
  ...
  _"we don't need to worry about it right now"_.
...
- **Design** multi-account access (Phase 1 of PR #230) —
  ...
  _"its fine to design and all that now"_ + _"you can pick
  the timing"_. Phase 1 lands as a research doc / ADR; NOT
  implementation.
...
- **Implementing** multi-account access before Aaron's
  ...
  Otto-76: _"i just would want to review a design first, i
  want to validate that one for securty consers myself"_.
