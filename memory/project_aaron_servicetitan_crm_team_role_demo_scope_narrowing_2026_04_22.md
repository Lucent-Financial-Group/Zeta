...
_"i work for the CRM team at ServiceTitan if you want to use that infomation to help inform your demo choices"_
...
- NOT exclusion of field-service concerns from Zeta scope generally — just a narrowing of the _demo_ target.
