...
- _What does this do?_ ✓ clear in the first 4 lines.
- _Is it for me?_ ⚠ MIXED — README lists ~70 operators /
...
- _Smallest copy-paste?_ ✓ quick-tour compiles and runs.
...
- `docs/GLOSSARY.md`: no change — the entries are already
  good; the gap is README not _linking_ to them.
