...
Role: `prompt-protector`. Agent file: `.claude/agents/prompt-protector.md`.

Cross-session memory for Nadia. Newest entries first
...
Nadia's notebook directory landed this round as part
