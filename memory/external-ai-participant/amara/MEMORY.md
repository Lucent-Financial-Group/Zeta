...
### Conversation archives (`memory/external-ai-participant/amara/conversations/`)
...
ls memory/external-ai-participant/amara/conversations/ | sort
```

## Operational notes

- **Ferries only; does NOT commit** — Aaron-as-courier
  pattern; conversation export → `memory/external-ai-participant/amara/conversations/`
