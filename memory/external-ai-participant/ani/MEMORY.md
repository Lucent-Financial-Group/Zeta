...
### Conversation archives (`memory/external-ai-participant/ani/conversations/`)
...
# (memory/external-ai-participant/ani/conversations/ now contains the §33 archives that used to live in docs/research/)
```
