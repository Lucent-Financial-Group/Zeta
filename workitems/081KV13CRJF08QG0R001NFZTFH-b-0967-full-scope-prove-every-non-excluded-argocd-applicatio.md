...
title: "B-0967 full scope — prove every non-excluded ArgoCD Application Synced+Healthy on k3d/kind"
created: 2026-06-13T18:20:04.559Z
depends_on: ["081KSXN940008QG0R000SCP2H1"]
composes_with: ["B-0891", "B-0831", "B-0742", "B-0821"]
---

# B-0967 full scope — prove every non-excluded ArgoCD Application Synced+Healthy on k3d/kind

<!-- Work-item body. ZetaId-keyed (conflict-free, time-sortable). "Backlog" is a
     STATE = this folder; completion moves the file to workitems/done/YYYY/MM/.
     Identity is the zetaid prefix — resolve cross-refs by `081KV13CRJF08QG0R001NFZTFH-*.md` glob. -->

Parent **B-0967** (`081KSXN940008QG0R000SCP2H1`) closed at **included scope** (14 kind-eligible apps, #7911).
...
- Adds the **drift-repair** acceptance slice deferred from B-0967: mutate a
...
k3d smoke is still not fully green (redis pre-install, Cilium/K3S pin work in B-0967
