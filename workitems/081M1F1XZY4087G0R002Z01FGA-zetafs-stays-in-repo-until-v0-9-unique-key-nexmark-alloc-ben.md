...
one-liner after packages publish. Factory rust is mise 1.98.0 via
`tools/setup/install.sh` — do not rustup-install a second compiler to
build Feldera.

## This change

- Pin rust 1.87.0 -> 1.98.0 (latest stable 2026-08-20) in `.mise.toml`
