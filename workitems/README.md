# `workitems/` — ZetaId-keyed work-items (B-0956)
...
create items with zero coordination and zero collision; the B-0954 agent-bus G-Set
...
- **`<zetaid>`** — canonical Crockford base32 (B-0682): filename-safe + **sort-preserving**
...
See `docs/backlog/P1/B-0956-*.md` + the design memo
