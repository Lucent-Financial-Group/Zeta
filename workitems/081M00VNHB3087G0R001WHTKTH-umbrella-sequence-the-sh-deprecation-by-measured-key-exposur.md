...
| tier                         | n   | scripts                                                                                                            |
| ---------------------------- | --- | ------------------------------------------------------------------------------------------------------------------ |
| T4 root-key, confined        | 1   | `persona-keys/keyring.sh`                                                                                          |
| T3 credential, **broadcast** | 3   | `secret-clip.sh` · `op-token-setup.sh` · `common/mise.sh`                                                          |
| T2 credential, on-disk       | 1   | `usb-nixos-installer/zeta-install.sh`                                                                              |
...
- **`common/mise.sh:149` moved from "last, or never" to T3.**
