...
export const APPLIED_BUT_UNASSERTED_REASONS: ReadonlyMap<string, string> = new Map([
  ...
  [
    ...
    "THREE independent blockers, established 2026-08-21 by rendering hindsight 0.3.0 against this Application's own valuesObject; any ONE of them defers it. " +
      ...
      "THE ARITHMETIC THAT SAYS `SYMPTOM`, and it is why the deferral does not lift by shrinking this app: the dev lane APPLIES 37 Applications totalling 4231m at the rung the tree ships, against a 2500m budget (4000m runner less 1500m reserved). Hindsight is 1000m of that. Take hindsight to ZERO and the lane is still 3231m -- over by 731m. Take hindsight alone to its `dev` rung (400m) and the lane is 3631m, over by 1131m. Take the WHOLE lane to `dev` and it is 1906m, which fits with 594m to spare. So the only cut that closes this is lane-wide, and lowering hindsight's three numbers on their own converts a Pending pod into a different Pending pod. mimir, at 1610m, is the larger single reservation. " +
