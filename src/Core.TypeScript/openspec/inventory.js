...
// ── Gap analysis ─────────────────────────────────────────────────────
function buildGapReport(specs, modules, options = {}) {
    ...
    const mappedArtifactSet = new Set();
    const missingArtifactSet = new Set();
...
function evaluateInventoryGate(report, options = {}) {
    const failures = [];
...
// ── CLI ──────────────────────────────────────────────────────────────
export { scanSpecs, scanModules, buildGapReport, evaluateInventoryGate, parseCliArgs, CAPABILITY_MODULE_MAP, CAPABILITY_ARTIFACT_MAP, EXCLUDED_MODULES, };
