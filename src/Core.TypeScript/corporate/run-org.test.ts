...
describe("argument parsing", () => {
  test("defaults are all off", () => {
    ...
    expect(parseArgs([])).toEqual({
      ...
      workAgent: undefined, workModel: undefined, until: undefined, windowStart: undefined, windowTarget: undefined, workAgentArgs: [], workVerify: undefined, workVerifyArgs: [],
    });
