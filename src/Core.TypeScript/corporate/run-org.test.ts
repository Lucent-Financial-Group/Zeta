...
describe("argument parsing", () => {
  test("defaults are all off", () => {
    ...
    expect(parseArgs([])).toEqual({
      ...
      describeCmd: undefined, describeArgs: [],
      ticketComposeCmd: undefined, ticketComposeArgs: [], ticketPostCmd: undefined, ticketPostArgs: [], followUpCmd: undefined, followUpArgs: [], feedbackDir: undefined, feedbackCmd: undefined, feedbackArgs: [], answerCmd: undefined, answerArgs: [], supplyTarget: undefined, parallel: undefined, followUpAtOnce: undefined, verifyAtOnce: undefined, planRoundCmd: undefined, planRoundArgs: [],
