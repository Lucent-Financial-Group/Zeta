 ...
 * measurability (081KQ3HBZ0008QG0R000K3NSX8 §Why P2). F3 strength varies sharply across these:
 *
...
export interface EsotericResonanceCatalog {
  ...
  readonly origin: "081KQ3HBZ0008QG0R000K3NSX8";
...
const SEED_CATALOG: EsotericResonanceCatalog = {
  ...
  entries: [
    ...
    // ── EST-002: Lurianic tzimtzum ──────────────────────────────────────────
    {
      ...
      counterexampleAttempts: [],
      notes:
        "The backlog item (081KQ3HBZ0008QG0R000K3NSX8 §Kabbalah) identifies tzimtzum as a potentially strong F2 candidate. " +
    ...
    // ── EST-003: Jung's coniunctio ──────────────────────────────────────────
    {
      ...
      counterexampleAttempts: [],
      notes:
        "The backlog item (081KQ3HBZ0008QG0R000K3NSX8 §Jung) identifies Jungian alchemy as 'the cleanest cross-disciplinary " +
