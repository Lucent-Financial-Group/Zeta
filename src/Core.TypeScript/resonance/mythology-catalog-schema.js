...
const SEED_CATALOG = {
    ...
    entries: [
        // ── MYT-001: Heimdallr ──────────────────────────────────────────────────
        {
            ...
            tradition: "norse",
            primarySources: "Völuspá (Poetic Edda), Grímnismál, Rígsþula, Gylfaginning + Skáldskaparmál (Snorri's Prose Edda)",
            mechanic: "Heimdallr guards Bifröst, the rainbow-bridge connecting Ásgarðr (realm of the Æsir) " +
            ...
            filters: {
                ...
                rationale: {
                    f1: "Factory observability/gate-keeping patterns and the endpoint-abstraction were " +
                    ...
                    f2: "F2 is partial rather than full pass: the bridge-guardian-as-the-bridge shape " +
                    ...
                    f3: "F3 passes within Norse tradition: Heimdallr is load-bearing in Eddic theology " +
            ...
            notes: "This is collection-index instance #12 candidate, first documented from Aaron's " +
        ...
        // ── MYT-002: Hermes/Mercury ─────────────────────────────────────────────
        {
            ...
            primarySources: "Homeric Hymn to Hermes, Iliad (Book 24, Priam's ransom), Odyssey (escort of suitors' souls), " +
                "Hesiod Theogony, Virgil Aeneid (Mercury's messenger role), Orphic Hymns",
            mechanic: "Hermes/Mercury is the only Olympian who traverses all three realms freely: " +
            ...
            factoryOperator: {
                ...
                source: "memory/feedback_peer_call_infrastructure_grok_codex_gemini_amara_ani_already_wired_for_cross_harness_multi_agent_reviews_otto_early_red_team_until_zeta_infernet_bp_ep_aaron_2026_05_05.md",
            },
            structuralType: "unification",
            subStructure: "bridge-figure",
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f1: "The peer-call infrastructure was reached for multi-harness tool-isolation and " +
                    ...
                    f2: "F2 is partial: the realm-crossing function maps recognizably to cross-boundary " +
                    ...
                    f3: "F3 passes strongly across two independent Indo-European tradition branches: " +
            ...
            status: "candidate",
            counterexampleAttempts: [],
            notes: "The overlap with the occult track (081KQ3HBZ0008QG0R000K3NSX8) via Hermes Trismegistus (Greek Hermes + " +
        ...
        // ── MYT-003: Loki (anti-instance) ──────────────────────────────────────
        {
            ...
            tradition: "norse",
            primarySources: "Völuspá, Lokasenna, Þrymskviða, Gylfaginning (Snorri's Prose Edda); " +
                "Saxo Grammaticus Gesta Danorum (parallel tradition)",
            mechanic: "Loki crosses all realm-boundaries repeatedly throughout Norse mythology — but as " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f1: "The factory's boundary-maintenance patterns (endpoint isolation, gate-keeping, " +
                    ...
                    f2: "F2 fails for the bridge-figure claim: Loki's boundary-crossings are structurally " +
                    ...
                    f3: "F3 passes: Loki is load-bearing in Norse mythology across Völuspá (cosmic agent " +
            ...
            status: "failed",
            counterexampleAttempts: [],
            notes: "Recording Loki as a failed anti-instance is required by the filter-failure-rate " +
