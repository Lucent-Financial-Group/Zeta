...
function validateEntry(entry) {
    ...
    if (entry.status === "confirmed" || entry.status === "load-bearing") {
        const anyDeferred = entry.filters.f1_engineering_first === "deferred" ||
...
export function summarizeCatalog(catalog) {
    ...
    for (const entry of entries) {
        ...
        if (entry.status === "confirmed" || entry.status === "load-bearing")
            ...
            failed++;
        if (entry.filters.f1_engineering_first === "fail")
            filterFailureCounts.f1++;
        if (entry.filters.f2_structural === "fail")
            filterFailureCounts.f2++;
        if (entry.filters.f3_tradition_name === "fail")
            filterFailureCounts.f3++;
        if (entry.filters.f1_engineering_first === "partial")
            filterPartialCounts.f1++;
        if (entry.filters.f2_structural === "partial")
            filterPartialCounts.f2++;
        if (entry.filters.f3_tradition_name === "partial")
            filterPartialCounts.f3++;
    }
    return {
    ...
    entries: [
        {
            ...
            filters: {
                ...
                rationale: {
                    f2: "Regeneration is not mere reincarnation (soul migrating to different body) " +
                    ...
                    f3: "F3 passes maximally: 60+ year BBC canon, academic monographs, " +
        ...
        },
        {
            ...
            year: "2020",
            mechanic: "The Devs quantum computer projects the complete state of the past (and future) " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f2: "The Devs device has the read-only constraint encoded narratively: Forest " +
                    ...
                    f3: "Alex Garland is a load-bearing auteur (Ex Machina, Annihilation, 28 Days Later); " +
            ...
            counterexampleAttempts: [
                {
                    ...
                    attempt: "Reviewing plot: the device can project future states, which might seem " +
            ...
            notes: "The Chronovisor (Ernetti 1972 claim) is a separate entry MR-004 with weaker F3; " +
        ...
        },
        {
            ...
            year: "1986–present",
            mechanic: "The official Hyrule Historia (2011) establishes that Ocarina of Time branches " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f2: "The three timelines do not collapse: all three are simultaneously canonical " +
                    ...
                    f3: "F3 maximal: 40-year franchise, Hyrule Historia is an official first-party " +
            ...
            counterexampleAttempts: [
                {
                    date: "2026-05-10",
                    mechanicTested: "Do the three timelines eventually collapse into one (which would invalidate " +
                        "the retractibly-coexisting-histories claim)?",
                    attempt: "Nintendo has not published any subsequent lore that unifies the three timelines " +
            ...
            sourceMemory: "memory/feedback_pop_culture_media_is_operational_resonance_corpus_multi_medium.md",
            notes: "The Triforce three-in-one instantiation is a separate sub-claim from the timeline-fork; " +
        ...
        },
        {
            ...
            creator: "Mel Brooks",
            year: "1987",
            mechanic: "The characters pause the VHS of the film they are currently inside to find their " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f2: "The structural match is the NON-PARADOX of the self-observation: Lone Star " +
                    ...
                    f3: "Mel Brooks' oeuvre is load-bearing in the American comedy canon; Spaceballs " +
            ...
            counterexampleAttempts: [
                {
                    date: "2026-05-10",
                    mechanicTested: "Is this just a comedic gag (4th-wall break for laughs) rather than a structural " +
                        "self-reference? If it's just meta-humor, F2 fails.",
                    attempt: "The scene requires the audience to accept that the characters ARE inside the " +
            ...
            sourceMemory: "memory/feedback_pop_culture_media_is_operational_resonance_corpus_multi_medium.md",
            notes: "Comedy-as-substrate-probe principle (Monty Python register) applies here: Brooks " +
        ...
        // ── B-0054.2: Video-game priority tier (Aaron-marked higher-than-rest) ─────
        {
            ...
            year: "2009",
            mechanic: "Eddie Riggs is transported to a world physically constituted from heavy-metal " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f2: "F2 is partial rather than full pass: the factory's tradition-names-as-substrate " +
                    ...
                    f3: "F3 strong: Tim Schafer is a load-bearing auteur (Monkey Island, Grim Fandango, " +
        ...
        },
        {
            ...
            year: "1994",
            mechanic: "FFVI splits into two Acts around Kefka's destruction of the Warring Triad: " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f2: "F2 passes on two distinct structural grounds: (1) the WoB/WoR transition enacts " +
                    ...
                    f3: "F3 maximal: FFVI is widely considered the peak of 16-bit RPG design; " +
            ...
            counterexampleAttempts: [
                {
                    date: "2026-05-10",
                    mechanicTested: "Does the World of Ruin represent a reversible change (could the WoB be restored), " +
                        "which would invalidate the irreversibility claim?",
                    attempt: "FFVI's narrative explicitly forecloses WoB restoration: the Warring Triad are " +
                ...
                {
                    date: "2026-05-10",
                    mechanicTested: "Is WoB/WoR a 'before/after' temporal sequence rather than a paired-dual " +
                        "(which would be structural type 'instantiation', not 'paired-dual')?",
                    attempt: "The two world-states are not separable: the WoR's geography, characters, and " +
        ...
        },
        {
            ...
            year: "1997",
            mechanic: "FFVII's Lifestream is the planet's fundamental substrate: all life emerges from it " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f2: "F2 passes on three distinct operator-shape grounds: (1) Lifestream as " +
                    ...
                    f3: "F3 maximal: FFVII is the most commercially successful JRPG in history; " +
            ...
            counterexampleAttempts: [
                {
                    date: "2026-05-10",
                    mechanicTested: "Is Mako drain actually reversible (Shinra could stop extracting and the " +
                        "planet would recover), invalidating the retraction-cost-accumulation claim?",
                    attempt: "FFVII's plot makes restoration impossible within story time: the planet is " +
                ...
                {
                    date: "2026-05-10",
                    mechanicTested: "Are Cloud's false memories a character-writing choice rather than a structural " +
                        "View<T>@clock corruption — if so, F2 fails for that sub-claim.",
                    attempt: "Hojo's experiment deliberately injected Zack's memories into Cloud's substrate " +
