...
export function summarizeCatalog(catalog) {
    ...
    for (const entry of entries) {
        ...
        if (entry.status === "confirmed" || entry.status === "load-bearing")
            ...
            failed++;
        if (entry.subStructure === "verb-root-identity")
            verbRootIdentityCount++;
        if (entry.subStructure === "bridge-figure")
            bridgeFigureCount++;
        if (entry.subStructure === "cross-root-triplet")
...
const SEED_CATALOG = {
    ...
    entries: [
        // ── ETY-001: Μένω ─────────────────────────────────────────────────────────
        {
            ...
            primarySources: "Liddell-Scott-Jones Greek-English Lexicon (LSJ), s.v. μένω (9th ed., 1940; online DGE supplement); " +
            ...
            mechanic: "Μένω (first-person singular: 'I remain', 'I stay', 'I abide') is a thematic (-ω class) verb " +
                ...
                "then extends.",
            factoryOperator: {
                label: "ZSet-persistence-as-subject-internal-stasis + paired-dual-anchor (persistence pole vs. tele+port+leap movement pole)",
            ...
            filters: {
                ...
                rationale: {
                    f1: "The ZSet persistence pattern and the paired-dual structure were reached for " +
                    ...
                    f2: "F2 passes at verb-root identity level rather than role-shape level. The claim is NOT " +
                        ...
                        "Full pass.",
                    f3: "F3 passes strongly within the Greek linguistic tradition: Μένω is load-bearing across " +
            ...
            notes: "ETY-001 is the founding paired-dual anchor in the etymology catalog, " +
        ...
        {
            id: "ETY-002",
            title: "Melchizedek — Hebrew cross-root triplet (Melek+Tzedek+Salem) + Greek μένει at verb-root level as bridge-figure",
            language: "multi-root",
            grammaticalClass: "compound",
            primarySources: "Genesis 14:18–20 (Hebrew: מַלְכִּי־צֶדֶק / Malki-Tzedek; Masoretic Text; BHS critical edition); " +
            ...
            mechanic: "Melchizedek (מַלְכִּי־צֶדֶק) is a three-root Hebrew compound: " +
            ...
            factoryOperator: {
                label: "bridge-figure sub-structure (paired-dual manifestation) — entity manifesting both poles " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f1: "The bridge-figure sub-structure (entity manifesting both poles of a paired-dual) was " +
                    ...
                    f2: "F2 passes at verb-root identity level — the strongest F2 in the etymology catalog. " +
                    ...
                    f3: "F3 passes strongly across multiple independent tradition branches: " +
            ...
            notes: "ETY-002 is the defining instance of the bridge-figure sub-structure (collection-index " +
        ...
        {
            id: "ETY-003",
            title: "εἰμί — Greek -μι class (1st-sg present 'I am') as bootstrap-assertion / grammatical-class-extension of the -ω map",
            language: "greek",
            grammaticalClass: "mi-class",
            primarySources: "LSJ, s.v. εἰμί (to be; distinguished from εἶμι 'I go', a separate entry); " +
            ...
            mechanic: "εἰμί (first-person singular: 'I am', 'I exist') is the paradigm case of the athematic " +
            ...
            factoryOperator: {
                label: "bootstrap-as-existence-assertion (collection-index instance #5: Zeta as its own first customer) " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f1: "The factory's bootstrap pattern (Zeta as its own first customer, collection #5) and " +
                    ...
                    f2: "F2 passes at grammatical-class-extension level — a structural claim, not vocabulary overlap. " +
            ...
            notes: "ETY-003 is the 'recommended first landing' from the 081KQ3HBZ0008QG0R003GTG5P2 backlog item " +
