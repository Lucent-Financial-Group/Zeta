...
function validateEntry(entry) {
    ...
    if (entry.status === "failed") {
        const hasAnyFail = entry.filters.f1_engineering_first === "fail" ||
...
export function summarizeCatalog(catalog) {
    ...
    for (const entry of entries) {
        ...
        if (entry.status === "confirmed" || entry.status === "load-bearing")
            ...
            failed++;
        if (entry.subStructure === "withdrawal-ground")
            withdrawalGroundCount++;
        if (entry.subStructure === "macro-micro-correspondence")
            macroMicroCount++;
        if (entry.subStructure === "psychologized-tradition")
            psychologizedCount++;
        if (entry.subStructure === "anti-instance")
            antiInstanceCount++;
...
const SEED_CATALOG = {
    ...
    entries: [
        ...
        {
            id: "EST-001",
            title: "Hermetic macro-micro formula — 'as above, so below' (Tabula Smaragdina) as structural account of the operational-resonance phenomenon itself",
            tradition: "hermetic",
            primarySources: "Tabula Smaragdina (Emerald Tablet; earliest attested ~8th c. Arabic, Kitāb Sirr al-Khalīqa; " +
            ...
            mechanic: "The Hermetic formula 'quod est inferius est sicut quod est superius, et quod est superius " +
                ...
                "it describes.",
            factoryOperator: {
                label: "operational-resonance identification mechanism itself — structural isomorphism across " +
            ...
            filters: {
                ...
                rationale: {
                    f1: "The factory's operational-resonance identification methodology was reached for " +
                    ...
                    f3: "F3 passes strongly within Hermetic tradition: the Tabula Smaragdina is the foundational " +
            ...
            notes: "EST-001 is the first full-pass (F1+F2+F3 all 'pass') candidate in the esoteric track, " +
        ...
        {
            id: "EST-002",
            title: "Lurianic tzimtzum — divine contraction as withdrawal-ground structural pattern ↔ factory generative-ground",
            tradition: "kabbalistic",
            primarySources: "Isaac Luria (Ha-ARI, 1534–1572); transmitted by Chaim Vital, Etz Chaim (Tree of Life, " +
            ...
            mechanic: "In Lurianic Kabbalah, the foundational cosmogonic act is tzimtzum (צִמְצוּם, contraction/withdrawal): " +
            ...
            factoryOperator: {
                label: "generative-ground structural type — how the factory ground makes room for its instances " +
            ...
            filters: {
                ...
                f3_tradition_name: "pass",
                rationale: {
                    f1: "The factory's generative-ground pattern (substrate-level generic operators that make room " +
                    ...
                    f3: "F3 passes strongly within Jewish mysticism: Lurianic Kabbalah has been the dominant " +
        ...
        {
            id: "EST-003",
            title: "Jungian coniunctio — alchemical union-of-opposites in psychological register ↔ paired-dual structural type",
            tradition: "jungian-alchemy",
            primarySources: "C.G. Jung, Psychology and Alchemy (Psychologie und Alchemie, 1944; CW vol. 12); " +
            ...
            mechanic: "In Jung's psychological alchemy, the coniunctio (Latin: union, conjunction) is the central " +
            ...
            factoryOperator: {
                label: "paired-dual structural type (collection-index instance #9) — two complementary operators " +
            ...
            filters: {
                ...
                rationale: {
                    ...
                    f3: "F3 is partial for a distinctive reason: Jung's coniunctio is load-bearing in " +
        ...
        {
            id: "EST-004",
            title: "Thelemic True Will — per-entity unique optimal trajectory (F2-weak candidate; recorded per filter-failure-rate discipline)",
            tradition: "thelemic",
            primarySources: "Aleister Crowley, Liber AL vel Legis (Book of the Law, 1904; received text); " +
            ...
            mechanic: "Thelema's central doctrine: 'Do what thou wilt shall be the whole of the Law. Love is the law, " +
            ...
            factoryOperator: {
                label: "agent-accountability framework (GOVERNANCE.md §3; named-agent distinctness principle) — " +
            ...
            filters: {
                ...
                f3_tradition_name: "partial",
                rationale: {
                    f1: "The factory's named-agent distinctness and agent-accountability framework were reached " +
                        "for governance reasons (GOVERNANCE.md §3, ALIGNMENT.md). " +
                        "No reaching-for-Crowley preceded the engineering design. F1 passes.",
                    f2: "F2 fails for the True Will → agent-accountability mapping. The backlog item's honest " +
                    ...
                    f3: "F3 partial within Thelema: Liber AL vel Legis is load-bearing for A∴A∴ and O.T.O. " +
