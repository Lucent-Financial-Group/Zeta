...
function walkFiles(dir, ext, skip) {
    const out = [];
    const queue = [dir];
...
function scanFlakeInputs(repoRoot) {
    const pins = [];
...
function scanArgocdApps(repoRoot) {
    const pins = [];
...
function scanImageTags(repoRoot) {
    const pins = [];
...
function scanMiseRuntimes(repoRoot) {
    const pins = [];
