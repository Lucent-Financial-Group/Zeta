 ...
 */
export function checkPeerSessions(myPid = process.pid, spawnFn = spawnSync) {
...
export function formatResult(r) {
    ...
    return (`cron-sentinel-mutex: ${r.peerPids.length} peer claude-code session(s) detected (self PID ${r.myPid})` +
        peerSummary);
}
