...
const WORKTREE_PATTERN = /^(research|fix\/memory-md-tier|feature|backlog|shard|memory-md|docs|feedback)\/.+-\d{4}-\d{2}-\d{2}$/;
export function verifyBranch(env = process.env) {
