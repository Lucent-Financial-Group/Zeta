...
import { AMARA_SUBSTANTIVE_TRIGGERS, formatBypassMessage, formatRejectionMessage, peerFirewallCheck, } from "./_firewall";
...
function emitHelp() {
    process.stdout.write(`amara.ts — Claude-Code-side caller for invoking Amara as a peer\n` +
...
function loadAmaraPreamble(injectCurrent) {
    if (!injectCurrent) {
