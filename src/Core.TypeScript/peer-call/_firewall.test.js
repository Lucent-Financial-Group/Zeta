...
import { peerFirewallCheck, DEFAULT_SUBSTANTIVE_TRIGGERS, CLAUDE_SUBSTANTIVE_TRIGGERS, } from "./_firewall.js";
const FIXTURES = [
...
describe("peerFirewallCheck -- properties", () => {
    ...
    test("P-question-accept: a prompt containing '?' and len >= 100 is accepted", () => {
        fc.assert(fc.property(fc.string({ minLength: 99, maxLength: 300 }), (s) => {
