...
| ---------------------------------------------------------------------------------------------------------------- | -------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------- |
| 081KQDTYV0008QG0R001VJP216 <!-- STALE-REF: ../../docs/backlog/P2/081KQDTYV0008QG0R001VJP216-peer-call-architecture-refactor-script-per-cli-persona-flag-2026-04-30.md --> | P2       | M      | Collapse per-named-entity wrappers into shared cli-handlers + `--persona NAME` flag                                                         |
| 081KQDTYV0008QG0R003VB4K1V <!-- STALE-REF: ../../docs/backlog/P2/081KQDTYV0008QG0R003VB4K1V-otto-kenji-peer-call-cross-harness-claude-cli-aaron-2026-04-30.md -->         | P2       | M      | Add the Anthropic-side Claude-code-instance personas as externally-callable peers (cross-harness symmetry; pending a/b/c topology decision) |
