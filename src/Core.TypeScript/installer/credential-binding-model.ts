 ...
 * Research: `tpmSeal`. `uefiKeyfile` ESP persist planner landed
 * (`uefi-keyfile-esp.ts`). `usbISerial` sysfs probe landed
 * (`usb-iserial-probe.ts`). Neither is the default persist path.
 */
