...
import { SchemaAwareJoin, deltasCommute } from "./schema-rx-join";
import { schemaZSet, FS_METADATA_SCHEMA_V1 } from "./schema-zset";
...
const fileInfoView = {
    ...
    compute(schema, _data) {
        ...
        return fileInfoView.dependsOn.filter(f => active.some((a) => a.name === f));
    },
};
