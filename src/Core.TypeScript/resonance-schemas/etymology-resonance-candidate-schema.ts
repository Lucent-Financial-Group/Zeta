// Smallest safe slice of 081KQ3HBZ0008QG0R003GTG5P2: pure-TS etymology-resonance-candidate schema + 1 bounded seed (εἰμί — recommended first landing per backlog etymology thread)
...
// One bounded step: type + seed + stub. Retractible at lexical level. Three-filter fields (F1-F2-F3) included per epistemology thread in 081KQ3HBZ0008QG0R003GTG5P2.
...
export const eimiSeed: EtymologyResonanceCandidate = {
  ...
  verdict: 'candidate',
  notes: 'Completes movement/persistence/being trio per 081KQ3HBZ0008QG0R003GTG5P2 open candidates (a). F2 grammatical-subject-position encoding is structural (not superficial or decorative). Passes honest three-filter calibration. Retractible reference per ALIGNMENT.md.'
};

export function validateEtymologyCandidate(c: EtymologyResonanceCandidate): boolean {
  // stub validator — real impl would cross-check against ALIGNMENT.md retractibility + 081KQ3HBZ0008QG0R002S674CG safety log + GLOSSARY.md kernel-propagation
