...
export async function main() {
    ...
    if (alreadyExists) {
        ...
        const created = (await ghApi("POST", `repos/${OWNER}/${REPO}/rulesets`, reviewPolicyPayload));
        console.log(`  Created ruleset "${created.name}" (id: ${created.id})`);
    }
    console.log();
    console.log(`Step 2: Updating Default ruleset (${DEFAULT_RULESET_ID}) — removing pull_request + copilot_code_review...`);
