...
import { B0891_RETENTION_USB_SERIAL_MARKERS, INITIAL_INSTALL_SERIAL_MARKERS, INSTALLED_OS_RETENTION_SERIAL_MARKERS, RETENTION_ABSENT_TERMINAL_MARKERS, RETENTION_FAILURE_SERIAL_MARKERS, FIRST_SESSION_SERIAL_MARKERS, serialFirstBootInProgress, } from "./serial-markers";
...
export { B0891_RETENTION_USB_SERIAL_MARKERS, INITIAL_INSTALL_SERIAL_MARKERS, INSTALLED_OS_RETENTION_SERIAL_MARKERS as RETENTION_SERIAL_MARKERS, RETENTION_ABSENT_TERMINAL_MARKERS, RETENTION_FAILURE_SERIAL_MARKERS, } from "./serial-markers";
...
export function createSpawnSyncQcow2RetentionExecutor(options = {}) {
    ...
    const readSerialOutput = options.readSerialOutput ?? ((serialLogPath) => readFileSync(serialLogPath, "utf8"));
    return {
