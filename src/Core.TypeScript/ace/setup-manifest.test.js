...
import { parseSetupManifest, parseMechanismManifest, pointerFromSetupManifest, pointerFromMechanismManifest } from "./setup-manifest.js";
...
`);
    ...
    test("parseMechanismManifest splits tokens and attrs", () => {
        const entries = parseMechanismManifest("tools/tla/x.jar https://example.com/x.jar requires=java role=formal-verifier\n");
