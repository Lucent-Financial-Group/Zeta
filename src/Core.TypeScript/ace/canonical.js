...
import { canonicalJson } from "../dynamic-value/json.js";
...
function assertWellFormed(s, role) {
 ...
 */
export function toTagged(value) {
    if (value === null)
        return { t: "null" };
    switch (typeof value) {
        case "boolean":
        ...
        case "object": {
            ...
            for (const k of Object.keys(obj).sort()) {
                const v = obj[k];
                if (v === undefined)
                    continue; // omit undefined props (JSON.stringify parity)
