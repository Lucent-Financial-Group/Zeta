...
import { aggregateAuthorRatios, classifyCommit, classifyPath, } from "./classify";
...
describe("classifyCommit", () => {
    function makeCommit(files, author = "otto") {
        return {
            sha: "deadbeef",
            author,
...
describe("aggregateAuthorRatios", () => {
    function makeResult(author, lane, distinctLanes) {
        return {
            sha: "x",
            author,
            lane,
