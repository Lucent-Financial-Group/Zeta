...
import { softBayesianMix, softQuantumMix, softMixGeneric } from "./soft-mix";
import { quaternionRing } from "./star-ring";
...
// ─── Load IR ─────────────────────────────────────────────────────────────────
const goldenFile = readFileSync(join(import.meta.dir, "../../../tests/cross-verification/zeta-ir-v1/zeta-ir-v1.golden.json"), "utf-8");
