...
import { findPathClaims } from "./check-existence.js";
 ...
 */
function resolveClaim(claimPath, fileDir, fileParentDir, repoRoot) {
...
export function checkFile(filePath) {
    ...
    for (const claim of claims) {
        ...
        if (resolved === null)
            continue; // non-existent paths are check-existence's domain
