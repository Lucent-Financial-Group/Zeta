...
memo's body table — the canonical eval-set for 081KQNJ500008QG0R003SCWBDV.
...
| path-form drift | `path-form-drift-bare-vs-qualified.md` | verify-then-claim memo **instance #15 / PR #1256** (adjacent ADR citations mixing fully-qualified with bare filename — path-form sub-class #6 of the 7-class list) — synthetic exemplar; instance #15's literal substance is captured in a follow-on fixture (081KQNJ500008QG0R003SCWBDV.4.1) | same on-disk file referenced as both `check-counts.ts` and `tools/substrate-claim-checker/check-counts.ts` |
...
- 081KQNJ500008QG0R003SCWBDV (the parent backlog row this directory contributes to)
