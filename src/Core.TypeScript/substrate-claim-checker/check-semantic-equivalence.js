...
export function checkFile(filePath) {
    ...
    try {
        ...
        console.error(`error: read failed for ${filePath}: ${error.message}`);
...
function searchInDirectory(dirPath) {
    ...
    try {
        ...
        console.error(`error: directory read failed for ${dirPath}: ${error.message}`);
        allOk = false;
    }
...
export function main() {
    ...
    for (const target of targets) {
        try {
            ...
            console.error(`error: cannot stat target ${target}: ${error.message}`);
            inputErrors++;
        }
    }
