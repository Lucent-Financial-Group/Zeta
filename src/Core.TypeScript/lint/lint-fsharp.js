#!/usr/bin/env bun
// lint-fsharp.ts — F# whitespace, style, and analyzer checks.
//
// Post-install orchestration of F# formatting checks via dotnet format
...
function retryReason(result, output) {
...
function main() {
    ...
    console.log("✓ F# whitespace, style, and analyzer checks passed successfully!");
    return 0;
}
process.exit(main());
