...
const fixture = (await Bun.file("vectors.json").json()) as Fixture;

const results: Record<string, YamlEvent[]> = {};
let mismatches = 0;
...
console.log(
  `Cross-verify (TS): ${fixture.vectors.length} vectors. Matched expected ${fixture.vectors.length - mismatches}/${fixture.vectors.length}.`,
);
