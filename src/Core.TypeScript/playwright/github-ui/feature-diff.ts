...
export function renderDiffReport(report: FeatureDiffReport): string {
  ...
  lines.push(
    `---`,
    ``,
    `_Generated by \`src/Core.TypeScript/playwright/github-ui/feature-diff.ts\` (081KR2E4K0008QG0R003E09GMM). ` +
...
function printHelp(writeStdout: (chunk: string) => void): void {
  writeStdout(
    `feature-diff.ts — diff two GitHub UI snapshot sets and report new feature candidates\n` +
      `\nUsage: bun src/Core.TypeScript/playwright/github-ui/feature-diff.ts --prior <path> --current <path> [--out <path>]\n` +
      `\nFlags:\n` +
