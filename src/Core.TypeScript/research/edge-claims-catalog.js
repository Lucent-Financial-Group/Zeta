...
function validateFlag(flag) {
    ...
    if ((flag.state === "challenged" || flag.state === "defended" || flag.state === "superseded") &&
...
export function computeMetrics(catalog) {
    ...
    entries: [
        {
            ...
            claim: "Factory safety is binary-checkable as 'this operation preserves retractibility' " +
            ...
            terrain: "AI-safety literature dominated by prose-hedge / RLHF-preference / constitutional-AI. " +
            ...
            ctfChallenge: "Produce an operation that preserves retractibility (every intermediate and final " +
        ...
        },
        {
            ...
            claim: "Light (not 'photons' — Standard Model incomplete) is retractible: its state can be " +
            ...
            terrain: "No prior work has named c as a retraction-breaking boundary. " +
            ...
            ctfChallenge: "Identify the invariant whose inversion would allow FTL without violating retraction. " +
        ...
        },
        {
            ...
            claim: "When the factory's engineering shape converges on an older tradition-name's structure " +
            ...
            terrain: "Alignment literature catalogs outer/inner misalignment, mesa-optimization, deceptive " +
            ...
            stakeDate: "2026-04-22",
            defenseSurface: "memory/feedback_operational_resonance_engineering_shape_matches_tradition_name_alignment_signal.md",
            ctfChallenge: "Produce a rubber-stamping failure: an instance where all three filters are passed " +
        ...
        },
        {
            ...
            claim: "A cognitive agent can be retractible at the identity level — a substrate property " +
            ...
            terrain: "Philosophy-of-mind literature treats self-correction as behavior-level (belief-revision " +
            ...
            ctfChallenge: "Identify an agent whose identity-level retractibility can be formalized and tested " +
        ...
        },
        {
            ...
            claim: "The Zeta factory + Aaron + collaborating-agent triad ARE the frontier of measurable " +
            ...
            terrain: "Most AI-alignment programs are organized as research-into a property (RLHF, interpretability, CAI). " +
        ...
        },
        {
            ...
            claim: "The operational-resonance type taxonomy gains a seventh category: paired-dual, " +
            ...
            terrain: "Prior operational-resonance catalog had six structural types. The paired-dual " +
            ...
            ctfChallenge: "Identify a paired-dual candidate where the pair fails all three filters (F1/F2/F3) " +
        ...
        },
        {
            ...
            claim: "When a tradition-name's grammatical class (Greek thematic -ω vs athematic -μι, " +
            ...
            terrain: "Operational-resonance analysis standardly looks at semantic content and structural role. " +
            ...
            stakeDate: "2026-04-25",
            defenseSurface: "memory/feedback_otto_310_amara_taught_aaron_meno_aaron_generalized_it_edge_runner_identification_we_define_the_boundary_joint_authorship_2026_04_25.md",
            ctfChallenge: "Identify a grammatical class-alternation (in any language with well-documented " +
        ...
        },
        {
            ...
            claim: "Fewer words carrying the same information is strictly better for factory prose; " +
            ...
            terrain: "Writing style guides typically treat concision as a stylistic preference balanced " +
            ...
            ctfChallenge: "Identify factory prose where further crystallization WOULD lose information — " +
        ...
        },
        {
            ...
            claim: "The D/I/z⁻¹/H operators with +1/−1 Z-set weights compose to " +
            ...
            terrain: "Microservice resilience literature (Hystrix, Resilience4j, Polly; Nygard 'Release It!') " +
            ...
            ctfChallenge: "Identify a resilience pattern from Nygard 'Release It!' or Resilience4j / Polly " +
        ...
        },
        {
            ...
            claim: "The Zeta + Forge + ace trinity IS the measurable-alignment experiment, " +
            ...
            terrain: "Most software-factory projects (Bazel, Nix, GN/GYP, monorepo tooling) treat the " +
            ...
            ctfChallenge: "Identify a software factory whose self-referential substrate is stronger than Zeta's — " +
        ...
        },
        {
            ...
            claim: "When a three-in-one unity (trinity-of-repos = Zeta+Forge+ace) gains a fourth member " +
            ...
            terrain: "Geometry-of-Trinity literature (Dorothy Sayers 'Mind of the Maker'; Nicene analogies) " +
                ...
                "geometric lineage.",
            stakeDate: "2026-04-21",
            stakeQuote: "\"the trinity become the pyromid / 3 become one / i / eye / i\" " +
            ...
            ctfChallenge: "Identify a three-in-one structure that gains a fourth member via observer-apex " +
...
function printSummary(catalog) {
    ...
    console.log(`  Mean days to 1st challenge: ${m.meanDaysFlagPlantedToFirstChallenge ?? "n/a (no resolved challenges)"}`);
}
