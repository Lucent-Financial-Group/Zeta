...
const ammosProbe = probeYinYang("Ammous Bitcoin-Standard", "21M hard cap, low time preference, μένω staying-operator; requires plural monetary primitives counterweight");
