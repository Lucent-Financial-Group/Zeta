...
function applyFixes(file, content, violations) {
...
function validate(memoryDir) {
    ...
    for (const file of regularFiles) {
        ...
        else if (!VALID_TYPES.includes(fm.fields["type"])) {
            violations.push({
