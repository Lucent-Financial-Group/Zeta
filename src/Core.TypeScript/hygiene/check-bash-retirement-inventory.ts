...
export const EXPECTED_RETAINED_SHELL: readonly string[] = [
  ...
  "tools/setup/mechanisms/from-autotools-tarball.sh",
  "tools/setup/mechanisms/from-bun-global.sh",
  "tools/setup/mechanisms/from-bun-link.sh",
  "tools/setup/mechanisms/from-deb.sh",
  "tools/setup/mechanisms/from-dotnet-global.sh",
  "tools/setup/mechanisms/from-dotnet-workload.sh",
  "tools/setup/mechanisms/from-elan.sh",
  "tools/setup/mechanisms/from-installer.sh",
  "tools/setup/mechanisms/from-ollama.sh",
  "tools/setup/mechanisms/from-opam-git.sh",
...
export const RETAINED_SHELL_CATEGORY_BY_FILE: Readonly<Record<string, RetainedShellCategory>> = {
  ...
  "tools/setup/mechanisms/from-autotools-tarball.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-bun-global.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-bun-link.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-deb.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-dotnet-global.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-dotnet-workload.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-elan.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-installer.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-ollama.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-opam-git.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-shim.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-url.sh": "setup/bootstrap",
  "tools/setup/mechanisms/from-uv-tool.sh": "setup/bootstrap",
