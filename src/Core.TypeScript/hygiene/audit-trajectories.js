...
function extractPathsFilter(yml) {
    const lines = yml.split("\n");
    let inPaths = false;
    const collected = [];
    for (const line of lines) {
...
async function axisCadenceWorkflows(ghAvailable) {
...
async function axisLintWorkflows(ghAvailable) {
...
async function axisHygieneTooling() {
...
async function axisRazorCadence(ghAvailable) {
