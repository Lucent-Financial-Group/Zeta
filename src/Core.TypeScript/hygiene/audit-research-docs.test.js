...
import { auditResearchDocsInRoots } from "./audit-research-docs.js";
function fixture() {
...
describe("auditResearchDocsInRoots", () => {
    test("classifies references, rationale markers, and markdown memory substrate", async () => {
        ...
        try {
            ...
            writeFileSync(join(root, "docs", "research", "rationale.txt"), "explicit unindexed rationale: archived raw OCR source\n");
