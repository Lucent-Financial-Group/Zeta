...
describe("the archives are withheld — the case that actually happened", () => {
  ...
  test("every glob shape in the real config works: dir/**, **/x/**, and a * stem", () => {
    ...
    // NOT a legacy B-NNNN id: `lint-no-b-refs.ts` forbids those in prose/source, and a test
    // fixture is still a reference. Any non-`081*` stem exercises the same discrimination.
