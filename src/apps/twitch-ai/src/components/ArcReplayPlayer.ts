import { ARC_FRAME_HEIGHT, ARC_FRAME_WIDTH, moveReplayIndex, type ArcRecording } from "../arc-replay";
...
export class ArcReplayPlayer {
  ...
  public constructor(containerId: string, recording: ArcRecording) {
    ...
    readout.append(this.tickReadout, this.actionReadout, this.stateReadout, this.levelReadout);
    ...
    provenance.textContent =
      "Offline committed replay from the Zeta-authored local ARC environment. No key or network request.";
  ...
  private render(): void {
    ...
    this.actionReadout.textContent = `Action ${step.observation.action.id}`;
