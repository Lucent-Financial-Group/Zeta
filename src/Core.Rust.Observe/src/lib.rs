...
//! single-pass, zero-copy, constant memory — safe for untrusted/unbounded input).
//! The DOM [`json::ZetaJsonParser`] is built on top of it (trusted-input only —
//! whole-tree materialization is a DoS vector). An optional serde_json-backed
