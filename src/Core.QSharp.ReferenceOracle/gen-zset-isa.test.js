...
import { generateQSharp, checkFixpoint, extractOperatorBodies } from "./gen-zset-isa";
const dir = import.meta.dir;
const ir = JSON.parse(readFileSync(join(dir, "zset-isa-ir.json"), "utf-8"));
...
describe("gen(gen)===gen — Q# ZSetISA fixpoint (Face 3)", () => {
    ...
    test("Face 3: the IR describes all six operators that exist in committed", () => {
        ...
        const coreOps = [...committedBodies.keys()].filter(n => n !== "VerifyIdentity" && n !== "JoinWeighted");
