...
/// The tropical semiring has NO additive inverse — it is a semiring,
/// not a ring. Callers that need retraction must use `IntegerRing` or
/// `IntervalRing` (both implement `IRing<'W>`).
[<Sealed>]
