...
const EvidenceReceiptDetailPage = lazy(() => import("./pages/EvidenceReceiptDetailPage"));
const EvidenceSourceManifestPage = lazy(() => import("./pages/EvidenceSourceManifestPage"));
...
function Router() {
  return (
    <Switch>
      ...
      <Route path={"/evidence-seam/sources"}><Suspense fallback={<RouteLoader />}><EvidenceSourceManifestPage /></Suspense></Route>
      <Route path={"/evidence-seam/receipt/:id"}><Suspense fallback={<RouteLoader />}><EvidenceReceiptDetailPage /></Suspense></Route>
