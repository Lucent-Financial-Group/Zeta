...
const SPECTRUM = [
  ...
  },
  {
    ...
    operators: "26 F# · 15 TS · 20-group F#/TS · Lean laws",
    defect: "—",
    readout: "31-BIT / DOMAIN-SPLIT",
    verdict: "unary factors + deterministic compensated fusion",
    detail: "signed object/position namespaces · collision refusal checked · admission / pose topology only · language / learning / cortical fidelity unmeasured",
    tone: "var(--amber)",
  },
  {
    lane: "exact dense Gaussian query",
    carrier: "≤64 declared linear-Gaussian layers",
    operators: "joint precision inversion · F#/Python agreement",
    defect: "—",
    readout: "COVARIANCE EXACT",
    verdict: "finite loopy covariance available by dense query",
    detail: "O(n³) query · loopy BP remains means-only · non-Gaussian inference unmeasured · CRDT state stays evidence union",
    tone: "var(--amber)",
    emphasis: true,
  },
  {
  ...
  },
  {
    ...
    operators: "canonical numeric order · Kahan information sum · TS/Python",
    defect: "—",
    readout: "QUERY ONLY",
    verdict: "six arrival orders + redelivery yield one numerical receipt",
    detail: "unsorted fold yields 2 posteriors even with Kahan · canonical order is load-bearing · Conflict retained · not a CRDT merge",
    tone: "var(--amber)",
  },
  {
    lane: "candidate English-seed audit",
    carrier: "65 declared candidate entries · 122 glossary headings",
    operators: "deterministic lexical receipt · TS/Python · removed-entry mutant",
    defect: "—",
    readout: "AUDIT ONLY",
    verdict: "31.35% lexical match · 0 / 122 fully covered",
    detail: "unknown tokens retained · candidate seed is not semantic proof · grammar weighting and grounded English unimplemented",
    tone: "var(--amber)",
  },
  {
