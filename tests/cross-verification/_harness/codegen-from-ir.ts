...
function main(): number {
  ...
  console.log(`[codegen] emitted 6 oracle scripts from ${basename(irPath)} → ${outDir}`);
...
export { emitTypeScript, emitFSharp, emitCSharp, emitRust, emitPython, emitGo, parseIrJson, type ZetaIrV1 };
