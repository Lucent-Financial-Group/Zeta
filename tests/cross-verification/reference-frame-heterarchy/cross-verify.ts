...
function isReport(value: unknown): value is OracleReport {
  ...
  const numeric = [
    ...
    "contradictionBowlProbability", "permutationCount", "naturalityMaxError", "duplicateAcceptedCount",
    "conflictCount", "k4ChromaticNumber", "k5ChromaticNumber",
  ];
...
console.log("reference-frame-heterarchy cross-verify: 14 finite witnesses across F#/TypeScript, 0 failure(s).");
